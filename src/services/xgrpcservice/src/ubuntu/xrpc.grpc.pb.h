 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void call(::grpc::ClientContext* context, const ::tcash::xrpc_request* request, ::tcash::xrpc_reply* response, std::function<void(::grpc::Status)>) = 0;
      virtual void call(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tcash::xrpc_reply* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void call(::grpc::ClientContext* context, const ::tcash::xrpc_request* request, ::tcash::xrpc_reply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void call(::grpc::ClientContext* context, const ::tcash::xrpc_request* request, ::tcash::xrpc_reply* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void call(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tcash::xrpc_reply* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void call(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tcash::xrpc_reply* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void table_stream(::grpc::ClientContext* context, ::tcash::xrpc_request* request, ::grpc::ClientReadReactor< ::tcash::xrpc_reply>* reactor) = 0;
      #else
      virtual void table_stream(::grpc::ClientContext* context, ::tcash::xrpc_request* request, ::grpc::experimental::ClientReadReactor< ::tcash::xrpc_reply>* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  class Stub final : public StubInterface {
   public:
    ...
    class experimental_async final :
     ...
     public:
      void call(::grpc::ClientContext* context, const ::tcash::xrpc_request* request, ::tcash::xrpc_reply* response, std::function<void(::grpc::Status)>) override;
      void call(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tcash::xrpc_reply* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void call(::grpc::ClientContext* context, const ::tcash::xrpc_request* request, ::tcash::xrpc_reply* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void call(::grpc::ClientContext* context, const ::tcash::xrpc_request* request, ::tcash::xrpc_reply* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void call(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tcash::xrpc_reply* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void call(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::tcash::xrpc_reply* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void table_stream(::grpc::ClientContext* context, ::tcash::xrpc_request* request, ::grpc::ClientReadReactor< ::tcash::xrpc_reply>* reactor) override;
      #else
      void table_stream(::grpc::ClientContext* context, ::tcash::xrpc_request* request, ::grpc::experimental::ClientReadReactor< ::tcash::xrpc_reply>* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_call : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_call() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::tcash::xrpc_request, ::tcash::xrpc_reply>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
                     context, const ::tcash::xrpc_request* request, ::tcash::xrpc_reply* response) { return this->call(context, request, response); }));}
    void SetMessageAllocatorFor_call(
        ::grpc::experimental::MessageAllocator< ::tcash::xrpc_request, ::tcash::xrpc_reply>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(0);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::tcash::xrpc_request, ::tcash::xrpc_reply>*>(handler)
    ...
    virtual ::grpc::ServerUnaryReactor* call(
      ::grpc::CallbackServerContext* /*context*/, const ::tcash::xrpc_request* /*request*/, ::tcash::xrpc_reply* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* call(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::tcash::xrpc_request* /*request*/, ::tcash::xrpc_reply* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_table_stream : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_table_stream() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(1,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::tcash::xrpc_request, ::tcash::xrpc_reply>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::tcash::xrpc_request* request) { return this->table_stream(context, request); }));
    }
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerWriteReactor< ::tcash::xrpc_reply>* table_stream(
      ::grpc::CallbackServerContext* /*context*/, const ::tcash::xrpc_request* /*request*/)
    #else
    virtual ::grpc::experimental::ServerWriteReactor< ::tcash::xrpc_reply>* table_stream(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::tcash::xrpc_request* /*request*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    WithStreamedUnaryMethod_call() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler<
          ::tcash::xrpc_request, ::tcash::xrpc_reply>(
            [this](::grpc_impl::ServerContext* context,
                   ::grpc_impl::ServerUnaryStreamer<
                     ::tcash::xrpc_request, ::tcash::xrpc_reply>* streamer) {
