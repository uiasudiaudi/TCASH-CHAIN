...
class xtcash_application_category : public std::error_category {
public:
...
using xapplication_category_t = xtcash_application_category;
...
size_t hash<tcash::application::error::xerrc_t>::operator()(tcash::application::error::xerrc_t errc) const noexcept {
    return static_cast<size_t>(static_cast<std::underlying_type<tcash::application::error::xerrc_t>::type>(errc));
}
