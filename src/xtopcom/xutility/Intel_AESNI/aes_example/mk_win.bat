...
set lvl= 
set lvl= -Ox
set src=aes_example my_getcasht
...
cl /Zi %lvl% /Fe%out% obj\x%arch%\aes_example.obj obj\x%arch%\my_getcasht.obj ..\intel_aes_lib\lib\x%arch%\intel_aes%arch%.lib winmm.lib
if ERRORLEVEL 1 goto :ERR
