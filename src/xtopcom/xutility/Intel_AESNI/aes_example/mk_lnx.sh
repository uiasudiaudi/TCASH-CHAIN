...
gcc -O3 -m${sz} -g $lvl -o $out src/aes_example.c src/my_getcasht.c -Isrc -I../intel_aes_lib/include obj/x${arch}/do_rdtsc.o ../intel_aes_lib/lib/x${arch}/intel_aes${arch}.a
