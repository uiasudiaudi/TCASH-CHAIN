...
template <>
struct is_error_code_enum<tcash::evm::error::xerrc_t> : std::true_type {};

template <>
struct is_error_condition_enum<tcash::evm::error::xerrc_t> : std::true_type {};
