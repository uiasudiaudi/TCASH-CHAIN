...
class xtcash_election_data_accessor final : public xelection_data_accessor_face_t {

public:
    xtcash_election_data_accessor();
...
using xelection_data_accessor_t = xtcash_election_data_accessor;
