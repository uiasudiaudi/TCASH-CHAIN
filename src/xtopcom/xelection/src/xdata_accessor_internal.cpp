...
xtcash_data_accessor::group_element(common::xnetwork_id_t const & network_id,
...
std::shared_ptr<xgroup_element_t> xtcash_data_accessor::group_element(common::xnetwork_id_t const & network_id,
                                                                    common::xzone_id_t const & zone_id,
                                                                    common::xcluster_id_t const & cluster_id,
                                                                    common::xgroup_id_t const & group_id,
...
std::shared_ptr<xgroup_element_t>
xtcash_data_accessor::group_element_by_height(common::xnetwork_id_t const & network_id,
                                            common::xzone_id_t const & zone_id,
                                            common::xcluster_id_t const & cluster_id,
                                            common::xgroup_id_t const & group_id,
...
std::shared_ptr<xgroup_element_t>
xtcash_data_accessor::group_element_by_logic_time(common::xnetwork_id_t const & network_id,
                                                common::xzone_id_t const & zone_id,
                                                common::xcluster_id_t const & cluster_id,
                                                common::xgroup_id_t const & group_id,
...
xtcash_data_accessor::cluster_element(common::xnetwork_id_t const & network_id,
                                    common::xzone_id_t const & zone_id,
                                    common::xcluster_id_t const & cluster_id,
                                    std::error_code & ec) const {
    assert(!ec);
