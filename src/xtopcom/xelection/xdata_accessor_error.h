...
enum class xtcash_data_accessor_errc {
    success = 0,
    node_id_empty,
    node_id_mismatch,
    node_not_found,
...
using xdata_accessor_errc_t = xtcash_data_accessor_errc;
...
template <>
struct is_error_code_enum<tcash::election::xdata_accessor_errc_t> : std::true_type {};
