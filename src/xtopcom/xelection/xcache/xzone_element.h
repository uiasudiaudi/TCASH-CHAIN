...
class xtcash_zone_element final : public xbasic_element_t
                              , public std::enable_shared_from_this<xtcash_zone_element> {
private:
...
public:
    xtcash_zone_element(xtcash_zone_element const &)             = delete;
    xtcash_zone_element & operator=(xtcash_zone_element const &) = delete;
    xtcash_zone_element(xtcash_zone_element &&)                  = default;
    xtcash_zone_element & operator=(xtcash_zone_element &&)      = default;
    ~xtcash_zone_element() override                            = default;

    xtcash_zone_element(common::xzone_id_t const & zone_id,
...
using xzone_element_t = xtcash_zone_element;
