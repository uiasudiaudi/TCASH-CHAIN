...
class xtcash_network_element final : public xbasic_element_t
                                 , public std::enable_shared_from_this<xtcash_network_element> {
private:
...
public:
    xtcash_network_element(xtcash_network_element const &)             = delete;
    xtcash_network_element & operator=(xtcash_network_element const &) = delete;
    xtcash_network_element(xtcash_network_element &&)                  = default;
    xtcash_network_element & operator=(xtcash_network_element &&)      = default;
    ~xtcash_network_element() override                               = default;

    explicit
    xtcash_network_element(common::xnetwork_id_t const & network_id);
...
using xnetwork_element_t = xtcash_network_element;
