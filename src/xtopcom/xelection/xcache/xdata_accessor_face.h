...
public:
    XDECLARE_DEFAULTED_DEFAULT_CONSTRUCTOR(xtcash_data_accessor_face);
    XDECLARE_DELETED_COPY_DEFAULTED_MOVE_SEMANTICS(xtcash_data_accessor_face);
    XDECLARE_DEFAULTED_VIRTULA_DESTRUCTOR(xtcash_data_accessor_face);
