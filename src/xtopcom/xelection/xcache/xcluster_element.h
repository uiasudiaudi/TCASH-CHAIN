...
class xtcash_cluster_element final
  : public xbasic_element_t
  , public std::enable_shared_from_this<xtcash_cluster_element> {
private:
...
public:
    xtcash_cluster_element(xtcash_cluster_element const &) = delete;
    xtcash_cluster_element & operator=(xtcash_cluster_element const &) = delete;
    xtcash_cluster_element(xtcash_cluster_element &&) = default;
    xtcash_cluster_element & operator=(xtcash_cluster_element &&) = default;
    ~xtcash_cluster_element() override = default;

    xtcash_cluster_element(common::xcluster_id_t const & cluster_id, std::shared_ptr<xzone_element_t> const & zone_element);
