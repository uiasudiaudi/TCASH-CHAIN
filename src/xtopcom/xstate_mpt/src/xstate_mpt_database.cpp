...
xtcash_state_mpt_caching_db::xtcash_state_mpt_caching_db(base::xvdbstore_t * db) {
...
observer_ptr<evm_common::trie::xtrie_db_t> xtcash_state_mpt_caching_db::trie_db(common::xtable_address_t const & table) const {
