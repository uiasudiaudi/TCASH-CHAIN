...
public:
    ...
    static std::shared_ptr<xtcash_state_mpt> create(common::xtable_address_t const & table, const xh256_t & root, base::xvdbstore_t * db, std::error_code & ec);
...
using xstate_mpt_t = details::xtcash_state_mpt;
using xaccount_info_t = details::xtcash_account_info;
NS_END2
