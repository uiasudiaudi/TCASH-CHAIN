...
namespace tcash
{
    namespace xconsensus
    {
        ...
        {
            //step#0: verified that replica and leader are valid by from_addr and to_addr at tcash layer like xconsnetwork or xconsnode_t. here just consider pass.
        ...
        {
            //step#0: verified that replica and leader are valid by from_addr and to_addr at tcash layer like xconsnetwork or xconsaccount. here just consider pass.
            base::xcspdu_t & packet = event_obj->_packet;
