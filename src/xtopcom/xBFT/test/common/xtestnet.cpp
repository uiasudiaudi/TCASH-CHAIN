...
namespace tcash
{
    namespace test
    {
        ...
        //note: to return false may call parent'push_event_up,or stcash further routing when return true
        ...
        bool    xrtt_simulator::on_timer_stcash(const int32_t errorcode,const int32_t thread_id,const int64_t timer_id,const int64_t cur_time_ms,const int32_t timeout_ms,const int32_t timer_repeat_ms)
        {
            return true;
        }
        ...
        bool  xoutoforder_simulator::on_event_up(const base::xvevent_t & event,base::xionode_t* from_child,const int32_t cur_thread_id,const uint64_t timenow_ms)
        {
            if(event.get_type() == base::enum_xevent_core_type_pdu)
            {
                ...
                if(random_value <= m_outoforder_value) //match condistion
                {
                    ...
                    is_stcash_event_up = true;
                }
                return is_stcash_event_up;
            }
            return false;
        }
        //note: to return false may call child'push_event_down,or stcash further routing when return true
        ...
        bool    xoutoforder_simulator::on_timer_stcash(const int32_t errorcode,const int32_t thread_id,const int64_t timer_id,const int64_t cur_time_ms,const int32_t timeout_ms,const int32_t timer_repeat_ms)
        {
            return true;
        }
