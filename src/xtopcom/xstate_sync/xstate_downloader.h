...
public:
    xtcash_state_downloader(base::xvdbstore_t * db,
    ...
    ~xtcash_state_downloader() = default;
...
using xstate_downloader_t = xtcash_state_downloader;
