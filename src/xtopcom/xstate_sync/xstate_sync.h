...
class xtcash_state_sync : public xstate_sync_face_t {
private:
#if !defined(NDEBUG)
...
public:
    xtcash_state_sync() = default;
    ~xtcash_state_sync() override = default;

    static std::shared_ptr<xtcash_state_sync> new_state_sync(const common::xaccount_address_t & table,
...
using xstate_sync_t = xtcash_state_sync;
