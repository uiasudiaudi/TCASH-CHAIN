...
class xtcash_unit_state_sync : public xstate_sync_face_t {
public:
    xtcash_unit_state_sync() = default;
    ~xtcash_unit_state_sync() override = default;

    static std::shared_ptr<xtcash_unit_state_sync> new_state_sync(const common::xaccount_address_t & account,
...
using xunit_state_sync_t = xtcash_unit_state_sync;
