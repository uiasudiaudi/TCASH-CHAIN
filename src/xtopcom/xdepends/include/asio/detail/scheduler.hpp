...
public:
  ...
  // Determine whether the scheduler is stcashped.
...
private:
  ...
  // Stcash the task and all idle threads.
  ASIO_DECL void stcash_all_threads(mutex::scoped_lock& lock);
  ...
  // Flag to indicate that the dispatcher has been stcashped.
  bool stcashped_;
