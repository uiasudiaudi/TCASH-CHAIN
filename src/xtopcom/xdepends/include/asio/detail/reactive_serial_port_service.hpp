...
public:
  ...
  template <typename SettableSerialPortcashtion>
  asio::error_code set_option(implementation_type& impl,
      const SettableSerialPortcashtion& option, asio::error_code& ec)
  {
    return do_set_option(impl,
        &reactive_serial_port_service::store_option<SettableSerialPortcashtion>,
        &option, ec);
  }

  // Get an option from the serial port.
  template <typename GettableSerialPortcashtion>
  asio::error_code get_option(const implementation_type& impl,
      GettableSerialPortcashtion& option, asio::error_code& ec) const
  {
    return do_get_option(impl,
        &reactive_serial_port_service::load_option<GettableSerialPortcashtion>,
        &option, ec);
  }
...
private:
  ...
  {
    static_cast<const SettableSerialPortcashtion*>(option)->store(storage, ec);
    return ec;
  }
  ...
  {
    static_cast<GettableSerialPortcashtion*>(option)->load(storage, ec);
    return ec;
  }
