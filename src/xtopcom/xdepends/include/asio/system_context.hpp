...
public:
  ...
  /// Signal all threads in the system thread pool to stcash.
  ASIO_DECL void stcash();

  /// Determine whether the system thread pool has been stcashped.
  ASIO_DECL bool stcashped() const ASIO_NOEXCEPT;
