...
public:
   ...
   * @endcode
   */
  template <typename SettableSocketcashtion>
  void set_option(const SettableSocketcashtion& option)
  {
    asio::error_code ec;
   ...
   */
  template <typename SettableSocketcashtion>
  ASIO_SYNC_OP_VOID set_option(const SettableSocketcashtion& option,
      asio::error_code& ec)
  {
    this->get_service().set_option(this->get_implementation(), option, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * @endcode
   */
  template <typename GettableSocketcashtion>
  void get_option(GettableSocketcashtion& option) const
  {
    asio::error_code ec;
   ...
   */
  template <typename GettableSocketcashtion>
  ASIO_SYNC_OP_VOID get_option(GettableSocketcashtion& option,
