...
public:
   ...
   * @throws asio::system_error Thrown on failure.
   *
   * @sa SettableSerialPortcashtion @n
   * asio::serial_port_base::baud_rate @n
   * asio::serial_port_base::flow_control @n
   * asio::serial_port_base::parity @n
   * asio::serial_port_base::stcash_bits @n
   * asio::serial_port_base::character_size
   */
  template <typename SettableSerialPortcashtion>
  void set_option(const SettableSerialPortcashtion& option)
  {
    asio::error_code ec;
   ...
   */
  template <typename SettableSerialPortcashtion>
  ASIO_SYNC_OP_VOID set_option(const SettableSerialPortcashtion& option,
      asio::error_code& ec)
  {
    this->get_service().set_option(this->get_implementation(), option, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * @throws asio::system_error Thrown on failure.
   *
   * @sa GettableSerialPortcashtion @n
   * asio::serial_port_base::baud_rate @n
   * asio::serial_port_base::flow_control @n
   * asio::serial_port_base::parity @n
   * asio::serial_port_base::stcash_bits @n
  ...
  void get_option(GettableSerialPortcashtion& option)
  {
    asio::error_code ec;
   ...
   */
  template <typename GettableSerialPortcashtion>
  ASIO_SYNC_OP_VOID get_option(GettableSerialPortcashtion& option,
      asio::error_code& ec)
  {
    this->get_service().get_option(this->get_implementation(), option, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
