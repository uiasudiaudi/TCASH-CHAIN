...
template <typename PointertcashodType>
inline PointertcashodType buffer_cast(const mutable_buffer& b) ASIO_NOEXCEPT
{
  return static_cast<PointertcashodType>(b.data());
}

/// Cast a non-modifiable buffer to a specified pointer to POD type.
template <typename PointertcashodType>
inline PointertcashodType buffer_cast(const const_buffer& b) ASIO_NOEXCEPT
{
  return static_cast<PointertcashodType>(b.data());
}
