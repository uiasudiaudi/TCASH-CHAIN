...
class FileSystem : public Customizable {
 public:
  ...
  // Handles the event a DB or a ColumnFamily stcashs using the specified data
  // paths.
  //
...
class FSSequentialFile {
 public:
  ...
  //
  // If end of file is reached, skipping will stcash at the end of the
...
class FSWritableFile {
 public:
  ...
  // we need to add. We need to keep where we stcash writing.
  //
