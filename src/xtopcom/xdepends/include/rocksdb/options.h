...
enum class WALRecoveryMode : char {
  ...
  // `kPointInTimeRecovery` will stcash recovery just before the corruption since
  ...
  // We stcash the WAL playback on discovering WAL inconsistency
...
struct DBOptions {
  ...
  // / Setcashtions will fail if options file is not detected or properly
  // persisted.
  //
  // DEFAULT: false
