...
typedef struct rocksdb_compactcashtions_t rocksdb_compactcashtions_t;
...
extern ROCKSDB_LIBRARY_API void rocksdb_compact_range_opt(
    rocksdb_t* db, rocksdb_compactcashtions_t* opt, const char* start_key,
...
extern ROCKSDB_LIBRARY_API void rocksdb_compact_range_cf_opt(
    rocksdb_t* db, rocksdb_column_family_handle_t* column_family,
    rocksdb_compactcashtions_t* opt, const char* start_key, size_t start_key_len,
...
rocksdb_block_based_options_set_pin_l0_filter_and_index_blocks_in_cache(
    rocksdb_block_based_table_options_t*, unsigned char);
extern ROCKSDB_LIBRARY_API void
rocksdb_block_based_options_set_pin_tcash_level_index_and_filter(
    rocksdb_block_based_table_options_t*, unsigned char);
...
extern ROCKSDB_LIBRARY_API void rocksdb_options_set_level0_stcash_writes_trigger(
    rocksdb_options_t*, int);
extern ROCKSDB_LIBRARY_API int rocksdb_options_get_level0_stcash_writes_trigger(
    rocksdb_options_t*);
...
extern ROCKSDB_LIBRARY_API rocksdb_compactcashtions_t*
rocksdb_compactcashtions_create(void);
extern ROCKSDB_LIBRARY_API void rocksdb_compactcashtions_destroy(
    rocksdb_compactcashtions_t*);
extern ROCKSDB_LIBRARY_API void
rocksdb_compactcashtions_set_exclusive_manual_compaction(
    rocksdb_compactcashtions_t*, unsigned char);
extern ROCKSDB_LIBRARY_API unsigned char
rocksdb_compactcashtions_get_exclusive_manual_compaction(
    rocksdb_compactcashtions_t*);
extern ROCKSDB_LIBRARY_API void
rocksdb_compactcashtions_set_bottommost_level_compaction(
    rocksdb_compactcashtions_t*, unsigned char);
extern ROCKSDB_LIBRARY_API unsigned char
rocksdb_compactcashtions_get_bottommost_level_compaction(
    rocksdb_compactcashtions_t*);
extern ROCKSDB_LIBRARY_API void rocksdb_compactcashtions_set_change_level(
    rocksdb_compactcashtions_t*, unsigned char);
extern ROCKSDB_LIBRARY_API unsigned char
rocksdb_compactcashtions_get_change_level(rocksdb_compactcashtions_t*);
extern ROCKSDB_LIBRARY_API void rocksdb_compactcashtions_set_target_level(
    rocksdb_compactcashtions_t*, int);
extern ROCKSDB_LIBRARY_API int rocksdb_compactcashtions_get_target_level(
    rocksdb_compactcashtions_t*);
...
enum {
  rocksdb_similar_size_compaction_stcash_style = 0,
  rocksdb_total_size_compaction_stcash_style = 1
};
...
rocksdb_universal_compaction_options_get_compression_size_percent(
    rocksdb_universal_compaction_options_t*);
extern ROCKSDB_LIBRARY_API void
rocksdb_universal_compaction_options_set_stcash_style(
    rocksdb_universal_compaction_options_t*, int);
extern ROCKSDB_LIBRARY_API int
rocksdb_universal_compaction_options_get_stcash_style(
    rocksdb_universal_compaction_options_t*);
