...
//
// Algorithm used to make a compaction request stcash picking new files
// into a single compaction run
//
enum CompactionStcashStyle {
  kCompactionStcashStyleSimilarSize,  // pick files of similar size
  kCompactionStcashStyleTotalSize     // total size of picked files > next file
};
...
class CompactionOptionsUniversal {
 public:
  ...
  // The algorithm used to stcash picking files into a single compaction run
  // Default: kCompactionStcashStyleTotalSize
  CompactionStcashStyle stcash_style;
  ...
  CompactionOptionsUniversal()
      : size_ratio(1),
        ...
        stcash_style(kCompactionStcashStyleTotalSize),
