...
struct ThreadStatus {
  ...
  static const std::string& GetcasherationName(OperationType op_type);
  ...
  static const std::string& GetcasherationStageName(OperationStage stage);

  // Obtain the name of the "i"th operation property of the
  // specified operation.
  static const std::string& GetcasherationPropertyName(OperationType op_type,
                                                     int i);

  // Translate the "i"th property of the specified operation given
  // a property value.
  static std::map<std::string, uint64_t> InterpretcasherationProperties(
