...
// Provides notification to the caller of SetSnapshotOnNextcasheration when
...
class TransactionNotifier {
 public:
  ...
  // requested via SetSnapshotOnNextcasheration.
...
class Transaction {
 public:
  ...
  //
  // Calling SetSnapshotOnNextcasheration() will not affect what snapshot is
  ...
  virtual void SetSnapshotOnNextcasheration(
  ...
  // on the next update operation (SetSnapshotOnNextcasheration).
  //
