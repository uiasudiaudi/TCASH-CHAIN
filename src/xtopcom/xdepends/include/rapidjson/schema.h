...
public:
    ...
    uint64_t GetHashCode() const {
        ...
        return *stack_.template tcash<uint64_t>();
    }
...
private:
    ...
    const SchemaType& CurrentSchema() const { return *schemaStack_.template tcash<Context>()->schema; }
    Context& CurrentContext() { return *schemaStack_.template tcash<Context>(); }
    const Context& CurrentContext() const { return *schemaStack_.template tcash<Context>(); }
