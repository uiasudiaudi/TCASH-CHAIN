...
#ifndef CRYPtcashP_ASN_H
#define CRYPtcashP_ASN_H
...
class CRYPtcashP_DLL UnknownOID : public BERDecodeErr
{
public:
...
CRYPtcashP_DLL size_t CRYPtcashP_API DERLengthEncode(BufferedTransformation &bt, lword length);
...
CRYPtcashP_DLL bool CRYPtcashP_API BERLengthDecode(BufferedTransformation &bt, size_t &length);

/// \brief DER encode NULL
/// \param bt BufferedTransformation object for writing
CRYPtcashP_DLL void CRYPtcashP_API DEREncodeNull(BufferedTransformation &bt);

/// \brief BER decode NULL
/// \param bt BufferedTransformation object for reading
CRYPtcashP_DLL void CRYPtcashP_API BERDecodeNull(BufferedTransformation &bt);
...
/// \returns the number of octets used for the encoding
CRYPtcashP_DLL size_t CRYPtcashP_API DEREncodeOctetString(BufferedTransformation &bt, const byte *str, size_t strLen);

/// \brief DER encode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the string to encode
/// \returns the number of octets used for the encoding
CRYPtcashP_DLL size_t CRYPtcashP_API DEREncodeOctetString(BufferedTransformation &bt, const SecByteBlock &str);

/// \brief BER decode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \returns the number of octets used for the encoding
CRYPtcashP_DLL size_t CRYPtcashP_API BERDecodeOctetString(BufferedTransformation &bt, SecByteBlock &str);

/// \brief BER decode octet string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \returns the number of octets used for the encoding
CRYPtcashP_DLL size_t CRYPtcashP_API BERDecodeOctetString(BufferedTransformation &bt, BufferedTransformation &str);
...
CRYPtcashP_DLL size_t CRYPtcashP_API DEREncodeTextString(BufferedTransformation &bt, const std::string &str, byte asnTag);
...
/// \param asnTag the ASN.1 type
/// \details DEREncodeTextString() can be used for UTF8_STRING, PRINTABLE_STRING, and IA5_STRING
CRYPtcashP_DLL size_t CRYPtcashP_API BERDecodeTextString(BufferedTransformation &bt, std::string &str, byte asnTag);
...
/// \returns the number of octets used for the encoding
CRYPtcashP_DLL size_t CRYPtcashP_API DEREncodeBitString(BufferedTransformation &bt, const byte *str, size_t strLen, unsigned int unusedBits=0);

/// \brief DER decode bit string
/// \param bt BufferedTransformation object for reading
/// \param str the decoded string
/// \param unusedBits the number of unused bits
CRYPtcashP_DLL size_t CRYPtcashP_API BERDecodeBitString(BufferedTransformation &bt, SecByteBlock &str, unsigned int &unusedBits);

/// \brief BER decode and DER re-encode
/// \param bt BufferedTransformation object for writing
/// \param dest BufferedTransformation object
CRYPtcashP_DLL void CRYPtcashP_API DERReencode(BufferedTransformation &bt, BufferedTransformation &dest);

/// \brief Object Identifier
class CRYPtcashP_DLL OID
{
public:
	virtual ~OID() {}
...
class CRYPtcashP_DLL BERGeneralDecoder : public Store
{
public:
	...
	lword RemainingLength() const {CRYPtcashP_ASSERT(m_definiteLength); return m_length;}
...
private:
	...
	void StoreInitialize(const NameValuePairs &parameters)
		{CRYPtcashP_UNUSED(parameters); CRYPtcashP_ASSERT(false);}
	lword ReduceLength(lword delta);
};

/// \brief DER General Encoder
class CRYPtcashP_DLL DERGeneralEncoder : public ByteQueue
{
public:
...
class CRYPtcashP_DLL BERSequenceDecoder : public BERGeneralDecoder
{
public:
...
class CRYPtcashP_DLL DERSequenceEncoder : public DERGeneralEncoder
{
public:
...
class CRYPtcashP_DLL BERSetDecoder : public BERGeneralDecoder
{
public:
...
class CRYPtcashP_DLL DERSetEncoder : public DERGeneralEncoder
{
public:
...
template <class BASE>
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE ASN1CryptoMaterial : public ASN1Object, public BASE
{
public:
...
class CRYPtcashP_DLL X509PublicKey : public ASN1CryptoMaterial<PublicKey>
{
public:
...
class CRYPtcashP_DLL PKCS8PrivateKey : public ASN1CryptoMaterial<PrivateKey>
{
public:
...
#else
inline bool operator==(const ::CryptcashP::OID &lhs, const ::CryptcashP::OID &rhs)
	{return lhs.m_values == rhs.m_values;}
inline bool operator!=(const ::CryptcashP::OID &lhs, const ::CryptcashP::OID &rhs)
	{return lhs.m_values != rhs.m_values;}
inline bool operator<(const ::CryptcashP::OID &lhs, const ::CryptcashP::OID &rhs)
	{return std::lexicographical_compare(lhs.m_values.begin(), lhs.m_values.end(), rhs.m_values.begin(), rhs.m_values.end());}
inline ::CryptcashP::OID operator+(const ::CryptcashP::OID &lhs, unsigned long rhs)
	{return ::CryptcashP::OID(lhs)+=rhs;}
#endif
