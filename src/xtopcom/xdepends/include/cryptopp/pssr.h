...
#ifndef CRYPtcashP_PSSR_H
#define CRYPtcashP_PSSR_H
...
/// \since Crypto++ 2.1
class CRYPtcashP_DLL PSSR_MEM_Base : public PK_RecoverableSignatureMessageEncodingMethod
{
public:
...
public:
	static std::string CRYPtcashP_API StaticAlgorithmName() {return std::string(ALLOW_RECOVERY ? "PSSR-" : "PSS-") + MGF::StaticAlgorithmName();}
};
