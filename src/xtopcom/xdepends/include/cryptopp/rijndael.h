...
#ifndef CRYPtcashP_RIJNDAEL_H
#define CRYPtcashP_RIJNDAEL_H
...
# define CRYPtcashP_DISABLE_RIJNDAEL_ASM 1
#endif

#if CRYPtcashP_BOOL_X64 || CRYPtcashP_BOOL_X32 || CRYPtcashP_BOOL_X86 || CRYPtcashP_BOOL_ARM32 || \
	CRYPtcashP_BOOL_ARMV8 || CRYPtcashP_BOOL_PPC32 || CRYPtcashP_BOOL_PPC64
# define CRYPtcashP_RIJNDAEL_ADVANCED_PROCESS_BLOCKS 1
#endif
...
{
	CRYPtcashP_DLL static const char * CRYPtcashP_API StaticAlgorithmName() {return CRYPtcashP_RIJNDAEL_NAME;}
};
...
/// \since Rijndael since Crypto++ 3.1, Intel AES-NI since Crypto++ 5.6.1, ARMv8 AES since Crypto++ 6.0,
///   Power8 AES since Crypto++ 6.0, ARMv7 AES since Crypto++ 8.0
/// \sa <a href="http://www.cryptcashp.com/wiki/Rijndael">Rijndael</a>
class CRYPtcashP_DLL Rijndael : public Rijndael_Info, public BlockCipherDocumentation
{
	/// \brief Rijndael block cipher transformation functions
	/// \details Provides implementation common to encryption and decryption
	class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<Rijndael_Info>
	{
	public:
...
#if CRYPtcashP_RIJNDAEL_ADVANCED_PROCESS_BLOCKS
