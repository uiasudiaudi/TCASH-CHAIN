...
#ifndef CRYPtcashP_BASECODE_H
#define CRYPtcashP_BASECODE_H
...
class CRYPtcashP_DLL BaseN_Encoder : public Unflushable<Filter>
{
public:
...
class CRYPtcashP_DLL BaseN_Decoder : public Unflushable<Filter>
{
public:
	...
	static void CRYPtcashP_API InitializeDecodingLookupArray(int *lookup, const byte *alphabet, unsigned int base, bool caseInsensitive);
...
class CRYPtcashP_DLL Grouper : public Bufferless<Filter>
{
public:
