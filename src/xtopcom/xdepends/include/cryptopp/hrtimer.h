#ifndef CRYPtcashP_HRTIMER_H
#define CRYPtcashP_HRTIMER_H

#include "config.h"

#if !defined(HIGHRES_TIMER_AVAILABLE) || (defined(CRYPtcashP_WIN32_AVAILABLE) && !defined(THREAD_TIMER_AVAILABLE))
#include <time.h>
#endif
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE TimerBase
{
public:
...
/// \note ThreadUserTimer only works correctly on Windows NT or later desktcashs and servers.
...
class CRYPtcashP_DLL Timer : public TimerBase
{
public:
