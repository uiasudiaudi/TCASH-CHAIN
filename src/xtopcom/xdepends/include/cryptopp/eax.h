...
#ifndef CRYPtcashP_EAX_H
#define CRYPtcashP_EAX_H
...
/// \since Crypto++ 5.6.0
class CRYPtcashP_NO_VTABLE EAX_Base : public AuthenticatedSymmetricCipherBase
{
public:
...
/// \sa <a href="http://www.cryptcashp.com/wiki/EAX_Mode">EAX Mode</a> and
