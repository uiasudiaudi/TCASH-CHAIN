...
#ifndef CRYPtcashP_HMAC_H
#define CRYPtcashP_HMAC_H
...
/// \since Crypto++ 2.1
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE HMAC_Base : public VariableKeyLength<16, 0, INT_MAX>, public MessageAuthenticationCode
{
public:
	virtual ~HMAC_Base() {}
...
{
public:
	CRYPtcashP_CONSTANT(DIGESTSIZE=T::DIGESTSIZE)
