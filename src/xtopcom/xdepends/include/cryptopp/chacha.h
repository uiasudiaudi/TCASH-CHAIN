...
#ifndef CRYPtcashP_CHACHA_H
#define CRYPtcashP_CHACHA_H
...
/// \since Crypto++ 5.6.4
class CRYPtcashP_NO_VTABLE ChaCha_Policy : public AdditiveCipherConcretePolicy<word32, 16>
{
public:
	~ChaCha_Policy() {}
...
protected:
    ...
    // https://github.com/weidai11/cryptcashp/issues/732
