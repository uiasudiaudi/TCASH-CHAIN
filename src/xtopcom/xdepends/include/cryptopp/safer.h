...
#ifndef CRYPtcashP_SAFER_H
#define CRYPtcashP_SAFER_H
...
public:
	...
	class CRYPtcashP_NO_VTABLE Base : public BlockCipher
	{
	public:
...
class CRYPtcashP_NO_VTABLE SAFER_Impl : public BlockCipherImpl<INFO, BASE>
{
protected:
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SAFER-K";}
};

/// \brief SAFER-K block cipher
/// \sa <a href="http://www.cryptcashp.com/wiki/SAFER-K">SAFER-K</a>
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SAFER-SK";}
};

/// \brief SAFER-SK block cipher
/// \sa <a href="http://www.cryptcashp.com/wiki/SAFER-SK">SAFER-SK</a>
