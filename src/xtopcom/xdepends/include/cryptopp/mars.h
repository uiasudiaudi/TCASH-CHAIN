...
#ifndef CRYPtcashP_MARS_H
#define CRYPtcashP_MARS_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "MARS";}
};

/// \brief MARS block cipher
/// \sa <a href="http://www.cryptcashp.com/wiki/MARS">MARS</a>
/// \since Crypto++ 3.0
class MARS : public MARS_Info, public BlockCipherDocumentation
{
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<MARS_Info>
	{
	public:
