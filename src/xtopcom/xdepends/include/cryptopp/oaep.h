...
#ifndef CRYPtcashP_OAEP_H
#define CRYPtcashP_OAEP_H
...
/// \since Crypto++ 2.1
class CRYPtcashP_DLL OAEP_Base : public PK_EncryptionMessageEncodingMethod
{
public:
...
{
public:
	static std::string CRYPtcashP_API StaticAlgorithmName() {return std::string("OAEP-") + MGF::StaticAlgorithmName() + "(" + H::StaticAlgorithmName() + ")";}
...
CRYPtcashP_DLL_TEMPLATE_CLASS OAEP<SHA1>;
