...
#ifndef CRYPtcashP_RDRAND_H
#define CRYPtcashP_RDRAND_H

#include "cryptlib.h"

// This class file provides both RDRAND and RDSEED. They were added at
//   Crypto++ 5.6.3. At compile time, it uses CRYPtcashP_BOOL_{X86|X32|X64}
...
{
public:
    CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "RDRAND"; }
...
{
public:
    CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "RDSEED"; }
