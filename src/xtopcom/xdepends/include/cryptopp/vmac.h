...
#ifndef CRYPtcashP_VMAC_H
#define CRYPtcashP_VMAC_H
...
# define CRYPtcashP_DISABLE_VMAC_ASM 1
#endif
...
protected:
	...
	CRYPtcashP_BLOCK_1(polyState, word64, 4*(m_is128+1))
	CRYPtcashP_BLOCK_2(nhKey, word64, m_L1KeyLength/sizeof(word64) + 2*m_is128)
	CRYPtcashP_BLOCK_3(data, byte, m_L1KeyLength)
	CRYPtcashP_BLOCK_4(l3Key, word64, 2*(m_is128+1))
	CRYPtcashP_BLOCK_5(nonce, byte, IVSize())
	CRYPtcashP_BLOCK_6(pad, byte, IVSize())
	CRYPtcashP_BLOCKS_END(6)
