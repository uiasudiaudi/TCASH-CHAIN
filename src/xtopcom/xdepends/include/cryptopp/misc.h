...
#ifndef CRYPtcashP_MISC_H
#define CRYPtcashP_MISC_H

#include "config.h"

#if !defined(CRYPtcashP_DOXYGEN_PROCESSING)

#if (CRYPtcashP_MSC_VERSION)
# pragma warning(push)
...
#include "smartptr.h"
		...
		#define _interlockedbittestandset CRYPtcashP_DISABLED_INTRINSIC_1
		#define _interlockedbittestandreset CRYPtcashP_DISABLED_INTRINSIC_2
		#define _interlockedbittestandset64 CRYPtcashP_DISABLED_INTRINSIC_3
		#define _interlockedbittestandreset64 CRYPtcashP_DISABLED_INTRINSIC_4
		#include <intrin.h>
		#undef _interlockedbittestandset
		#undef _interlockedbittestandreset
		#undef _interlockedbittestandset64
		#undef _interlockedbittestandreset64
		#define CRYPtcashP_FAST_ROTATE(x) 1
	#elif _MSC_VER >= 1300
		#define CRYPtcashP_FAST_ROTATE(x) ((x) == 32 | (x) == 64)
	#else
		#define CRYPtcashP_FAST_ROTATE(x) ((x) == 32)
	#endif
#elif (defined(__MWERKS__) && TARGET_CPU_PPC) || \
	(defined(__GNUC__) && (defined(_ARCH_PWR2) || defined(_ARCH_PWR) || defined(_ARCH_PPC) || defined(_ARCH_PPC64) || defined(_ARCH_COM)))
	#define CRYPtcashP_FAST_ROTATE(x) ((x) == 32)
#elif defined(__GNUC__) && (CRYPtcashP_BOOL_X64 || CRYPtcashP_BOOL_X32 || CRYPtcashP_BOOL_X86)	// depend on GCC's peephole optimization to generate rotate instructions
	#define CRYPtcashP_FAST_ROTATE(x) 1
#else
	#define CRYPtcashP_FAST_ROTATE(x) 0
#endif
...
#define CRYPtcashP_BYTESWAP_AVAILABLE
#include <byteswap.h>
#endif
...
#endif  // CRYPtcashP_DOXYGEN_PROCESSING

#if CRYPtcashP_DOXYGEN_PROCESSING
...
//   see http://github.com/weidai11/cryptcashp/issues/364
ANONYMOUS_NAMESPACE_BEGIN
template<class T>
T NumericLimitsMin()
{
	CRYPtcashP_ASSERT(std::numeric_limits<T>::is_specialized);
...
#if defined(CRYPtcashP_WORD128_AVAILABLE)
template<>
CryptcashP::word128 NumericLimitsMin()
{
	return 0;
}
template<>
CryptcashP::word128 NumericLimitsMax()
{
	return (((CryptcashP::word128)W64LIT(0xffffffffffffffff)) << 64U) | (CryptcashP::word128)W64LIT(0xffffffffffffffff);
}
#endif
...
#define CRYPtcashP_COMPILE_ASSERT(expr) { ... }
#else // CRYPtcashP_DOXYGEN_PROCESSING
template <bool b>
...
#define CRYPtcashP_COMPILE_ASSERT(assertion) CRYPtcashP_COMPILE_ASSERT_INSTANCE(assertion, __LINE__)
#if defined(CRYPtcashP_EXPORTS) || defined(CRYPtcashP_IMPORTS)
#define CRYPtcashP_COMPILE_ASSERT_INSTANCE(assertion, instance)
#else
# if defined(__GNUC__)
#  define CRYPtcashP_COMPILE_ASSERT_INSTANCE(assertion, instance) \
		static CompileAssert<(assertion)> \
		CRYPtcashP_ASSERT_JOIN(cryptcashp_CRYPtcashP_ASSERT_, instance) __attribute__ ((unused))
# else
#  define CRYPtcashP_COMPILE_ASSERT_INSTANCE(assertion, instance) \
		static CompileAssert<(assertion)> \
		CRYPtcashP_ASSERT_JOIN(cryptcashp_CRYPtcashP_ASSERT_, instance)
# endif // __GNUC__
#endif
#define CRYPtcashP_ASSERT_JOIN(X, Y) CRYPtcashP_DO_ASSERT_JOIN(X, Y)
#define CRYPtcashP_DO_ASSERT_JOIN(X, Y) X##Y
...
class CRYPtcashP_DLL Empty
{
};

#if !defined(CRYPtcashP_DOXYGEN_PROCESSING)
template <class BASE1, class BASE2>
class CRYPtcashP_NO_VTABLE TwoBases : public BASE1, public BASE2
{
};

template <class BASE1, class BASE2, class BASE3>
class CRYPtcashP_NO_VTABLE ThreeBases : public BASE1, public BASE2, public BASE3
{
};
#endif // CRYPtcashP_DOXYGEN_PROCESSING
...
public:
	...
	CRYPtcashP_NOINLINE const T & Ref(CRYPtcashP_NOINLINE_DOTDOTDOT) const;
...
template <class T, class F, int instance>
  const T & Singleton<T, F, instance>::Ref(CRYPtcashP_NOINLINE_DOTDOTDOT) const
{
#if defined(CRYPtcashP_CXX11_ATOMICS) && defined(CRYPtcashP_CXX11_SYNCHRONIZATION) && defined(CRYPtcashP_CXX11_DYNAMIC_INIT)
...
#if (!__STDC_WANT_SECURE_LIB__ && !defined(_MEMORY_S_DEFINED)) || defined(CRYPtcashP_WANT_SECURE_LIB)
...
///   make the symbols available if <tt>CRYPtcashP_WANT_SECURE_LIB</tt> is defined.
///   <tt>CRYPtcashP_WANT_SECURE_LIB</tt> is in config.h, but it is disabled by default.
...
# define memcpy_s CryptcashP::memcpy_s
# define memmove_s CryptcashP::memmove_s
#endif
...
#if CRYPtcashP_GCC_VERSION >= 30001
...
# if (CRYPtcashP_LLVM_CLANG_VERSION >= 20800) || (CRYPtcashP_APPLE_CLANG_VERSION >= 30000)
#  pragma GCC diagnostic ignored "-Wtautological-compare"
# elif (CRYPtcashP_GCC_VERSION >= 40300)
...
{
	CRYPtcashP_COMPILE_ASSERT((sizeof(T1)<=sizeof(T2) && T2(-1)>0) || (sizeof(T1)>sizeof(T2) && T1(-1)>0));
...
#define CRYPtcashP_GET_BYTE_AS_BYTE(x, y) byte((x)>>(8*(y)))
...
inline unsigned int TrailingZeros(word32 v)
{
	...
	CRYPtcashP_ASSERT(v != 0);
#if defined(__BMI__)
	return (unsigned int)_tzcnt_u32(v);
#elif defined(__GNUC__) && (CRYPtcashP_GCC_VERSION >= 30400)
...
CRYPtcashP_DLL void CRYPtcashP_API xorbuf(byte *buf, const byte *mask, size_t count);
...
CRYPtcashP_DLL void CRYPtcashP_API xorbuf(byte *output, const byte *input, const byte *mask, size_t count);
...
/// \sa ModPowerOf2
CRYPtcashP_DLL bool CRYPtcashP_API VerifyBufsEqual(const byte *buf1, const byte *buf2, size_t count);
...
{
	CRYPtcashP_ASSERT(IsPowerOf2(b));
...
{
	// http://github.com/weidai11/cryptcashp/issues/364
#if !defined(CRYPtcashP_APPLE_CLANG_VERSION) || (CRYPtcashP_APPLE_CLANG_VERSION >= 80000)
	CRYPtcashP_ASSERT(std::numeric_limits<T1>::is_integer);
	CRYPtcashP_ASSERT(std::numeric_limits<T2>::is_integer);
#endif

	CRYPtcashP_ASSERT(!std::numeric_limits<T1>::is_signed || n > 0);
	CRYPtcashP_ASSERT(!std::numeric_limits<T2>::is_signed || m > 0);
...
{
#if defined(CRYPtcashP_CXX11_ALIGNOF)
	return alignof(T);
#elif (_MSC_VER >= 1300)
	return __alignof(T);
	...
	return __alignof__(T);
#elif CRYPtcashP_BOOL_SLOW_WORD64
...
#if (CRYPtcashP_LITTLE_ENDIAN)
	typedef LittleEndian NativeByteOrder;
#elif (CRYPtcashP_BIG_ENDIAN)
...
///  If CRYPtcashP_LITTLE_ENDIAN is set in config.h, then
///  GetNativeByteOrder returns LittleEndian. If CRYPtcashP_BIG_ENDIAN
...
CRYPtcashP_DLL void CRYPtcashP_API CallNewHandler();
...
/// \note The function is not constant time because it stcashs processing when the carry is 0.
inline void IncrementCounterByOne(byte *inout, unsigned int size)
{
	CRYPtcashP_ASSERT(inout != NULLPTR); CRYPtcashP_ASSERT(size < INT_MAX);
...
{
	CRYPtcashP_ASSERT(output != NULLPTR); CRYPtcashP_ASSERT(input != NULLPTR); CRYPtcashP_ASSERT(size < INT_MAX);
...
#if !defined(CRYPtcashP_DISABLE_ASM) && \
    (_MSC_VER >= 1400 || defined(__GNUC__)) && \
    (CRYPtcashP_BOOL_X64 || CRYPtcashP_BOOL_X86)
...
#endif	// CRYPtcashP_BOOL_X64 || CRYPtcashP_BOOL_X86

#if !defined(CRYPtcashP_DISABLE_ASM) && (_MSC_VER >= 1700) && defined(_M_ARM)
template<> inline void SecureWipeBuffer(byte *buf, size_t n)
{
...
/// \note AlignedAllocate and AlignedDeallocate are available when CRYPtcashP_BOOL_ALIGN16 is
///   defined. CRYPtcashP_BOOL_ALIGN16 is defined in config.h
CRYPtcashP_DLL void* CRYPtcashP_API AlignedAllocate(size_t size);

/// \brief Frees a buffer allocated with AlignedAllocate
/// \param ptr the buffer to free
/// \note AlignedAllocate and AlignedDeallocate are available when CRYPtcashP_BOOL_ALIGN16 is
///   defined. CRYPtcashP_BOOL_ALIGN16 is defined in config.h
CRYPtcashP_DLL void CRYPtcashP_API AlignedDeallocate(void *ptr);

#endif // CRYPtcashP_DOXYGEN_PROCESSING

#if CRYPtcashP_BOOL_ALIGN16
CRYPtcashP_DLL void* CRYPtcashP_API AlignedAllocate(size_t size);
CRYPtcashP_DLL void CRYPtcashP_API AlignedDeallocate(void *ptr);
#endif // CRYPtcashP_BOOL_ALIGN16

/// \brief Allocates a buffer
/// \param size the size of the buffer
CRYPtcashP_DLL void * CRYPtcashP_API UnalignedAllocate(size_t size);

/// \brief Frees a buffer allocated with UnalignedAllocate
/// \param ptr the buffer to free
CRYPtcashP_DLL void CRYPtcashP_API UnalignedDeallocate(void *ptr);
...
template<> inline word32 rotlFixed<word32>(word32 x, unsigned int y)
{
	...
	CRYPtcashP_ASSERT(y < 8*sizeof(x));
...
{
#if defined(CRYPtcashP_BYTESWAP_AVAILABLE)
...
{
#if defined(__GNUC__) && defined(CRYPtcashP_X86_ASM_AVAILABLE)
	__asm__ ("bswap %0" : "=r" (value) : "0" (value));
	return value;
#elif defined(CRYPtcashP_BYTESWAP_AVAILABLE)
	return bswap_32(value);
#elif defined(__MWERKS__) && TARGET_CPU_PPC
	return (word32)__lwbrx(&value,0);
#elif (_MSC_VER >= 1400) || (defined(_MSC_VER) && !defined(_DLL))
	return _byteswap_ulong(value);
#elif CRYPtcashP_FAST_ROTATE(32) && !defined(__xlC__)
...
{
#if defined(__GNUC__) && defined(CRYPtcashP_X86_ASM_AVAILABLE) && defined(__x86_64__)
	__asm__ ("bswap %0" : "=r" (value) : "0" (value));
	return value;
#elif defined(CRYPtcashP_BYTESWAP_AVAILABLE)
...
{
#if CRYPtcashP_BOOL_SLOW_WORD64
...
void ByteReverse(T *out, const T *in, size_t byteCount)
{
	...
	CRYPtcashP_ASSERT(byteCount % sizeof(T) == 0);
	CRYPtcashP_ASSERT(IsAligned<T>(in));
	CRYPtcashP_ASSERT(IsAligned<T>(out));
...
inline void GetUserKey(ByteOrder order, T *out, size_t outlen, const byte *in, size_t inlen)
{
	...
	CRYPtcashP_ASSERT(inlen <= outlen*U);
...
inline void UnalignedbyteNonTemplate(ByteOrder order, byte *block, word16 value, const byte *xorBlock)
{
	if (order == BIG_ENDIAN_ORDER)
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
			block[1] = xorBlock[1] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
		}
		else
		{
			block[0] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
			block[1] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
		}
	}
	else
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
			block[1] = xorBlock[1] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
		}
		else
		{
			block[0] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
			block[1] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
		}
	}
}
...
inline void UnalignedbyteNonTemplate(ByteOrder order, byte *block, word32 value, const byte *xorBlock)
{
	if (order == BIG_ENDIAN_ORDER)
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 3);
			block[1] = xorBlock[1] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 2);
			block[2] = xorBlock[2] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
			block[3] = xorBlock[3] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
		}
		else
		{
			block[0] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 3);
			block[1] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 2);
			block[2] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
			block[3] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
		}
	}
	else
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
			block[1] = xorBlock[1] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
			block[2] = xorBlock[2] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 2);
			block[3] = xorBlock[3] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 3);
		}
		else
		{
			block[0] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
			block[1] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
			block[2] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 2);
			block[3] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 3);
		}
	}
}
...
inline void UnalignedbyteNonTemplate(ByteOrder order, byte *block, word64 value, const byte *xorBlock)
{
	if (order == BIG_ENDIAN_ORDER)
	{
		if (xorBlock)
		{
			block[0] = xorBlock[0] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 7);
			block[1] = xorBlock[1] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 6);
			block[2] = xorBlock[2] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 5);
			block[3] = xorBlock[3] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 4);
			block[4] = xorBlock[4] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 3);
			block[5] = xorBlock[5] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 2);
			block[6] = xorBlock[6] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
			block[7] = xorBlock[7] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
		}
		else
		{
			block[0] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 7);
			block[1] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 6);
			block[2] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 5);
			block[3] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 4);
			block[4] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 3);
			block[5] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 2);
			block[6] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 1);
			block[7] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
		}
	}
	else
	{
		if (xorBlock)
		{
			...
			block[2] = xorBlock[2] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 2);
			block[3] = xorBlock[3] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 3);
			block[4] = xorBlock[4] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 4);
			block[5] = xorBlock[5] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 5);
			block[6] = xorBlock[6] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 6);
			block[7] = xorBlock[7] ^ CRYPtcashP_GET_BYTE_AS_BYTE(value, 7);
		}
		else
		{
			block[0] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 0);
			...
			block[2] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 2);
			block[3] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 3);
			block[4] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 4);
			block[5] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 5);
			block[6] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 6);
			block[7] = CRYPtcashP_GET_BYTE_AS_BYTE(value, 7);
		}
	}
}
...
{
	CRYPtcashP_UNUSED(assumeAligned);
...
public:
	...
	{
		CRYPtcashP_COMPILE_ASSERT(sizeof(U) >= sizeof(T));
...
template<> struct SafeShifter<true>
{
	...
	{
		CRYPtcashP_UNUSED(value); CRYPtcashP_UNUSED(bits);
		return 0;
	}
...
#define CRYPtcashP_BLOCK_1(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+0);}     size_t SS1() {return       sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CRYPtcashP_BLOCK_2(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS1());} size_t SS2() {return SS1()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CRYPtcashP_BLOCK_3(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS2());} size_t SS3() {return SS2()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CRYPtcashP_BLOCK_4(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS3());} size_t SS4() {return SS3()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CRYPtcashP_BLOCK_5(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS4());} size_t SS5() {return SS4()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CRYPtcashP_BLOCK_6(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS5());} size_t SS6() {return SS5()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CRYPtcashP_BLOCK_7(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS6());} size_t SS7() {return SS6()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CRYPtcashP_BLOCK_8(n, t, s) t* m_##n() {return (t *)(void *)(m_aggregate+SS7());} size_t SS8() {return SS7()+sizeof(t)*(s);} size_t m_##n##Size() {return (s);}
#define CRYPtcashP_BLOCKS_END(i) size_t SST() {return SS##i();} void AllocateBlocks() {m_aggregate.New(SST());} AlignedSecByteBlock m_aggregate;
