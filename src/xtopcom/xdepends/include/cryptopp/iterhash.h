...
#ifndef CRYPtcashP_ITERHASH_H
#define CRYPtcashP_ITERHASH_H
...
class CRYPtcashP_DLL HashInputTooLong : public InvalidDataFormat
{
public:
...
class CRYPtcashP_NO_VTABLE IteratedHashBase : public BASE
{
public:
...
class CRYPtcashP_NO_VTABLE IteratedHash : public IteratedHashBase<T_HashWordType, T_Base>
{
public:
	typedef T_Endianness ByteOrderClass;
	typedef T_HashWordType HashWordType;

	CRYPtcashP_CONSTANT(BLOCKSIZE = T_BlockSize)
	// BCB2006 workaround: can't use BLOCKSIZE here
	CRYPtcashP_COMPILE_ASSERT((T_BlockSize & (T_BlockSize - 1)) == 0);	// blockSize is a power of 2
	...
	{
		CRYPtcashP_ASSERT(in != NULLPTR);
		CRYPtcashP_ASSERT(out != NULLPTR);
		CRYPtcashP_ASSERT(IsAligned<T_HashWordType>(in));
		CRYPtcashP_ASSERT(IsAligned<T_HashWordType>(out));
...
class CRYPtcashP_NO_VTABLE IteratedHashWithStaticTransform
	: public ClonableImpl<T_Transform, AlgorithmImpl<IteratedHash<T_HashWordType, T_Endianness, T_BlockSize>, T_Transform> >
{
public:
	CRYPtcashP_CONSTANT(DIGESTSIZE = T_DigestSize ? T_DigestSize : T_StateSize)
...
protected:
	...
	CRYPtcashP_DLL_TEMPLATE_CLASS IteratedHashBase<word64, HashTransformation>;
	CRYPtcashP_STATIC_TEMPLATE_CLASS IteratedHashBase<word64, MessageAuthenticationCode>;

	CRYPtcashP_DLL_TEMPLATE_CLASS IteratedHashBase<word32, HashTransformation>;
	CRYPtcashP_STATIC_TEMPLATE_CLASS IteratedHashBase<word32, MessageAuthenticationCode>;
#endif
