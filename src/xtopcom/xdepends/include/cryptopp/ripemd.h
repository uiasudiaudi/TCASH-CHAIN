...
#ifndef CRYPtcashP_RIPEMD_H
#define CRYPtcashP_RIPEMD_H
...
public:
	...
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-160";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-320";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-128";}
};
...
public:
	static void InitState(HashWordType *state);
	static void Transform(word32 *digest, const word32 *data);
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RIPEMD-256";}
};
