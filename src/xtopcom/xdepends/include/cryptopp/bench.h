...
#ifndef CRYPtcashP_BENCH_H
#define CRYPtcashP_BENCH_H
...
// tcash level, prints preamble and postamble
...
extern void OutputResultcasherations(const char *name, const char *provider, const char *operation, bool pc, unsigned long iterations, double timeTaken);
