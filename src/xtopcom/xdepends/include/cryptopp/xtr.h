#ifndef CRYPtcashP_XTR_H
#define CRYPtcashP_XTR_H
...
public:
	...
	void RaisetcashthPower(Element &a) const
	{
		a.c1.swap(a.c2);
	}
	...
	{
		CRYPtcashP_ASSERT(&x != &result && &y != &result && &z != &result);
