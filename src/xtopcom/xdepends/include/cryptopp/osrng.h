...
#ifndef CRYPtcashP_OSRNG_H
#define CRYPtcashP_OSRNG_H
...
class CRYPtcashP_DLL OS_RNG_Err : public Exception
{
public:
...
class CRYPtcashP_DLL MicrosoftCryptcashrovider
{
public:
	/// \brief Construct a MicrosoftCryptcashrovider
	MicrosoftCryptcashrovider();
	~MicrosoftCryptcashrovider();
...
# endif
	...
	///   BCryptcashenAlgorithmProvider() acquires then handle and
...
class CRYPtcashP_DLL NonblockingRng : public RandomNumberGenerator
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "NonblockingRng"; }
...
protected:
#ifdef CRYPtcashP_WIN32_AVAILABLE
	MicrosoftCryptcashrovider m_Provider;
#else
	int m_fd;
#endif
};
...
#if defined(BLOCKING_RNG_AVAILABLE) || defined(CRYPtcashP_DOXYGEN_PROCESSING)
...
class CRYPtcashP_DLL BlockingRng : public RandomNumberGenerator
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "BlockingRng"; }
...
CRYPtcashP_DLL void CRYPtcashP_API OS_GenerateRandomBlock(bool blocking, byte *output, size_t size);
...
class CRYPtcashP_DLL AutoSeededRandomPool : public RandomPool
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "AutoSeededRandomPool"; }
...
CRYPtcashP_DLL_TEMPLATE_CLASS AutoSeededX917RNG<AES>;
...
///   If CRYPtcashP_ENABLE_COMPLIANCE_WITH_FIPS_140_2 is defined, then DefaultAutoSeededRNG is
...
#if CRYPtcashP_ENABLE_COMPLIANCE_WITH_FIPS_140_2
