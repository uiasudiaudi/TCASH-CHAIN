...
#ifndef CRYPtcashP_DONNA_H
#define CRYPtcashP_DONNA_H
...
// CRYPtcashP_WORD128_AVAILABLE mostly depends upon GCC support for
...
# define CRYPtcashP_CURVE25519_64BIT 1
#else
# define CRYPtcashP_CURVE25519_32BIT 1
#endif
...
#if (CRYPtcashP_SSE2_INTRIN_AVAILABLE) && defined(_MSC_VER)
# define CRYPtcashP_CURVE25519_SSE2 1
#endif

#if (CRYPtcashP_CURVE25519_SSE2)
