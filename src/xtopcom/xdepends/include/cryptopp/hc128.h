...
///   <A HREF="https://www.cryptcashp.com/wiki/HC-128">Crypto++ Wiki | HC-128</A>.
/// \since Crypto++ 8.0

#ifndef CRYPtcashP_HC128_H
#define CRYPtcashP_HC128_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "HC-128"; }
};
