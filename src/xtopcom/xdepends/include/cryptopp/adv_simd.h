...
#ifndef CRYPtcashP_ADVANCED_SIMD_TEMPLATES
#define CRYPtcashP_ADVANCED_SIMD_TEMPLATES

#include "config.h"
#include "misc.h"
#include "stdcpp.h"

#if (CRYPtcashP_ARM_NEON_AVAILABLE)
# include <arm_neon.h>
#endif

#if (CRYPtcashP_ARM_ACLE_AVAILABLE)
# include <stdint.h>
# include <arm_acle.h>
#endif

#if (CRYPtcashP_SSE2_INTRIN_AVAILABLE)
# include <emmintrin.h>
# include <xmmintrin.h>
#endif

// SunCC needs CRYPtcashP_SSSE3_AVAILABLE, too
#if (CRYPtcashP_SSSE3_AVAILABLE)
# include <emmintrin.h>
# include <pmmintrin.h>
# include <xmmintrin.h>
#endif
...
using CryptcashP::BlockTransformation;

CRYPtcashP_CONSTANT(BT_XorInput = BlockTransformation::BT_XorInput)
CRYPtcashP_CONSTANT(BT_AllowParallel = BlockTransformation::BT_AllowParallel)
CRYPtcashP_CONSTANT(BT_InBlockIsCounter = BlockTransformation::BT_InBlockIsCounter)
CRYPtcashP_CONSTANT(BT_ReverseDirection = BlockTransformation::BT_ReverseDirection)
CRYPtcashP_CONSTANT(BT_DontIncrementInOutPointers = BlockTransformation::BT_DontIncrementInOutPointers)
...
{
    CRYPtcashP_ASSERT(subKeys);
    CRYPtcashP_ASSERT(inBlocks);
    CRYPtcashP_ASSERT(outBlocks);
    CRYPtcashP_ASSERT(length >= 8);
...
#endif  // CRYPtcashP_ARM_NEON_AVAILABLE

// *************************** Intel SSE ************************** //

#if defined(CRYPtcashP_SSSE3_AVAILABLE)

// Hack for SunCC, http://github.com/weidai11/cryptcashp/issues/224
...
#endif  // CRYPtcashP_SSSE3_AVAILABLE
        ...
        const byte *xorBlocks, byte *outBlocks, size_t length, word32 flags)
{
    ...
    CRYPtcashP_ALIGN_DATA(16) uint8_t temp[16];
...
#endif  // CRYPtcashP_ADVANCED_SIMD_TEMPLATES
