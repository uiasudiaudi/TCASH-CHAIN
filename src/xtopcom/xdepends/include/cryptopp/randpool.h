...
#ifndef CRYPtcashP_RANDPOOL_H
#define CRYPtcashP_RANDPOOL_H
...
/// \sa OldRandomPool
/// \since Crypto++ 4.0 (PGP 2.6.x style), Crypto++ 5.5 (AES-256 based)
class CRYPtcashP_DLL RandomPool : public RandomNumberGenerator, public NotCopyable
{
public:
...
///   CRYPtcashP_MAINTAIN_BACKWARDS_COMPATIBILITY. OldRandomPool also provides the modern
...
class CRYPtcashP_DLL OldRandomPool : public RandomNumberGenerator
{
public:
