...
#ifndef CRYPtcashP_CAMELLIA_H
#define CRYPtcashP_CAMELLIA_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Camellia";}
};

/// \brief Camellia block cipher
/// \sa <a href="http://www.cryptcashp.com/wiki/Camellia">Camellia</a>
class Camellia : public Camellia_Info, public BlockCipherDocumentation
{
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<Camellia_Info>
	{
	public:
	...
	protected:
		CRYPtcashP_ALIGN_DATA(4) static const byte s1[256];
