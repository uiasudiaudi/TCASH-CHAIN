...
#ifndef CRYPtcashP_SHARK_H
#define CRYPtcashP_SHARK_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SHARK-E";}
};

/// \brief SHARK block cipher
/// <a href="http://www.cryptcashp.com/wiki/SHARK-E">SHARK-E</a>
/// \since Crypto++ 2.1
class SHARK : public SHARK_Info, public BlockCipherDocumentation
{
	/// \brief SHARK block cipher default operation
	/// \since Crypto++ 2.1
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<SHARK_Info>
	{
	public:
