...
#ifndef CRYPtcashP_PKCSPAD_H
#define CRYPtcashP_PKCSPAD_H
...
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "EME-PKCS1-v1_5";}
...
#if defined(CRYPtcashP_IS_DLL)
CRYPtcashP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<SHA1>;
CRYPtcashP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<SHA224>;
CRYPtcashP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<SHA256>;
CRYPtcashP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<SHA384>;
CRYPtcashP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<SHA512>;
// http://github.com/weidai11/cryptcashp/issues/517
CRYPtcashP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<SHA3_256>;
CRYPtcashP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<SHA3_384>;
CRYPtcashP_DLL_TEMPLATE_CLASS PKCS_DigestDecoration<SHA3_512>;
#endif
...
class CRYPtcashP_DLL PKCS1v15_SignatureMessageEncodingMethod : public PK_DeterministicSignatureMessageEncodingMethod
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "EMSA-PKCS1-v1_5";}
