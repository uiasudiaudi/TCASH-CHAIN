...
#ifndef CRYPtcashP_IDEA_H
#define CRYPtcashP_IDEA_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "IDEA";}
};

/// \brief IDEA block cipher
/// \sa <a href="http://www.cryptcashp.com/wiki/IDEA">IDEA</a>
/// \since Crypto++ 1.0
class IDEA : public IDEA_Info, public BlockCipherDocumentation
{
public:		// made public for internal purposes
#ifdef CRYPtcashP_NATIVE_DWORD_AVAILABLE
	typedef word Word;
#else
	typedef hword Word;
#endif
...
private:
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<IDEA_Info>
	{
	public:
