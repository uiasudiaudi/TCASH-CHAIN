...
#ifndef CRYPtcashP_ELGAMAL_H
#define CRYPtcashP_ELGAMAL_H
...
/// \since Crypto++ 1.0
class CRYPtcashP_NO_VTABLE ElGamalBase : public DL_KeyAgreementAlgorithm_DH<Integer, NoCofactorMultiplication>,
...
public:
	...
	{
		CRYPtcashP_UNUSED(groupParams), CRYPtcashP_UNUSED(ephemeralPublicKey), CRYPtcashP_UNUSED(derivationParams);
		agreedElement.Encode(derivedKey, derivedLength);
	}

	size_t GetSymmetricKeyLength(size_t plainTextLength) const
	{
		CRYPtcashP_UNUSED(plainTextLength);
...
/// \sa <A HREF="https://github.com/weidai11/cryptcashp/commit/a5a684d92986e8e2">Commit a5a684d92986e8e2</A>
struct ElGamalKeys
{
...
struct ElGamal
{
	...
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ElgamalEnc/Crypto++Padding";}
