...
#ifndef CRYPtcashP_LUBYRACK_H
#define CRYPtcashP_LUBYRACK_H
...
{
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<LR_Info<T> >
	{
	public:
	...
	protected:
		CRYPtcashP_CONSTANT(S=T::DIGESTSIZE)
