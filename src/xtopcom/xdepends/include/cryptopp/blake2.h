...
#ifndef CRYPtcashP_BLAKE2_H
#define CRYPtcashP_BLAKE2_H
...
struct BLAKE2s_Info : public VariableKeyLength<32,0,32,1,SimpleKeyingInterface::NOT_RESYNCHRONIZABLE>
{
    ...
    CRYPtcashP_CONSTANT(MIN_KEYLENGTH = KeyBase::MIN_KEYLENGTH)
    CRYPtcashP_CONSTANT(MAX_KEYLENGTH = KeyBase::MAX_KEYLENGTH)
    CRYPtcashP_CONSTANT(DEFAULT_KEYLENGTH = KeyBase::DEFAULT_KEYLENGTH)

    CRYPtcashP_CONSTANT(BLOCKSIZE = 64)
    CRYPtcashP_CONSTANT(DIGESTSIZE = 32)
    CRYPtcashP_CONSTANT(SALTSIZE = 8)
    CRYPtcashP_CONSTANT(PERSONALIZATIONSIZE = 8)

    CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "BLAKE2s";}
};
...
struct BLAKE2b_Info : public VariableKeyLength<64,0,64,1,SimpleKeyingInterface::NOT_RESYNCHRONIZABLE>
{
    ...
    CRYPtcashP_CONSTANT(BLOCKSIZE = 128)
    CRYPtcashP_CONSTANT(DIGESTSIZE = 64)
    CRYPtcashP_CONSTANT(SALTSIZE = 16)
    CRYPtcashP_CONSTANT(PERSONALIZATIONSIZE = 16)

    CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "BLAKE2b";}
};

/// \brief BLAKE2s parameter block
struct CRYPtcashP_NO_VTABLE BLAKE2s_ParameterBlock
{
    CRYPtcashP_CONSTANT(SALTSIZE = BLAKE2s_Info::SALTSIZE)
    CRYPtcashP_CONSTANT(DIGESTSIZE = BLAKE2s_Info::DIGESTSIZE)
    CRYPtcashP_CONSTANT(PERSONALIZATIONSIZE = BLAKE2s_Info::PERSONALIZATIONSIZE)
...
struct CRYPtcashP_NO_VTABLE BLAKE2b_ParameterBlock
{
    CRYPtcashP_CONSTANT(SALTSIZE = BLAKE2b_Info::SALTSIZE)
    CRYPtcashP_CONSTANT(DIGESTSIZE = BLAKE2b_Info::DIGESTSIZE)
    CRYPtcashP_CONSTANT(PERSONALIZATIONSIZE = BLAKE2b_Info::PERSONALIZATIONSIZE)
...
/// \since Crypto++ 5.6.4
struct CRYPtcashP_NO_VTABLE BLAKE2s_State
{
    BLAKE2s_State() {
        Reset();
    }
    ...
    CRYPtcashP_CONSTANT(BLOCKSIZE = BLAKE2s_Info::BLOCKSIZE)
...
/// \since Crypto++ 5.6.4
struct CRYPtcashP_NO_VTABLE BLAKE2b_State
{
    BLAKE2b_State() {
        Reset();
    }
    ...
    CRYPtcashP_CONSTANT(BLOCKSIZE = BLAKE2b_Info::BLOCKSIZE)
...
{
public:
    CRYPtcashP_CONSTANT(DEFAULT_KEYLENGTH = BLAKE2s_Info::DEFAULT_KEYLENGTH)
    CRYPtcashP_CONSTANT(MIN_KEYLENGTH = BLAKE2s_Info::MIN_KEYLENGTH)
    CRYPtcashP_CONSTANT(MAX_KEYLENGTH = BLAKE2s_Info::MAX_KEYLENGTH)
...
protected:
    ...
    void UncheckedSetKey(const byte* key, unsigned int length, const CryptcashP::NameValuePairs& params);
...
{
public:
    CRYPtcashP_CONSTANT(DEFAULT_KEYLENGTH = BLAKE2b_Info::DEFAULT_KEYLENGTH)
    CRYPtcashP_CONSTANT(MIN_KEYLENGTH = BLAKE2b_Info::MIN_KEYLENGTH)
    CRYPtcashP_CONSTANT(MAX_KEYLENGTH = BLAKE2b_Info::MAX_KEYLENGTH)
