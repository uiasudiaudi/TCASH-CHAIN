...
#ifndef CRYPtcashP_ECPOINT_H
#define CRYPtcashP_ECPOINT_H
...
/// \since Crypto++ 2.0
struct CRYPtcashP_DLL ECPPoint
{
	virtual ~ECPPoint() {}
...
CRYPtcashP_DLL_TEMPLATE_CLASS AbstractGroup<ECPPoint>;

/// \brief Elliptical Curve Point over GF(2^n)
/// \since Crypto++ 2.0
struct CRYPtcashP_DLL EC2NPoint
{
	virtual ~EC2NPoint() {}
...
CRYPtcashP_DLL_TEMPLATE_CLASS AbstractGroup<EC2NPoint>;
