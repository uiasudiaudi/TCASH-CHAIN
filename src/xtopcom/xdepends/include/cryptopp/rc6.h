...
#ifndef CRYPtcashP_RC6_H
#define CRYPtcashP_RC6_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RC6";}
	typedef word32 RC6_WORD;
};

/// \brief RC6 block cipher
/// \sa <a href="http://www.cryptcashp.com/wiki/RC6">RC6</a>
/// \since Crypto++ 3.0
class RC6 : public RC6_Info, public BlockCipherDocumentation
{
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<RC6_Info>
	{
	public:
