...
#ifndef CRYPtcashP_BLOWFISH_H
#define CRYPtcashP_BLOWFISH_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Blowfish";}
};

// <a href="http://www.cryptcashp.com/wiki/Blowfish">Blowfish</a>
...
class Blowfish : public Blowfish_Info, public BlockCipherDocumentation
{
	...
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<Blowfish_Info>
	{
	public:
