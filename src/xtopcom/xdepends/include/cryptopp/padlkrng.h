...
/// \since Crypto++ 6.0
/// \sa <A HREF="http://www.cryptcashp.com/wiki/VIA_Padlock">VIA
///   Padlock</A> on the Crypto++ wiki

#ifndef CRYPtcashP_PADLOCK_RNG_H
#define CRYPtcashP_PADLOCK_RNG_H
...
///   at <A HREF="http://www.cryptcashp.com/wiki/VIA_Padlock">VIA Padlock</A>.
/// \sa MaurerRandomnessTest() for random bit generators
/// \since Crypto++ 6.0
class PadlockRNG : public RandomNumberGenerator
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "PadlockRNG"; }
...
#endif  // CRYPtcashP_PADLOCK_RNG_H
