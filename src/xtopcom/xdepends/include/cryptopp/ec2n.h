...
#ifndef CRYPtcashP_EC2N_H
#define CRYPtcashP_EC2N_H
...
class CRYPtcashP_DLL EC2N : public AbstractGroup<EC2NPoint>, public EncodedPoint<EC2NPoint>
{
public:
	typedef GF2NP Field;
...
CRYPtcashP_DLL_TEMPLATE_CLASS DL_FixedBasePrecomputationImpl<EC2N::Point>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_GroupPrecomputation<EC2N::Point>;
