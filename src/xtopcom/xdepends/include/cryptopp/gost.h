...
#ifndef CRYPtcashP_GOST_H
#define CRYPtcashP_GOST_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "GOST";}
};

/// \brief GOST block cipher
/// \sa <a href="http://www.cryptcashp.com/wiki/GOST">GOST</a>
/// \since Crypto++ 2.1
class GOST : public GOST_Info, public BlockCipherDocumentation
{
	/// \brief GOST block cipher default operation
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<GOST_Info>
	{
	public:
