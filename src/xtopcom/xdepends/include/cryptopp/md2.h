...
#ifndef CRYPtcashP_MD2_H
#define CRYPtcashP_MD2_H
...
public:
	...
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "MD2";}

	CRYPtcashP_CONSTANT(DIGESTSIZE = 16)
	CRYPtcashP_CONSTANT(BLOCKSIZE = 16)
