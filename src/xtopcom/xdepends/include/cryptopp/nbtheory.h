...
#ifndef CRYPtcashP_NBTHEORY_H
#define CRYPtcashP_NBTHEORY_H
...
CRYPtcashP_DLL const word16 * CRYPtcashP_API GetPrimeTable(unsigned int &size);
...
CRYPtcashP_DLL Integer CRYPtcashP_API MaurerProvablePrime(RandomNumberGenerator &rng, unsigned int bits);
...
CRYPtcashP_DLL Integer CRYPtcashP_API MihailescuProvablePrime(RandomNumberGenerator &rng, unsigned int bits);
...
///   in the table.
CRYPtcashP_DLL bool CRYPtcashP_API IsSmallPrime(const Integer &p);
...
CRYPtcashP_DLL bool CRYPtcashP_API TrialDivision(const Integer &p, unsigned bound);
...
CRYPtcashP_DLL bool CRYPtcashP_API SmallDivisorsTest(const Integer &p);
...
CRYPtcashP_DLL bool CRYPtcashP_API IsFermatProbablePrime(const Integer &n, const Integer &b);
...
///   IsStrongLucasProbablePrime instead.
/// \sa IsStrongProbablePrime, IsStrongLucasProbablePrime
CRYPtcashP_DLL bool CRYPtcashP_API IsLucasProbablePrime(const Integer &n);

/// \brief Determine if a number is probably prime
/// \param n the number to test
/// \param b the base to exponentiate
/// \returns true if the number n is probably prime, false otherwise.
CRYPtcashP_DLL bool CRYPtcashP_API IsStrongProbablePrime(const Integer &n, const Integer &b);

/// \brief Determine if a number is probably prime
/// \param n the number to test
/// \returns true if the number n is probably prime, false otherwise.
CRYPtcashP_DLL bool CRYPtcashP_API IsStrongLucasProbablePrime(const Integer &n);
...
CRYPtcashP_DLL bool CRYPtcashP_API RabinMillerTest(RandomNumberGenerator &rng, const Integer &n, unsigned int rounds);
...
CRYPtcashP_DLL bool CRYPtcashP_API IsPrime(const Integer &p);
...
CRYPtcashP_DLL bool CRYPtcashP_API VerifyPrime(RandomNumberGenerator &rng, const Integer &p, unsigned int level = 1);

/// \brief Application callback to signal suitability of a cabdidate prime
class CRYPtcashP_DLL PrimeSelector
{
public:
...
CRYPtcashP_DLL bool CRYPtcashP_API FirstPrime(Integer &p, const Integer &max, const Integer &equiv, const Integer &mod, const PrimeSelector *pSelector);

CRYPtcashP_DLL unsigned int CRYPtcashP_API PrimeSearchInterval(const Integer &max);

CRYPtcashP_DLL AlgorithmParameters CRYPtcashP_API MakeParametersForTwoPrimesOfEqualSize(unsigned int productBitLength);
...
CRYPtcashP_DLL Integer CRYPtcashP_API CRT(const Integer &xp, const Integer &p, const Integer &xq, const Integer &q, const Integer &u);
...
CRYPtcashP_DLL int CRYPtcashP_API Jacobi(const Integer &a, const Integer &b);

/// \brief Calculate the Lucas value
/// \returns the Lucas value
/// \details Lucas() calculates the Lucas function <tt>V_e(p, 1) mod n</tt>.
CRYPtcashP_DLL Integer CRYPtcashP_API Lucas(const Integer &e, const Integer &p, const Integer &n);
...
CRYPtcashP_DLL Integer CRYPtcashP_API InverseLucas(const Integer &e, const Integer &m, const Integer &p, const Integer &q, const Integer &u);
...
CRYPtcashP_DLL Integer CRYPtcashP_API ModularSquareRoot(const Integer &a, const Integer &p);
...
CRYPtcashP_DLL Integer CRYPtcashP_API ModularRoot(const Integer &a, const Integer &dp, const Integer &dq, const Integer &p, const Integer &q, const Integer &u);
...
CRYPtcashP_DLL bool CRYPtcashP_API SolveModularQuadraticEquation(Integer &r1, Integer &r2, const Integer &a, const Integer &b, const Integer &c, const Integer &p);
...
CRYPtcashP_DLL unsigned int CRYPtcashP_API DiscreteLogWorkFactor(unsigned int bitlength);
...
///   calculate discrete log or factor a number.
CRYPtcashP_DLL unsigned int CRYPtcashP_API FactoringWorkFactor(unsigned int bitlength);

// ********************************************************

/// \brief Generator of prime numbers of special forms
class CRYPtcashP_DLL PrimeAndGenerator
{
public:
