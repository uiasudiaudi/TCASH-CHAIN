...
#ifndef CRYPtcashP_HEX_H
#define CRYPtcashP_HEX_H
...
class CRYPtcashP_DLL HexEncoder : public SimpleProxyFilter
{
public:
...
class CRYPtcashP_DLL HexDecoder : public BaseN_Decoder
{
public:
...
private:
	static const int * CRYPtcashP_API GetDefaultDecodingLookupArray();
};
