...
#ifndef CRYPtcashP_POLYNOMI_H
#define CRYPtcashP_POLYNOMI_H
...
inline bool operator==(const CryptcashP::PolynomialOverFixedRing<T, instance> &a, const CryptcashP::PolynomialOverFixedRing<T, instance> &b)
...
///
template <class T, int instance>
inline CryptcashP::PolynomialOverFixedRing<T, instance> operator+(const CryptcashP::PolynomialOverFixedRing<T, instance> &a, const CryptcashP::PolynomialOverFixedRing<T, instance> &b)
	{return CryptcashP::PolynomialOverFixedRing<T, instance>(a.Plus(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline CryptcashP::PolynomialOverFixedRing<T, instance> operator-(const CryptcashP::PolynomialOverFixedRing<T, instance> &a, const CryptcashP::PolynomialOverFixedRing<T, instance> &b)
	{return CryptcashP::PolynomialOverFixedRing<T, instance>(a.Minus(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline CryptcashP::PolynomialOverFixedRing<T, instance> operator*(const CryptcashP::PolynomialOverFixedRing<T, instance> &a, const CryptcashP::PolynomialOverFixedRing<T, instance> &b)
	{return CryptcashP::PolynomialOverFixedRing<T, instance>(a.Times(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline CryptcashP::PolynomialOverFixedRing<T, instance> operator/(const CryptcashP::PolynomialOverFixedRing<T, instance> &a, const CryptcashP::PolynomialOverFixedRing<T, instance> &b)
	{return CryptcashP::PolynomialOverFixedRing<T, instance>(a.DividedBy(b, a.ms_fixedRing));}
///
template <class T, int instance>
inline CryptcashP::PolynomialOverFixedRing<T, instance> operator%(const CryptcashP::PolynomialOverFixedRing<T, instance> &a, const CryptcashP::PolynomialOverFixedRing<T, instance> &b)
	{return CryptcashP::PolynomialOverFixedRing<T, instance>(a.Modulo(b, a.ms_fixedRing));}

NAMESPACE_END

NAMESPACE_BEGIN(std)
template<class T> inline void swap(CryptcashP::PolynomialOver<T> &a, CryptcashP::PolynomialOver<T> &b)
{
	a.swap(b);
}
template<class T, int i> inline void swap(CryptcashP::PolynomialOverFixedRing<T,i> &a, CryptcashP::PolynomialOverFixedRing<T,i> &b)
{
	a.swap(b);
}
NAMESPACE_END
