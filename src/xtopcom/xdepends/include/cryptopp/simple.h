...
#ifndef CRYPtcashP_SIMPLE_H
#define CRYPtcashP_SIMPLE_H
...
class CRYPtcashP_NO_VTABLE ClonableImpl : public BASE
{
public:
...
class CRYPtcashP_NO_VTABLE AlgorithmImpl : public BASE
{
public:
	...
	static std::string CRYPtcashP_API StaticAlgorithmName() {return ALGORITHM_INFO::StaticAlgorithmName();}
	/// \brief The algorithm name
	/// \returns the algorithm name
...
class CRYPtcashP_DLL InvalidKeyLength : public InvalidArgument
{
public:
...
class CRYPtcashP_DLL InvalidRounds : public InvalidArgument
{
public:
...
class CRYPtcashP_DLL InvalidBlockSize : public InvalidArgument
{
public:
...
class CRYPtcashP_DLL InvalidDerivedLength : public InvalidArgument
{
public:
...
class CRYPtcashP_DLL InvalidPersonalizationLength : public InvalidArgument
{
public:
...
class CRYPtcashP_DLL InvalidSaltLength : public InvalidArgument
{
public:
...
template <class T>
class CRYPtcashP_NO_VTABLE Bufferless : public T
{
public:
	bool IsolatedFlush(bool hardFlush, bool blocking)
		{CRYPtcashP_UNUSED(hardFlush); CRYPtcashP_UNUSED(blocking); return false;}
};

/// \brief Base class for unflushable filters
/// \tparam T the class or type
template <class T>
class CRYPtcashP_NO_VTABLE Unflushable : public T
{
public:
	bool Flush(bool completeFlush, int propagation=-1, bool blocking=true)
		{return ChannelFlush(DEFAULT_CHANNEL, completeFlush, propagation, blocking);}
	bool IsolatedFlush(bool hardFlush, bool blocking)
		{CRYPtcashP_UNUSED(hardFlush); CRYPtcashP_UNUSED(blocking); CRYPtcashP_ASSERT(false); return false;}
...
template <class T>
class CRYPtcashP_NO_VTABLE InputRejecting : public T
{
public:
	...
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
		{CRYPtcashP_UNUSED(inString); CRYPtcashP_UNUSED(length); CRYPtcashP_UNUSED(messageEnd); CRYPtcashP_UNUSED(blocking); throw InputRejected();}
	//@}
	...
	bool IsolatedMessageSeriesEnd(bool blocking)
		{CRYPtcashP_UNUSED(blocking); throw InputRejected();}
	size_t ChannelPut2(const std::string &channel, const byte *inString, size_t length, int messageEnd, bool blocking)
		{CRYPtcashP_UNUSED(channel); CRYPtcashP_UNUSED(inString); CRYPtcashP_UNUSED(length); CRYPtcashP_UNUSED(messageEnd); CRYPtcashP_UNUSED(blocking); throw InputRejected();}
	bool ChannelMessageSeriesEnd(const std::string& channel, int messageEnd, bool blocking)
		{CRYPtcashP_UNUSED(channel); CRYPtcashP_UNUSED(messageEnd); CRYPtcashP_UNUSED(blocking); throw InputRejected();}
	//@}
};
...
template <class T>
class CRYPtcashP_NO_VTABLE CustomFlushPropagation : public T
{
public:
	///	\name SIGNALS
	//@{
...
/// \tparam T BufferedTransformation derived class
template <class T>
class CRYPtcashP_NO_VTABLE CustomSignalPropagation : public CustomFlushPropagation<T>
{
public:
...
/// \details T should be a BufferedTransformation derived class
template <class T>
class CRYPtcashP_NO_VTABLE Multichannel : public CustomFlushPropagation<T>
{
public:
...
//		{PropagateMessageSeriesEnd(propagation, channel);}
	byte * ChannelCreatePutSpace(const std::string &channel, size_t &size)
		{CRYPtcashP_UNUSED(channel); size = 0; return NULLPTR;}
...
/// \tparam T BufferedTransformation derived class
template <class T>
class CRYPtcashP_NO_VTABLE AutoSignaling : public T
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE Store : public AutoSignaling<InputRejecting<BufferedTransformation> >
{
public:
...
///   more details.
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE Sink : public BufferedTransformation
{
public:
	size_t TransferTo2(BufferedTransformation &target, lword &transferBytes, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true)
		{CRYPtcashP_UNUSED(target); CRYPtcashP_UNUSED(transferBytes); CRYPtcashP_UNUSED(channel); CRYPtcashP_UNUSED(blocking); transferBytes = 0; return 0;}
	size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const
		{CRYPtcashP_UNUSED(target); CRYPtcashP_UNUSED(begin); CRYPtcashP_UNUSED(end); CRYPtcashP_UNUSED(channel); CRYPtcashP_UNUSED(blocking); return 0;}
};
...
class CRYPtcashP_DLL BitBucket : public Bufferless<Sink>
{
public:
	std::string AlgorithmName() const {return "BitBucket";}
	void IsolatedInitialize(const NameValuePairs &params)
		{CRYPtcashP_UNUSED(params);}
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
		{CRYPtcashP_UNUSED(inString); CRYPtcashP_UNUSED(length); CRYPtcashP_UNUSED(messageEnd); CRYPtcashP_UNUSED(blocking); return 0;}
};
