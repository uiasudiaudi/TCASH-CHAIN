...
#ifndef CRYPtcashP_TWOFISH_H
#define CRYPtcashP_TWOFISH_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Twofish";}
};

/// \brief Twofish block cipher
/// \sa <a href="http://www.cryptcashp.com/wiki/Twofish">Twofish</a>
/// \since Crypto++ 3.1
class Twofish : public Twofish_Info, public BlockCipherDocumentation
{
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<Twofish_Info>
	{
	public:
