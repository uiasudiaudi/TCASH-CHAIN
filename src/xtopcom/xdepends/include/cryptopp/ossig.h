...
#ifndef CRYPtcashP_OS_SIGNAL_H
#define CRYPtcashP_OS_SIGNAL_H
...
#if defined(UNIX_SIGNALS_AVAILABLE) || defined(CRYPtcashP_DOXYGEN_PROCESSING)
...
extern "C" {
    inline void NullSignalHandler(int unused) {CRYPtcashP_UNUSED(unused);}
}
...
/// \since Crypto++ 5.6.5
/// \sa NullSignalHandler, SignalHandlerFn, \ref CRYPtcashP_ASSERT "CRYPtcashP_ASSERT", DebugTrapHandler
