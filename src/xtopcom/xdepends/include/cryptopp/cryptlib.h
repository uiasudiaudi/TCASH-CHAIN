...
<p>Click <a href="CryptcashPRef.zip">here</a> to download a zip archive containing this manual.
<p>Thanks to Ryan Phillips for providing the Doxygen configuration file
and getting us started on the manual.
*/

#ifndef CRYPtcashP_CRYPTLIB_H
#define CRYPtcashP_CRYPTLIB_H
...
class CRYPtcashP_DLL Exception : public std::exception
{
public:
	/// \enum ErrorType
...
/// \brief An invalid argument was detected
class CRYPtcashP_DLL InvalidArgument : public Exception
{
public:
...
/// \brief Input data was received that did not conform to expected format
class CRYPtcashP_DLL InvalidDataFormat : public Exception
{
public:
...
class CRYPtcashP_DLL InvalidCiphertext : public InvalidDataFormat
{
public:
...
/// \brief A method was called which was not implemented
class CRYPtcashP_DLL NotImplemented : public Exception
{
public:
...
class CRYPtcashP_DLL CannotFlush : public Exception
{
public:
...
class CRYPtcashP_DLL OS_Error : public Exception
{
public:
	...
	const std::string & Getcasheration() const {return m_operation;}
...
struct CRYPtcashP_DLL DecodingResult
{
...
///   <A HREF="http://www.cryptcashp.com/wiki/NameValuePairs">NameValuePairs</A> on the Crypto++ wiki
...
public:
	...
	class CRYPtcashP_DLL ValueTypeMismatch : public InvalidArgument
	{
	public:
	...
	CRYPtcashP_DLL std::string GetValueNames() const
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CRYPtcashP_DLL bool GetIntValue(const char *name, int &value) const
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CRYPtcashP_DLL int GetIntValueWithDefault(const char *name, int defaultValue) const
	...
	CRYPtcashP_DLL bool GetWord64Value(const char *name, word64 &value) const
		{return GetValue(name, value);}
	...
	CRYPtcashP_DLL word64 GetWord64ValueWithDefault(const char *name, word64 defaultValue) const
		{return GetValueWithDefault(name, defaultValue);}
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CRYPtcashP_DLL static void CRYPtcashP_API ThrowIfTypeMismatch(const char *name, const std::type_info &stored, const std::type_info &retrieving)
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CRYPtcashP_DLL void GetRequiredIntParameter(const char *className, const char *name, int &value) const
	{
	...
	/// \sa GetValue(), GetValueWithDefault(), GetIntValue(), GetIntValueWithDefault(),
	///   GetRequiredParameter() and GetRequiredIntParameter()
	CRYPtcashP_DLL virtual bool GetVoidValue(const char *name, const std::type_info &valueType, void *pValue) const =0;
};
...
/// \details Name is part of the CryptcashP namespace.
...
/// \details Weak is part of the CryptcashP namespace. Schemes and algorithms are moved into Weak
...
///   CRYPtcashP_ENABLE_NAMESPACE_WEAK 1</tt> before including a header for a weak or wounded
///   algorithm. For example:
///   <pre>
///     \c \#define CRYPtcashP_ENABLE_NAMESPACE_WEAK 1
///     \c \#include <md5.h>
///     ...
///     CryptcashP::Weak::MD5 md5;
///   </pre>
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE Clonable
{
public:
	virtual ~Clonable() {}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE Algorithm : public Clonable
{
public:
	virtual ~Algorithm() {}
	...
	///    CRYPtcashP_ENABLE_COMPLIANCE_WITH_FIPS_140_2 in config.h.
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE SimpleKeyingInterface
{
public:
	...
	virtual void Resynchronize(const byte *iv, int ivLength=-1) {
		CRYPtcashP_UNUSED(iv); CRYPtcashP_UNUSED(ivLength);
		throw NotImplemented(GetAlgorithm().AlgorithmName() + ": this object doesn't support resynchronization");
	}
...
protected:
	...
	inline void AssertValidKeyLength(size_t length) const
		{CRYPtcashP_UNUSED(length); CRYPtcashP_ASSERT(IsValidKeyLength(length));}
};
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE BlockTransformation : public Algorithm
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE StreamTransformation : public Algorithm
{
public:
	...
	///   <tt>n * OptimalBlockSize() - GetcashtimalBlockSizeUsed()</tt> for any <tt>n \> 0</tt>.
	...
	virtual unsigned int GetcashtimalBlockSizeUsed() const {return 0;}
	...
	///   \ref CRYPtcashP_ASSERT "asserts" IsRandomAccess() in debug builds.
	virtual void Seek(lword pos)
	{
		CRYPtcashP_UNUSED(pos);
		CRYPtcashP_ASSERT(!IsRandomAccess());
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE HashTransformation : public Algorithm
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE BlockCipher : public SimpleKeyingInterface, public BlockTransformation
{
protected:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE SymmetricCipher : public SimpleKeyingInterface, public StreamTransformation
{
protected:
	const Algorithm & GetAlgorithm() const {return *this;}
};
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE MessageAuthenticationCode : public SimpleKeyingInterface, public HashTransformation
{
protected:
	const Algorithm & GetAlgorithm() const {return *this;}
};
...
/// \sa <A HREF="http://www.cryptcashp.com/wiki/Authenticated_Encryption">Authenticated
///   Encryption</A> on the Crypto++ wiki.
/// \since Crypto++ 5.6.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE AuthenticatedSymmetricCipher : public MessageAuthenticationCode, public StreamTransformation
{
public:
...
protected:
	...
	virtual void UncheckedSpecifyDataLengths(lword headerLength, lword messageLength, lword footerLength)
		{CRYPtcashP_UNUSED(headerLength); CRYPtcashP_UNUSED(messageLength); CRYPtcashP_UNUSED(footerLength);}
};
...
/// \since Crypto++ 3.1
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE RandomNumberGenerator : public Algorithm
{
public:
	...
	{
		CRYPtcashP_UNUSED(input); CRYPtcashP_UNUSED(length);
...
/// \since Crypto++ 7.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE KeyDerivationFunction : public Algorithm
{
public:
...
CRYPtcashP_DLL RandomNumberGenerator & CRYPtcashP_API NullRNG();

class WaitObjectContainer;
class CallStack;

/// \brief Interface for objects that can be waited on.
class CRYPtcashP_NO_VTABLE Waitable
{
public:
	virtual ~Waitable() {}
...
/// \nosubgrouping
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE BufferedTransformation : public Algorithm, public Waitable
{
public:
	...
	//@{
		...
		virtual bool IsolatedMessageSeriesEnd(bool blocking)
			{CRYPtcashP_UNUSED(blocking); return false;}
...
public:
	...
	//@{
		...
		///   If all bytes are not transferred for a message, then processing stcashs and the number of remaining
	...
	//@{
		...
		virtual BufferedTransformation *AttachedTransformation() {CRYPtcashP_ASSERT(!Attachable()); return NULLPTR;}
		...
		virtual void Detach(BufferedTransformation *newAttachment = NULLPTR) {
			CRYPtcashP_UNUSED(newAttachment); CRYPtcashP_ASSERT(!Attachable());
...
CRYPtcashP_DLL BufferedTransformation & TheBitBucket();

/// \brief Interface for crypto material, such as public and private keys, and crypto parameters
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CryptoMaterial : public NameValuePairs
{
public:
	/// Exception thrown when invalid crypto material is detected
	class CRYPtcashP_DLL InvalidMaterial : public InvalidDataFormat
	{
	public:
	...
	virtual void Save(BufferedTransformation &bt) const
		{CRYPtcashP_UNUSED(bt); throw NotImplemented("CryptoMaterial: this object does not support saving");}
	...
	virtual void Load(BufferedTransformation &bt)
		{CRYPtcashP_UNUSED(bt); throw NotImplemented("CryptoMaterial: this object does not support loading");}
	...
	virtual void Precompute(unsigned int precomputationStorage) {
		CRYPtcashP_UNUSED(precomputationStorage); CRYPtcashP_ASSERT(!SupportsPrecomputation());
	...
	virtual void LoadPrecomputation(BufferedTransformation &storedPrecomputation)
		{CRYPtcashP_UNUSED(storedPrecomputation); CRYPtcashP_ASSERT(!SupportsPrecomputation()); throw NotImplemented("CryptoMaterial: this object does not support precomputation");}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE GeneratableCryptoMaterial : virtual public CryptoMaterial
{
public:
	...
	virtual void GenerateRandom(RandomNumberGenerator &rng, const NameValuePairs &params = g_nullNameValuePairs) {
		CRYPtcashP_UNUSED(rng); CRYPtcashP_UNUSED(params);
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PublicKey : virtual public CryptoMaterial
{
};

/// \brief Interface for private keys
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PrivateKey : public GeneratableCryptoMaterial
{
};

/// \brief Interface for crypto prameters
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE Cryptcasharameters : public GeneratableCryptoMaterial
{
};
...
/// \sa <A HREF="https://github.com/weidai11/cryptcashp/issues/569">Issue 569</A>
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE AsymmetricAlgorithm : public Algorithm
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PublicKeyAlgorithm : public AsymmetricAlgorithm
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PrivateKeyAlgorithm : public AsymmetricAlgorithm
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE KeyAgreementAlgorithm : public AsymmetricAlgorithm
{
public:
	...
	CryptoMaterial & AccessMaterial() {return AccessCryptcasharameters();}
	/// \brief Retrieves a reference to Crypto Parameters
	/// \return a const reference the crypto parameters
	const CryptoMaterial & GetMaterial() const {return GetCryptcasharameters();}

	/// \brief Retrieves a reference to Crypto Parameters
	/// \return a reference the crypto parameters
	virtual Cryptcasharameters & AccessCryptcasharameters() =0;
	/// \brief Retrieves a reference to Crypto Parameters
	/// \return a const reference the crypto parameters
	virtual const Cryptcasharameters & GetCryptcasharameters() const {return const_cast<KeyAgreementAlgorithm *>(this)->AccessCryptcasharameters();}
};
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PK_CryptoSystem
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PK_Encryptor : public PK_CryptoSystem, public PublicKeyAlgorithm
{
public:
	/// \brief Exception thrown when trying to encrypt plaintext of invalid length
	class CRYPtcashP_DLL InvalidPlaintextLength : public Exception
	{
	public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PK_Decryptor : public PK_CryptoSystem, public PrivateKeyAlgorithm
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PK_SignatureScheme
{
public:
	...
	class CRYPtcashP_DLL InvalidKeyLength : public Exception
	{
	public:
	...
	class CRYPtcashP_DLL KeyTooShort : public InvalidKeyLength
	{
	public:
	...
	{CRYPtcashP_UNUSED(recoverablePartLength); return SignatureLength();}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PK_MessageAccumulator : public HashTransformation
{
public:
	...
	{
		CRYPtcashP_UNUSED(digest); CRYPtcashP_UNUSED(digestSize);
		throw NotImplemented("PK_MessageAccumulator: TruncatedFinal() should not be called");
	}
};

/// \brief Interface for public-key signers
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PK_Signer : public PK_SignatureScheme, public PrivateKeyAlgorithm
{
public:
	virtual ~PK_Signer() {}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE PK_Verifier : public PK_SignatureScheme, public PublicKeyAlgorithm
{
public:
	virtual ~PK_Verifier() {}
...
/// \since Crypto++ 3.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE SimpleKeyAgreementDomain : public KeyAgreementAlgorithm
{
public:
...
/// \since Crypto++ 3.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE AuthenticatedKeyAgreementDomain : public KeyAgreementAlgorithm
{
public:
...
public:
	...
	virtual bool ValidateDomainParameters(RandomNumberGenerator &rng) const
		{return GetCryptcasharameters().Validate(rng, 2);}
...
class CRYPtcashP_DLL BERDecodeErr : public InvalidArgument
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE ASN1Object
{
public:
	virtual ~ASN1Object() {}
...
///   CryptcashP namespace to help programs locate the symbol. If the symbol is present, then
...
///      }
/// </pre>
/// \sa HeaderVersion(), <A HREF="http://github.com/weidai11/cryptcashp/issues/371">GitHub Issue 371</A>.
/// \since Crypto++ 6.0
extern "C" {
	int LibraryVersion(CRYPtcashP_NOINLINE_DOTDOTDOT);
} // C linkage
...
///      }
/// </pre>
/// \sa LibraryVersion(), <A HREF="http://github.com/weidai11/cryptcashp/issues/371">GitHub Issue 371</A>.
/// \since Crypto++ 6.0
extern "C" {
inline int HeaderVersion()
{
	return CRYPtcashP_VERSION;
}
} // C linkage
