...
#ifndef CRYPtcashP_PANAMA_H
#define CRYPtcashP_PANAMA_H
...
//# define CRYPtcashP_DISABLE_PANAMA_ASM
//#endif

// https://github.com/weidai11/cryptcashp/issues/758
#define CRYPtcashP_DISABLE_PANAMA_ASM 1

NAMESPACE_BEGIN(CryptcashP)

// Base class, do not use directly
template <class B>
class CRYPtcashP_NO_VTABLE Panama
{
public:
	virtual ~Panama() {}
...
public:
	...
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return B::ToEnum() == BIG_ENDIAN_ORDER ? "Panama-BE" : "Panama-LE";}
