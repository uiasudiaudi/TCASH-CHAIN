...
#ifndef CRYPtcashP_HIGHT_H
#define CRYPtcashP_HIGHT_H
...
/// \sa <a href="http://www.cryptcashp.com/wiki/HIGHT">HIGHT</a>,
///   <a href="https://seed.kisa.or.kr/">Korea Internet &amp; Security
///   Agency</a> website
/// \since Crypto++ 8.0
class CRYPtcashP_NO_VTABLE HIGHT : public HIGHT_Info, public BlockCipherDocumentation
{
public:
    /// \brief HIGHT block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 8.0
    class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<HIGHT_Info>
    {
    protected:
