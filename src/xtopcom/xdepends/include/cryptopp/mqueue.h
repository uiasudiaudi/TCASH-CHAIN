#ifndef CRYPtcashP_MQUEUE_H
#define CRYPtcashP_MQUEUE_H
...
/// Message Queue
class CRYPtcashP_DLL MessageQueue : public AutoSignaling<BufferedTransformation>
{
public:
	...
	bool IsolatedMessageSeriesEnd(bool blocking)
		{CRYPtcashP_UNUSED(blocking); m_messageCounts.push_back(0); return false;}
...
class CRYPtcashP_DLL EqualityComparisonFilter : public Unflushable<Multichannel<Filter> >
{
public:
...
#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
template<> inline void swap(CryptcashP::MessageQueue &a, CryptcashP::MessageQueue &b)
{
	a.swap(b);
}
NAMESPACE_END
