...
///   Integer::Two(), then see the comments at the tcash of <tt>integer.cpp</tt>.
/// \since Crypto++ 1.0

#ifndef CRYPtcashP_INTEGER_H
#define CRYPtcashP_INTEGER_H
...
// Always align, http://github.com/weidai11/cryptcashp/issues/256
...
/// \since Crypto++ 1.0
/// \nosubgrouping
class CRYPtcashP_DLL Integer : private InitializeInteger, public ASN1Object
{
public:
	...
	//@{
		...
		static const Integer & CRYPtcashP_API Zero();
		...
		static const Integer & CRYPtcashP_API One();
		...
		static const Integer & CRYPtcashP_API Two();
		...
		static Integer CRYPtcashP_API Power2(size_t e);
	//@}
	...
	//@{
		...
		static void CRYPtcashP_API Divide(Integer &r, Integer &q, const Integer &a, const Integer &d);
		...
		static void CRYPtcashP_API Divide(word &r, Integer &q, const Integer &a, word d);
		...
		static void CRYPtcashP_API DivideByPowerOf2(Integer &r, Integer &q, const Integer &a, unsigned int n);
		...
		static Integer CRYPtcashP_API Gcd(const Integer &a, const Integer &n);
	...
	//@{
		...
		friend CRYPtcashP_DLL std::istream& CRYPtcashP_API operator>>(std::istream& in, Integer &a);
		...
		friend CRYPtcashP_DLL std::ostream& CRYPtcashP_API operator<<(std::ostream& out, const Integer &a);
	//@}
	...
	CRYPtcashP_DLL friend Integer CRYPtcashP_API a_times_b_mod_c(const Integer &x, const Integer& y, const Integer& m);
	/// \brief Modular exponentiation
	/// \param x a reference to the base
	/// \param e a reference to the exponent
	/// \param m a reference to the modulus
	/// \returns an Integer <tt>(a ^ b) % m</tt>.
	CRYPtcashP_DLL friend Integer CRYPtcashP_API a_exp_b_mod_c(const Integer &x, const Integer& e, const Integer& m);
...
#ifndef CRYPtcashP_DOXYGEN_PROCESSING
...
/// \brief Comparison
inline bool operator==(const CryptcashP::Integer& a, const CryptcashP::Integer& b) {return a.Compare(b)==0;}
/// \brief Comparison
inline bool operator!=(const CryptcashP::Integer& a, const CryptcashP::Integer& b) {return a.Compare(b)!=0;}
/// \brief Comparison
inline bool operator> (const CryptcashP::Integer& a, const CryptcashP::Integer& b) {return a.Compare(b)> 0;}
...
inline bool operator<=(const CryptcashP::Integer& a, const CryptcashP::Integer& b) {return a.Compare(b)<=0;}
/// \brief Addition
inline CryptcashP::Integer operator+(const CryptcashP::Integer &a, const CryptcashP::Integer &b) {return a.Plus(b);}
/// \brief Subtraction
inline CryptcashP::Integer operator-(const CryptcashP::Integer &a, const CryptcashP::Integer &b) {return a.Minus(b);}
/// \brief Multiplication
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline CryptcashP::Integer operator*(const CryptcashP::Integer &a, const CryptcashP::Integer &b) {return a.Times(b);}
/// \brief Division
inline CryptcashP::Integer operator/(const CryptcashP::Integer &a, const CryptcashP::Integer &b) {return a.DividedBy(b);}
/// \brief Remainder
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline CryptcashP::Integer operator%(const CryptcashP::Integer &a, const CryptcashP::Integer &b) {return a.Modulo(b);}
/// \brief Division
inline CryptcashP::Integer operator/(const CryptcashP::Integer &a, CryptcashP::word b) {return a.DividedBy(b);}
/// \brief Remainder
/// \sa a_times_b_mod_c() and a_exp_b_mod_c()
inline CryptcashP::word    operator%(const CryptcashP::Integer &a, CryptcashP::word b) {return a.Modulo(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline CryptcashP::Integer operator&(const CryptcashP::Integer &a, const CryptcashP::Integer &b) {return a.And(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline CryptcashP::Integer operator|(const CryptcashP::Integer &a, const CryptcashP::Integer &b) {return a.Or(b);}
...
///   the operation.
/// \since Crypto++ 6.0
inline CryptcashP::Integer operator^(const CryptcashP::Integer &a, const CryptcashP::Integer &b) {return a.Xor(b);}

NAMESPACE_END

#ifndef __BORLANDC__
NAMESPACE_BEGIN(std)
inline void swap(CryptcashP::Integer &a, CryptcashP::Integer &b)
{
	a.swap(b);
}
NAMESPACE_END
