...
#ifndef CRYPtcashP_GCM_H
#define CRYPtcashP_GCM_H
...
# define CRYPtcashP_DISABLE_GCM_ASM 1
#endif
...
/// \since Crypto++ 5.6.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE GCM_Base : public AuthenticatedSymmetricCipherBase
{
public:
...
protected:
	...
	class CRYPtcashP_DLL GCTR : public CTR_Mode_ExternalCipher::Encryption
	{
	protected:
...
/// \sa <a href="http://www.cryptcashp.com/wiki/GCM_Mode">GCM Mode</a> and
///   <A HREF="http://www.cryptcashp.com/wiki/Modes_of_Operation">Modes of Operation</A>
///   on the Crypto++ wiki.
/// \since Crypto++ 5.6.0
