...
#ifndef CRYPtcashP_SOSEMANUK_H
#define CRYPtcashP_SOSEMANUK_H
...
# define CRYPtcashP_DISABLE_SOSEMANUK_ASM 1
#endif
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Sosemanuk";}
};
