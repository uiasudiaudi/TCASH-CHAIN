...
#ifndef CRYPtcashP_MODES_H
#define CRYPtcashP_MODES_H
...
/// \brief Block cipher mode of operation information
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CipherModeBase : public SymmetricCipher
{
public:
...
protected:
	...
	{
		CRYPtcashP_ASSERT(m_register.size() > 0);
...
class CRYPtcashP_NO_VTABLE ModePolicyCommonTemplate : public CipherModeBase, public POLICY_INTERFACE
{
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CFB_ModePolicy : public ModePolicyCommonTemplate<CFB_CipherAbstractPolicy>
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "CFB";}
...
{
	CRYPtcashP_ASSERT(dest);
	CRYPtcashP_ASSERT(dsize >= ssize);
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE OFB_ModePolicy : public ModePolicyCommonTemplate<AdditiveCipherAbstractPolicy>
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "OFB";}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CTR_ModePolicy : public ModePolicyCommonTemplate<AdditiveCipherAbstractPolicy>
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "CTR";}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE BlockOrientedCipherModeBase : public CipherModeBase
{
public:
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE ECB_OneWay : public BlockOrientedCipherModeBase
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "ECB";}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CBC_ModeBase : public BlockOrientedCipherModeBase
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "CBC";}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CBC_Encryption : public CBC_ModeBase
{
public:
	void ProcessData(byte *outString, const byte *inString, size_t length);
};
...
/// \since Crypto++ 3.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CBC_CTS_Encryption : public CBC_Encryption
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "CBC/CTS";}
...
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CBC_Decryption : public CBC_ModeBase
{
public:
...
/// \since Crypto++ 3.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CBC_CTS_Decryption : public CBC_Decryption
{
public:
	unsigned int MinLastBlockSize() const {return BlockSize()+1;}
	size_t ProcessLastBlock(byte *outString, size_t outLength, const byte *inString, size_t inLength);
...
public:
	...
	///   Shoup's ECIES.
	static std::string CRYPtcashP_API StaticAlgorithmName()
...
CRYPtcashP_DLL_TEMPLATE_CLASS CFB_CipherTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, CFB_ModePolicy> >;
CRYPtcashP_DLL_TEMPLATE_CLASS CFB_EncryptionTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, CFB_ModePolicy> >;
CRYPtcashP_DLL_TEMPLATE_CLASS CFB_DecryptionTemplate<AbstractPolicyHolder<CFB_CipherAbstractPolicy, CFB_ModePolicy> >;

/// \brief CFB block cipher mode of operation
/// \sa <A HREF="http://www.cryptcashp.com/wiki/Modes_of_Operation">Modes of Operation</A>
///   on the Crypto++ wiki.
...
CRYPtcashP_DLL_TEMPLATE_CLASS AdditiveCipherTemplate<AbstractPolicyHolder<AdditiveCipherAbstractPolicy, OFB_ModePolicy> >;
...
CRYPtcashP_DLL_TEMPLATE_CLASS AdditiveCipherTemplate<AbstractPolicyHolder<AdditiveCipherAbstractPolicy, CTR_ModePolicy> >;
CRYPtcashP_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<ConcretePolicyHolder<Empty, AdditiveCipherTemplate<AbstractPolicyHolder<AdditiveCipherAbstractPolicy, CTR_ModePolicy> > > >;
...
CRYPtcashP_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<ECB_OneWay>;
...
CRYPtcashP_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<CBC_Encryption>;
CRYPtcashP_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<CBC_Decryption>;
...
CRYPtcashP_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<CBC_CTS_Encryption>;
CRYPtcashP_DLL_TEMPLATE_CLASS CipherModeFinalTemplate_ExternalCipher<CBC_CTS_Decryption>;
