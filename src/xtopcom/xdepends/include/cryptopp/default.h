...
#ifndef CRYPtcashP_DEFAULT_H
#define CRYPtcashP_DEFAULT_H
...
{
	CRYPtcashP_CONSTANT(BLOCKSIZE  = BlockSize)
	CRYPtcashP_CONSTANT(KEYLENGTH  = KeyLength)
	CRYPtcashP_CONSTANT(SALTLENGTH = SaltSize)
	CRYPtcashP_CONSTANT(DIGESTSIZE = DigestSize)
	CRYPtcashP_CONSTANT(ITERATIONS = Iterations)
};
...
{
public:
	CRYPtcashP_CONSTANT(BLOCKSIZE  = Info::BLOCKSIZE)
	CRYPtcashP_CONSTANT(KEYLENGTH  = Info::KEYLENGTH)
	CRYPtcashP_CONSTANT(SALTLENGTH = Info::SALTLENGTH)
	CRYPtcashP_CONSTANT(DIGESTSIZE = Info::DIGESTSIZE)
	CRYPtcashP_CONSTANT(ITERATIONS = Info::ITERATIONS)
...
protected:
	void FirstPut(const byte *inString) {CRYPtcashP_UNUSED(inString);}
	void LastPut(const byte *inString, size_t length);
