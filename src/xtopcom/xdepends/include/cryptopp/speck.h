...
///   The Simon and Speck GitHub</A> and <A HREF="https://www.cryptcashp.com/wiki/SPECK">
///   SPECK</A> on the Crypto++ wiki.
/// \since Crypto++ 6.0

#ifndef CRYPtcashP_SPECK_H
#define CRYPtcashP_SPECK_H
...
# define CRYPtcashP_SPECK64_ADVANCED_PROCESS_BLOCKS 1
#endif

#if CRYPtcashP_BOOL_X64 || CRYPtcashP_BOOL_X32 || CRYPtcashP_BOOL_X86 || \
    CRYPtcashP_BOOL_ARM32 || CRYPtcashP_BOOL_ARMV8 || \
    CRYPtcashP_BOOL_PPC32 || CRYPtcashP_BOOL_PPC64
# define CRYPtcashP_SPECK128_ADVANCED_PROCESS_BLOCKS 1
#endif

// Yet another SunStudio/SunCC workaround. Failed self tests
// in SSE code paths on i386 for SunStudio 12.3 and below.
#if defined(__SUNPRO_CC) && (__SUNPRO_CC <= 0x5120)
# undef CRYPtcashP_SPECK64_ADVANCED_PROCESS_BLOCKS
# undef CRYPtcashP_SPECK128_ADVANCED_PROCESS_BLOCKS
#endif
...
/// \sa SPECK64, SPECK128, <a href="http://www.cryptcashp.com/wiki/SPECK">SPECK</a>
/// \since Crypto++ 6.0
template <class W>
struct SPECK_Base
{
...
///   The Simon and Speck GitHub</A>, <a href="http://www.cryptcashp.com/wiki/SPECK">SPECK</a> on the
///   Crypto++ wiki
/// \since Crypto++ 6.0
class CRYPtcashP_NO_VTABLE SPECK64 : public SPECK_Info<8, 12, 12, 16>, public BlockCipherDocumentation
{
public:
    /// \brief SPECK block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CRYPtcashP_NO_VTABLE Base : protected SPECK_Base<word32>, public BlockCipherImpl<SPECK_Info<8, 12, 12, 16> >
    {
    public:
        /// \brief The algorithm name
        /// \returns the algorithm name
...
#if CRYPtcashP_SPECK64_ADVANCED_PROCESS_BLOCKS
...
///   Crypto++ wiki
/// \since Crypto++ 6.0
class CRYPtcashP_NO_VTABLE SPECK128 : public SPECK_Info<16, 16, 16, 32>, public BlockCipherDocumentation
{
public:
    /// \brief SPECK block cipher transformation functions
    /// \details Provides implementation common to encryption and decryption
    /// \since Crypto++ 6.0
    class CRYPtcashP_NO_VTABLE Base : protected SPECK_Base<word64>, public BlockCipherImpl<SPECK_Info<16, 16, 16, 32> >
    {
    public:
        /// \brief The algorithm name
        /// \returns the algorithm name
    ...
    public:
        void ProcessAndXorBlock(const byte *inBlock, const byte *xorBlock, byte *outBlock) const;
#if CRYPtcashP_SPECK128_ADVANCED_PROCESS_BLOCKS
        size_t AdvancedProcessBlocks(const byte *inBlocks, const byte *xorBlocks, byte *outBlocks, size_t length, word32 flags) const;
#endif
    };
