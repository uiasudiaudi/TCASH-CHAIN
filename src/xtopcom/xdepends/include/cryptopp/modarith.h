...
#ifndef CRYPtcashP_MODARITH_H
#define CRYPtcashP_MODARITH_H
...
CRYPtcashP_DLL_TEMPLATE_CLASS AbstractGroup<Integer>;
CRYPtcashP_DLL_TEMPLATE_CLASS AbstractRing<Integer>;
CRYPtcashP_DLL_TEMPLATE_CLASS AbstractEuclideanDomain<Integer>;
...
class CRYPtcashP_DLL ModularArithmetic : public AbstractRing<Integer>
{
public:
	...
	{
		CRYPtcashP_UNUSED(ignore_for_now);
...
///   But this should be fine:
///   <pre>    abcd = group.Add(a, group.Add(b, group.Add(c,d));</pre>
class CRYPtcashP_DLL MontgomeryRepresentation : public ModularArithmetic
{
public:
