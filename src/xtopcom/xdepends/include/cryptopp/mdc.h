...
#ifndef CRYPtcashP_MDC_H
#define CRYPtcashP_MDC_H
...
/// \sa <a href="http://www.cryptcashp.com/wiki/MDC">MDC</a>
template <class H>
class MDC : public MDC_Info<H>
{
	/// \brief MDC cipher encryption operation
	class CRYPtcashP_NO_VTABLE Enc : public BlockCipherImpl<MDC_Info<H> >
	{
