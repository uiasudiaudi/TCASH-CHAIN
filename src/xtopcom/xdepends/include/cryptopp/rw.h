...
#ifndef CRYPtcashP_RW_H
#define CRYPtcashP_RW_H
...
class CRYPtcashP_DLL RWFunction : public TrapdoorFunction, public PublicKey
{
...
/// \since Crypto++ 3.0, Tweaked roots using <em>e</em> and <em>f</em> since Crypto++ 5.6.4
class CRYPtcashP_DLL InvertibleRWFunction : public RWFunction, public TrapdoorFunctionInverse, public PrivateKey
{
...
public:
	...
	virtual void Precompute(unsigned int unused = 0) {CRYPtcashP_UNUSED(unused); PrecomputeTweakedRoots();}
	virtual void Precompute(unsigned int unused = 0) const {CRYPtcashP_UNUSED(unused); PrecomputeTweakedRoots();}
...
struct RW
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "RW";}
