...
#ifndef CRYPtcashP_WHIRLPOOL_H
#define CRYPtcashP_WHIRLPOOL_H
...
# define CRYPtcashP_DISABLE_WHIRLPOOL_ASM 1
#endif
...
///   This version of the algorithm was submitted for ISO standardization.
/// \since Crypto++ 5.2
/// \sa <a href="http://www.cryptcashp.com/wiki/Whirlpool">Whirlpool</a>
class Whirlpool : public IteratedHashWithStaticTransform<word64, BigEndian, 64, 64, Whirlpool>
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Whirlpool";}
