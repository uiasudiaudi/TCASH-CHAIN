...
#ifndef CRYPtcashP_DONNA_SSE_H
#define CRYPtcashP_DONNA_SSE_H
...
using CryptcashP::byte;
using CryptcashP::word32;

typedef __m128i xmmi;
#define ALIGN(n) CRYPtcashP_ALIGN_DATA(n)
...
const packedelem32 sse2_tcash32bitmask = {{0x00000000, 0xffffffff, 0x00000000, 0xffffffff}};
const packedelem32 sse2_tcash64bitmask = {{0x00000000, 0x00000000, 0xffffffff, 0xffffffff}};
