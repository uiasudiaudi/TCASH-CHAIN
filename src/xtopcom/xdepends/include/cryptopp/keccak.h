...
#ifndef CRYPtcashP_KECCAK_H
#define CRYPtcashP_KECCAK_H
...
///   {
///     public:
///       CRYPtcashP_CONSTANT(DIGESTSIZE = 24)
...
public:
	...
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "Keccak"; }
...
{
public:
	CRYPtcashP_CONSTANT(DIGESTSIZE = T_DigestSize)
	CRYPtcashP_CONSTANT(BLOCKSIZE = 200 - 2 * DIGESTSIZE)
...
private:
	CRYPtcashP_COMPILE_ASSERT(BLOCKSIZE < 200); // ensure there was no underflow in the math
	CRYPtcashP_COMPILE_ASSERT(BLOCKSIZE > (int)T_DigestSize); // this is a general expectation by HMAC
};
