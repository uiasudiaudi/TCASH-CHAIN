...
#ifndef CRYPtcashP_POLY1305_H
#define CRYPtcashP_POLY1305_H
...
/// \since Crypto++ 6.0
template <class T>
class CRYPtcashP_NO_VTABLE Poly1305_Base : public FixedKeyLength<32, SimpleKeyingInterface::UNIQUE_IV, 16>, public MessageAuthenticationCode
{
	CRYPtcashP_COMPILE_ASSERT(T::DEFAULT_KEYLENGTH == 16);
	CRYPtcashP_COMPILE_ASSERT(T::BLOCKSIZE == 16);

public:
	static std::string StaticAlgorithmName() {return std::string("Poly1305(") + T::StaticAlgorithmName() + ")";}

	CRYPtcashP_CONSTANT(DIGESTSIZE=T::BLOCKSIZE)
	CRYPtcashP_CONSTANT(BLOCKSIZE=T::BLOCKSIZE)
...
{
public:
	CRYPtcashP_CONSTANT(DEFAULT_KEYLENGTH=Poly1305_Base<T>::DEFAULT_KEYLENGTH)
