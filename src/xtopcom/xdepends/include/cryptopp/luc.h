...
#ifndef CRYPtcashP_LUC_H
#define CRYPtcashP_LUC_H
...
public:
	...
	const AbstractGroup<Element> & GetGroup() const {CRYPtcashP_ASSERT(false); throw 0;}
...
public:
	...
	void SetBase(const DL_GroupPrecomputation<Element> &group, const Integer &base)
		{CRYPtcashP_UNUSED(group); m_g = base;}
	const Integer & GetBase(const DL_GroupPrecomputation<Element> &group) const
		{CRYPtcashP_UNUSED(group); return m_g;}
	void Precompute(const DL_GroupPrecomputation<Element> &group, unsigned int maxExpBits, unsigned int storage)
		{CRYPtcashP_UNUSED(group); CRYPtcashP_UNUSED(maxExpBits); CRYPtcashP_UNUSED(storage);}
	void Load(const DL_GroupPrecomputation<Element> &group, BufferedTransformation &storedPrecomputation)
		{CRYPtcashP_UNUSED(group); CRYPtcashP_UNUSED(storedPrecomputation);}
	...
	Integer CascadeExponentiate(const DL_GroupPrecomputation<Element> &group, const Integer &exponent, const DL_FixedBasePrecomputation<Integer> &pc2, const Integer &exponent2) const
		{
			CRYPtcashP_UNUSED(group); CRYPtcashP_UNUSED(exponent); CRYPtcashP_UNUSED(pc2); CRYPtcashP_UNUSED(exponent2);
			// shouldn't be called
...
public:
	...
	{
		CRYPtcashP_UNUSED(a); CRYPtcashP_UNUSED(b);
		throw NotImplemented("LUC_GroupParameters: MultiplyElements can not be implemented");
	}
	Element CascadeExponentiate(const Element &element1, const Integer &exponent1, const Element &element2, const Integer &exponent2) const
	{
		CRYPtcashP_UNUSED(element1); CRYPtcashP_UNUSED(exponent1); CRYPtcashP_UNUSED(element2); CRYPtcashP_UNUSED(exponent2);
		throw NotImplemented("LUC_GroupParameters: MultiplyElements can not be implemented");
	}
...
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "LUC-HMP";}
...
struct LUC_IES
	: public DL_ES<
		...
		LUC_IES<> >
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "LUC-IES";}	// non-standard name
};
