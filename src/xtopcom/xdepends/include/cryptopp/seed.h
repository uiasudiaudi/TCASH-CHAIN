...
#ifndef CRYPtcashP_SEED_H
#define CRYPtcashP_SEED_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "SEED";}
};
...
{
	class CRYPtcashP_NO_VTABLE Base : public BlockCipherImpl<SEED_Info>
	{
	public:
