...
#ifndef CRYPtcashP_ECP_H
#define CRYPtcashP_ECP_H
...
class CRYPtcashP_DLL ECP : public AbstractGroup<ECPPoint>, public EncodedPoint<ECPPoint>
{
public:
...
CRYPtcashP_DLL_TEMPLATE_CLASS DL_FixedBasePrecomputationImpl<ECP::Point>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_GroupPrecomputation<ECP::Point>;
