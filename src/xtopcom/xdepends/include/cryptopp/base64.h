...
#ifndef CRYPtcashP_BASE64_H
#define CRYPtcashP_BASE64_H
...
private:
	...
	static const int * CRYPtcashP_API GetDecodingLookupArray();
};
...
public:
	...
	Base64URLEncoder(BufferedTransformation *attachment = NULLPTR, bool insertLineBreaks = false, int maxLineLength = -1)
		: SimpleProxyFilter(new BaseN_Encoder(new Grouper), attachment)
	{
		CRYPtcashP_UNUSED(insertLineBreaks), CRYPtcashP_UNUSED(maxLineLength);
