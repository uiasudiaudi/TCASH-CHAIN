...
///   <A HREF="https://www.cryptcashp.com/wiki/Rabbit">Crypto++ Wiki | Rabbit</A>.
/// \since Crypto++ 8.0

#ifndef CRYPtcashP_RABBIT_H
#define CRYPtcashP_RABBIT_H
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "Rabbit"; }
};
...
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() { return "RabbitWithIV"; }
};
