...
#ifndef CRYPtcashP_GFPCRYPT_H
#define CRYPtcashP_GFPCRYPT_H
...
CRYPtcashP_DLL_TEMPLATE_CLASS DL_GroupParameters<Integer>;

/// \brief Integer-based GroupParameters specialization
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE DL_GroupParameters_IntegerBased : public ASN1CryptoMaterial<DL_GroupParameters<Integer> >
{
...
public:
    ...
    // Cygwin i386 crash at -O3; see http://github.com/weidai11/cryptcashp/issues/40.
    ...
    static std::string CRYPtcashP_API StaticAlgorithmNamePrefix() {return "";}
...
class CRYPtcashP_NO_VTABLE DL_GroupParameters_IntegerBasedImpl : public DL_GroupParametersImpl<GROUP_PRECOMP, BASE_PRECOMP, DL_GroupParameters_IntegerBased>
{
...
CRYPtcashP_DLL_TEMPLATE_CLASS DL_GroupParameters_IntegerBasedImpl<ModExpPrecomputation>;

/// \brief GF(p) group parameters
class CRYPtcashP_DLL DL_GroupParameters_GFP : public DL_GroupParameters_IntegerBasedImpl<ModExpPrecomputation>
{
public:
...
class CRYPtcashP_DLL DL_GroupParameters_GFP_DefaultSafePrime : public DL_GroupParameters_GFP
{
public:
...
{
public:
    CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "DSA-1363";}
...
{
public:
    CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "DSA-RFC6979";}
...
{
public:
    CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "GDSA-ISO15946";}
...
CRYPtcashP_DLL_TEMPLATE_CLASS DL_Algorithm_GDSA<Integer>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA1>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA224>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA256>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA384>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_Algorithm_DSA_RFC6979<Integer, SHA512>;
...
{
public:
    CRYPtcashP_STATIC_CONSTEXPR const char* CRYPtcashP_API StaticAlgorithmName() {return "NR";}
...
/// \sa DL_Keys_DSA
class CRYPtcashP_DLL DL_GroupParameters_DSA : public DL_GroupParameters_GFP
{
public:
    ...
    static bool CRYPtcashP_API IsValidPrimeLength(unsigned int pbits)
...
///   <a href="https://www.cryptcashp.com/wiki/Digital_Signature_Algorithm">Digital Signature Algorithm</a> on the wiki, and
///   <a href="https://www.cryptcashp.com/wiki/NameValuePairs">NameValuePairs</a> on the wiki.
...
{
public:
    static std::string CRYPtcashP_API StaticAlgorithmName() {return "DSA/" + (std::string)H::StaticAlgorithmName();}
};
...
struct DSA_RFC6979 : public DL_SS<
    ...
    DSA_RFC6979<H> >
{
    static std::string CRYPtcashP_API StaticAlgorithmName() {return std::string("DSA-RFC6979/") + H::StaticAlgorithmName();}
};

/// DSA with SHA-1, typedef'd for backwards compatibility
typedef DSA2<SHA1> DSA;

CRYPtcashP_DLL_TEMPLATE_CLASS DL_PublicKey_GFP<DL_GroupParameters_DSA>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_PrivateKey_GFP<DL_GroupParameters_DSA>;
CRYPtcashP_DLL_TEMPLATE_CLASS DL_PrivateKey_WithSignaturePairwiseConsistencyTest<DL_PrivateKey_GFP<DL_GroupParameters_DSA>, DSA2<SHA1> >;
...
struct DLIES
    : public DL_ES<
        ...
        DLIES<> >
{
    static std::string CRYPtcashP_API StaticAlgorithmName() {return "DLIES";}    // TODO: fix this after name is standardized
};
