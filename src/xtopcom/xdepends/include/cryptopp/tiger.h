...
#ifndef CRYPtcashP_TIGER_H
#define CRYPtcashP_TIGER_H
...
# define CRYPtcashP_DISABLE_TIGER_ASM 1
#endif
...
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "Tiger";}
