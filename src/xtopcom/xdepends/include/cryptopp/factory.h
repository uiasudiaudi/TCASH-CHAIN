...
#ifndef CRYPtcashP_OBJFACT_H
#define CRYPtcashP_OBJFACT_H
...
public:
	...
	CRYPtcashP_NOINLINE static ObjectFactoryRegistry<AbstractClass, instance> & Registry(CRYPtcashP_NOINLINE_DOTDOTDOT);
...
ObjectFactoryRegistry<AbstractClass, instance> & ObjectFactoryRegistry<AbstractClass, instance>::Registry(CRYPtcashP_NOINLINE_DOTDOTDOT)
{
