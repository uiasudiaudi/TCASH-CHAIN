...
#ifndef CRYPtcashP_ESIGN_H
#define CRYPtcashP_ESIGN_H
...
{
public:
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "EMSA5";}
	...
	{
		CRYPtcashP_UNUSED(rng), CRYPtcashP_UNUSED(recoverableMessage), CRYPtcashP_UNUSED(recoverableMessageLength);
		CRYPtcashP_UNUSED(messageEmpty), CRYPtcashP_UNUSED(hashIdentifier);
...
struct ESIGN_Keys
{
	CRYPtcashP_STATIC_CONSTEXPR const char* StaticAlgorithmName() {return "ESIGN";}
