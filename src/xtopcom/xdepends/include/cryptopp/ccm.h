...
#ifndef CRYPtcashP_CCM_H
#define CRYPtcashP_CCM_H
...
/// \since Crypto++ 5.6.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE CCM_Base : public AuthenticatedSymmetricCipherBase
{
public:
	CCM_Base()
...
/// \sa <a href="http://www.cryptcashp.com/wiki/CCM_Mode">CCM Mode</a> and
