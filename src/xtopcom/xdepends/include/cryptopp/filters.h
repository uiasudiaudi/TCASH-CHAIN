...
#ifndef CRYPtcashP_FILTERS_H
#define CRYPtcashP_FILTERS_H
...
///   more details.
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE Filter : public BufferedTransformation, public NotCopyable
{
public:
	virtual ~Filter() {}
...
struct CRYPtcashP_DLL FilterPutSpaceHelper
{
	...
	{
		CRYPtcashP_ASSERT(desiredSize >= minSize && bufferSize >= minSize);
...
class CRYPtcashP_DLL MeterFilter : public Bufferless<Filter>
{
public:
	virtual ~MeterFilter() {}
	...
	void IsolatedInitialize(const NameValuePairs &parameters)
		{CRYPtcashP_UNUSED(parameters); ResetMeter();}
...
class CRYPtcashP_DLL TransparentFilter : public MeterFilter
{
public:
...
class CRYPtcashP_DLL OpaqueFilter : public MeterFilter
{
public:
...
class CRYPtcashP_DLL FilterWithBufferedInput : public Filter
{
public:
...
protected:
	...
	virtual void InitializeDerivedAndReturnNewSizes(const NameValuePairs &parameters, size_t &firstSize, size_t &blockSize, size_t &lastSize)
		{CRYPtcashP_UNUSED(parameters); CRYPtcashP_UNUSED(firstSize); CRYPtcashP_UNUSED(blockSize); CRYPtcashP_UNUSED(lastSize); InitializeDerived(parameters);}
	...
	virtual void NextPutSingle(const byte *inString)
		{CRYPtcashP_UNUSED(inString); CRYPtcashP_ASSERT(false);}
...
protected:
	...
	virtual int NextPut(const byte *inString, size_t length)
		{CRYPtcashP_UNUSED(inString); CRYPtcashP_UNUSED(length); CRYPtcashP_ASSERT(false); return 0;}
...
class CRYPtcashP_DLL FilterWithInputQueue : public Filter
{
public:
...
protected:
	...
	void IsolatedInitialize(const NameValuePairs &parameters)
		{CRYPtcashP_UNUSED(parameters); m_inQueue.Clear();}
...
/// \since Crypto++ 5.0
class CRYPtcashP_DLL StreamTransformationFilter : public FilterWithBufferedInput, public BlockPaddingSchemeDef, private FilterPutSpaceHelper
{
public:
...
/// \since Crypto++ 1.0
class CRYPtcashP_DLL HashFilter : public Bufferless<Filter>, private FilterPutSpaceHelper
{
public:
	virtual ~HashFilter() {}
...
/// \brief Filter wrapper for HashTransformation
/// \since Crypto++ 4.0
class CRYPtcashP_DLL HashVerificationFilter : public FilterWithBufferedInput
{
public:
...
/// \since Crypto++ 5.6.0
class CRYPtcashP_DLL AuthenticatedEncryptionFilter : public StreamTransformationFilter
{
public:
...
/// \since Crypto++ 5.6.0
class CRYPtcashP_DLL AuthenticatedDecryptionFilter : public FilterWithBufferedInput, public BlockPaddingSchemeDef
{
public:
	/// \enum Flags
	/// \brief Flags controlling filter behavior.
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL SignerFilter : public Unflushable<Filter>
{
public:
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL SignatureVerificationFilter : public FilterWithBufferedInput
{
public:
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL Redirector : public CustomSignalPropagation<Sink>
{
public:
	/// \enum Behavior
	...
	/// \brief Stcash redirecting input
	void StcashRedirection() {m_target = NULLPTR;}
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL OutputProxy : public CustomSignalPropagation<Sink>
{
public:
	virtual ~OutputProxy() {}
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL ProxyFilter : public FilterWithBufferedInput
{
public:
	virtual ~ProxyFilter() {}
...
/// \since Crypto++ 5.0
class CRYPtcashP_DLL SimpleProxyFilter : public ProxyFilter
{
public:
	...
	/// </pre>
	void LastPut(const byte *inString, size_t length)
		{CRYPtcashP_UNUSED(inString), CRYPtcashP_UNUSED(length); m_filter->MessageEnd();}
};
...
/// \since Crypto++ 5.0
class CRYPtcashP_DLL PK_EncryptorFilter : public SimpleProxyFilter
{
public:
...
/// \since Crypto++ 5.0
class CRYPtcashP_DLL PK_DecryptorFilter : public SimpleProxyFilter
{
public:
...
public:
	...
	StringSinkTemplate(T &output)
		: m_output(&output) {CRYPtcashP_ASSERT(sizeof(value_type)==1);}
	...
	size_t Put2(const byte *inString, size_t length, int messageEnd, bool blocking)
	{
		CRYPtcashP_UNUSED(messageEnd); CRYPtcashP_UNUSED(blocking);
		if (length > 0)
		{
...
CRYPtcashP_DLL_TEMPLATE_CLASS StringSinkTemplate<std::string>;
...
CRYPtcashP_DLL_TEMPLATE_CLASS StringSinkTemplate<std::vector<byte> >;
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL ArraySink : public Bufferless<Sink>
{
public:
	virtual ~ArraySink() {}
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL ArrayXorSink : public ArraySink
{
public:
...
public:
	...
	CRYPtcashP_DLL size_t TransferTo2(BufferedTransformation &target, lword &transferBytes, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true);
	CRYPtcashP_DLL size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const;

private:
	CRYPtcashP_DLL void StoreInitialize(const NameValuePairs &parameters);
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL RandomNumberStore : public Store
{
public:
	...
	size_t CopyRangeTo2(BufferedTransformation &target, lword &begin, lword end=LWORD_MAX, const std::string &channel=DEFAULT_CHANNEL, bool blocking=true) const
	{
		CRYPtcashP_UNUSED(target); CRYPtcashP_UNUSED(begin); CRYPtcashP_UNUSED(end); CRYPtcashP_UNUSED(channel); CRYPtcashP_UNUSED(blocking);
...
/// \brief Empty store
/// \since Crypto++ 5.0
class CRYPtcashP_DLL NullStore : public Store
{
public:
...
/// \since Crypto++ 1.0
class CRYPtcashP_DLL CRYPtcashP_NO_VTABLE Source : public InputRejecting<Filter>
{
public:
	virtual ~Source() {}
...
/// \since Crypto++ 4.0
class CRYPtcashP_DLL StringSource : public SourceTemplate<StringStore>
{
public:
...
/// \since Crypto++ 8.0
class CRYPtcashP_DLL VectorSource : public SourceTemplate<StringStore>
{
public:
...
/// \brief RNG-based implementation of Source interface
/// \since Crypto++ 4.0
class CRYPtcashP_DLL RandomNumberSource : public SourceTemplate<RandomNumberStore>
{
public:
