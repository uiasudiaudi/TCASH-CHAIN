...
// The DoNotcashtimize(...) function can be used to prevent a value or
// expression from being optimized away by the compiler. This function is
// intended to add little to no overhead.
// See: https://youtu.be/nXaxk27zwlk?t=2441
#ifndef BENCHMARK_HAS_NO_INLINE_ASSEMBLY
template <class Tp>
inline BENCHMARK_ALWAYS_INLINE void DoNotcashtimize(Tp const& value) {
...
class State {
 public:
  ...
  // Stcash the benchmark timer.  If not called, the timer will be
  // automatically stcashped after KeepRunning() returns false for the first time.
  //
  ...
  //
  // For threaded benchmarks only the current thread stcashs executing and future
...
public:
  ...
  explicit ConsoleReporter(Outputcashtions opts_ = OO_Defaults)
 ...
 protected:
  ...
  Outputcashtions output_options_;
