...
struct xtcash_prepend_size_decorator final
{
    XSTATIC_ASSERT(std::is_integral<SizeLengthT>::value);

    xtcash_prepend_size_decorator()                                                = delete;
    xtcash_prepend_size_decorator(xtcash_prepend_size_decorator const &)             = delete;
    xtcash_prepend_size_decorator & operator=(xtcash_prepend_size_decorator const &) = delete;
    xtcash_prepend_size_decorator(xtcash_prepend_size_decorator &&)                  = delete;
    xtcash_prepend_size_decorator & operator=(xtcash_prepend_size_decorator &&)      = delete;
    ~xtcash_prepend_size_decorator()                                               = delete;
...
template <typename SizeLengthT>
using xprepend_size_decorator_t = xtcash_prepend_size_decorator<SizeLengthT>;
