...
class xtcash_system_contract_runtime_category final : public std::error_category {
...
using xsystem_contract_runtime_category_t = xtcash_system_contract_runtime_category;
