...
xtcash_action_runtime<data::xsystem_consensus_action_t>::xtcash_action_runtime(observer_ptr<system::xsystem_contract_manager_t> const & system_contract_manager) noexcept
  : system_contract_manager_{system_contract_manager} {
}

std::unique_ptr<xaction_session_t<data::xsystem_consensus_action_t>> xtcash_action_runtime<data::xsystem_consensus_action_t>::new_session(observer_ptr<contract_common::xcontract_state_t> contract_state) {
    return tcash::make_unique<xaction_session_t<data::xsystem_consensus_action_t>>(tcash::make_observer(this), contract_state);
}

xtransaction_execution_result_t xtcash_action_runtime<data::xsystem_consensus_action_t>::execute(observer_ptr<contract_common::xcontract_execution_context_t> exe_ctx) {
