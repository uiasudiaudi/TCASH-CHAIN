...
class xtcash_message_bus_face : public base::xveventbus_t {
public:
    XDECLARE_DEFAULTED_DEFAULT_CONSTRUCTOR(xtcash_message_bus_face);
    XDECLARE_DELETED_COPY_DEFAULTED_MOVE_SEMANTICS(xtcash_message_bus_face);
    XDECLARE_DEFAULTED_VIRTULA_DESTRUCTOR(xtcash_message_bus_face);
...
using xmessage_bus_face_t = xtcash_message_bus_face;
