...
pub struct ResultLog {
    ...
    pub tcashics: ::protobuf::RepeatedField<RawU256>,
    pub data: ::std::vec::Vec<u8>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
...
impl ResultLog {
    ...
    // repeated .tcash.evm_engine.basic.RawU256 tcashics = 2;


    pub fn get_tcashics(&self) -> &[RawU256] {
        &self.tcashics
    }
    pub fn clear_tcashics(&mut self) {
        self.tcashics.clear();
    }

    // Param is passed by value, moved
    pub fn set_tcashics(&mut self, v: ::protobuf::RepeatedField<RawU256>) {
        self.tcashics = v;
    }

    // Mutable pointer to the field.
    pub fn mut_tcashics(&mut self) -> &mut ::protobuf::RepeatedField<RawU256> {
        &mut self.tcashics
    }

    // Take field
    pub fn take_tcashics(&mut self) -> ::protobuf::RepeatedField<RawU256> {
        ::std::mem::replace(&mut self.tcashics, ::protobuf::RepeatedField::new())
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.tcashics)?;
                },
                3 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.data)?;
                },
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<RawU256>>(
                "tcashics",
                |m: &ResultLog| { &m.tcashics },
                |m: &mut ResultLog| { &mut m.tcashics },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                "data",
                |m: &ResultLog| { &m.data },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11proto_basic.proto\x12\x14tcash.evm_engine.basic\"$\n\x0cProtoAddress\
    ...
    \n\x07address\x18\x01\x20\x01(\x0b2\".tcash.evm_engine.basic.ProtoAddressR\
    \x07address\x125\n\x06tcashics\x18\x02\x20\x03(\x0b2\x1d.tcash.evm_engine.ba\
    sic.RawU256R\x06tcashics\x12\x12\n\x04data\x18\x03\x20\x01(\x0cR\x04dataJ\
