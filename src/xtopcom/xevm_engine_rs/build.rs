...
#[cfg(feature = "build_as_xtcash_lib")]
fn main() {
    ...
    // product:
    // from: cbuild/src/xtcashcom/xevm_engine_rs/debug/build/xevm_engine-94e9d92524952b17/out/
    // to  : cbuild/lib/Linux
    Command::new("cp")
        .arg("-f")
        .arg(&format!(
...
#[cfg(not(feature = "build_as_xtcash_lib"))]
fn main() {}
