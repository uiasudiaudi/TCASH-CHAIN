...
#    include <json/json.h>
#    include "xtcashcl/include/request_result_definition.h"
...
public:
    ...
    virtual int encode_transaction_params(Json::Value & root, tcash::data::xtransaction_t * trans_action);
    void set_transaction(tcash::data::xtransaction_ptr_t & val);
...
protected:
    ...
    tcash::data::xtransaction_ptr_t trans_action_;
};
