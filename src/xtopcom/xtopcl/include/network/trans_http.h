...
#include "xtcashcl/include/network/trans_base.h"
...
class trans_http_client : public tcash::xhttp::xhttp_client_async_base_t {
private:
    using base_t = tcash::xhttp::xhttp_client_async_base_t;
