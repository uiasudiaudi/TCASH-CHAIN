...
#define XGET_CONFIG(NAME) static_cast<tcash::config::xconfig_register_t const &>(tcash::config::xconfig_register_t::get_instance()).get<tcash::config::x ## NAME ## _configuration_t>()
#define XGET_ONCHAIN_GOVERNANCE_PARAMETER(NAME) static_cast<tcash::config::xconfig_register_t const &>(tcash::config::xconfig_register_t::get_instance()).get<tcash::config::x ## NAME ## _onchain_goverance_parameter_t>()

#define XSET_CONFIG(NAME, v) tcash::config::xconfig_register_t::get_instance().set(tcash::config::x ## NAME ## _configuration_t::name, v)
#define XSET_ONCHAIN_GOVERNANCE_PARAMETER(NAME, v)tcash::config::xconfig_register_t::get_instance().set(tcash::config::x ## NAME ## _onchain_goverance_parameter_t::name, v)