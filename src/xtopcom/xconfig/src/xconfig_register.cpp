...
#define XADD_OFFCHAIN_PARAMETER(NAME)                                                                                                                                              \
    m_params_map.insert({tcash::config::x##NAME##_configuration_t::name,                                                                                                             \
                         tcash::config::xto_string_helper_t<tcash::config::x##NAME##_configuration_t::type>::to_string(tcash::config::x##NAME##_configuration_t::value)})
