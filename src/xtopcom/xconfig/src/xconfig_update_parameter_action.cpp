...
bool xconfig_incremental_add_update_parameter_action_t::do_update(const std::map<std::string, std::string>& params) {
    ...
    for (auto const& item: params) {
        ...
        target_param[item.first] = xtcash_config_utility::incremental_add_bwlist(result, item.second);
...
bool xconfig_incremental_delete_update_parameter_action_t::do_update(const std::map<std::string, std::string>& params) {
    ...
    for (auto const& item: params) {
        ...
        target_param[item.first] = xtcash_config_utility::incremental_delete_bwlist(result, item.second);
...
std::string xtcash_config_utility::incremental_add_bwlist(std::string const& bwlist, std::string const& value) {
...
std::string  xtcash_config_utility::incremental_delete_bwlist(std::string const& bwlist, std::string const& value) {
