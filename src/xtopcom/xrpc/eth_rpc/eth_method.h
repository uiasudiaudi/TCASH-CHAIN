...
public:
    EthMethod() {
        ...
        m_supported_method.insert("tcashRelay_getPolyBlockHashListByHash");
        m_supported_method.insert("tcashRelay_getLeafBlockHashListByHash");
        m_supported_method.insert("tcashRelay_getBlockByNumber");
        m_supported_method.insert("tcashRelay_getBlockByHash");
        m_supported_method.insert("tcashRelay_blockNumber");
        m_supported_method.insert("tcashRelay_getTransactionByHash");
        m_supported_method.insert("tcashRelay_getTransactionReceipt");

        m_supported_method.insert("tcash_getBalance");
    }
