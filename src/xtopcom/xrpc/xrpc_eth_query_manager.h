...
public:
    ...
    void tcashRelay_getBlockByNumber(Json::Value & js_req, Json::Value & js_rsp, string & strResult, uint32_t & nErrorCode);
    void tcashRelay_getBlockByHash(Json::Value & js_req, Json::Value & js_rsp, string & strResult, uint32_t & nErrorCode);
    void tcashRelay_blockNumber(Json::Value & js_req, Json::Value & js_rsp, string & strResult, uint32_t & nErrorCode);
    void tcashRelay_getTransactionByHash(Json::Value & js_req, Json::Value & js_rsp, string & strResult, uint32_t & nErrorCode);
    void tcashRelay_getTransactionReceipt(Json::Value & js_req, Json::Value & js_rsp, string & strResult, uint32_t & nErrorCode);

    void tcash_getBalance(Json::Value & js_req, Json::Value & js_rsp, string & strResult, uint32_t & nErrorCode);
private:
    ...
    int get_log(Json::Value & js_rsp, const uint64_t begin, const uint64_t end, const std::vector<std::set<std::string>>& vtcashics, const std::set<std::string>& sAddress);
    bool check_log_is_match(evm_common::xevm_log_t const& log, const std::vector<std::set<std::string>>& vtcashics, const std::set<std::string>& sAddress) const;
    bool check_block_log_bloom(xobject_ptr_t<base::xvblock_t>& block, const std::vector<std::set<std::string>>& vtcashics, const std::set<std::string>& sAddress) const;
    int parse_tcashics(const Json::Value& t, std::vector<std::set<std::string>>& vtcashics, Json::Value & js_rsp);
