...
void xfilter_manager::sendTransaction_filter(xjson_proc_t & json_proc) {
    ...
    if (version == data::xtransaction_version_2) {
        ...
        CONDTION_FAIL_THROW(tcash::xverifier::xverifier_error::xverifier_success == xverifier::xtx_utl::address_is_valid(src_addr, true), enum_xrpc_error_code::rpc_param_param_error, "sender_account invalid");
        CONDTION_FAIL_THROW(tcash::xverifier::xverifier_error::xverifier_success == xverifier::xtx_utl::address_is_valid(dst_addr, true), enum_xrpc_error_code::rpc_param_param_error, "receiver_account invalid");
        ...
        CONDTION_FAIL_THROW(tcash::xverifier::xverifier_error::xverifier_success == xverifier::xtx_utl::address_is_valid(src_addr, true), enum_xrpc_error_code::rpc_param_param_error, "tx_sender_account_addr invalid");
        CONDTION_FAIL_THROW(tcash::xverifier::xverifier_error::xverifier_success == xverifier::xtx_utl::address_is_valid(dst_addr, true), enum_xrpc_error_code::rpc_param_param_error, "tx_receiver_account_addr invalid");    
    }
