...
class xtcash_gasfee_evm
  : public xgas_state_operator_t
  , public xgas_tx_operator_t {
public:
    xtcash_gasfee_evm(std::shared_ptr<data::xunit_bstate_t> const & state, xobject_ptr_t<data::xcons_transaction_t> const & tx, uint64_t time);
...
private:
    evm_common::u256 m_max_converted_utcash{0};
...
using xgasfee_evm_t = xtcash_gasfee_evm;
