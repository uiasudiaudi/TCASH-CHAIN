...
class xtcash_gasfee_category : public std::error_category {
public:
...
using xgasfee_category_t = xtcash_gasfee_category;
...
size_t hash<tcash::gasfee::error::xerrc_t>::operator()(tcash::gasfee::error::xerrc_t errc) const noexcept {
    return static_cast<size_t>(static_cast<std::underlying_type<tcash::gasfee::error::xerrc_t>::type>(errc));
}
