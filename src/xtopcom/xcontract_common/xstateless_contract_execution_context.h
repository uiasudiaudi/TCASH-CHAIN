...
class xtcash_stateless_contract_execution_context {
public:
    xtcash_stateless_contract_execution_context() = delete;
    xtcash_stateless_contract_execution_context(xtcash_stateless_contract_execution_context const &) = delete;
    xtcash_stateless_contract_execution_context & operator=(xtcash_stateless_contract_execution_context const &) = delete;
    xtcash_stateless_contract_execution_context(xtcash_stateless_contract_execution_context &&) = default;
    xtcash_stateless_contract_execution_context & operator=(xtcash_stateless_contract_execution_context &&) = default;
    ~xtcash_stateless_contract_execution_context() = default;

    explicit xtcash_stateless_contract_execution_context(observer_ptr<data::xunit_bstate_t> unitstate_owned) : m_unitstate_owned{unitstate_owned} {
        xassert(unitstate_owned != nullptr);
    }

    xtcash_stateless_contract_execution_context(observer_ptr<data::xunit_bstate_t> unitstate_owned, observer_ptr<data::xunit_bstate_t> unitstate_other)
...
using xstateless_contract_execution_context_t = xtcash_stateless_contract_execution_context;
