...
public:
    xtcash_basic_property(xtcash_basic_property const &) = delete;
    xtcash_basic_property & operator=(xtcash_basic_property const &) = delete;
    xtcash_basic_property(xtcash_basic_property &&) = default;
    xtcash_basic_property & operator=(xtcash_basic_property &&) = default;
    virtual ~xtcash_basic_property() = default;

protected:
    xtcash_basic_property() = default;

    xtcash_basic_property(std::string const & name,
...
using xbasic_property_t = xtcash_basic_property;
