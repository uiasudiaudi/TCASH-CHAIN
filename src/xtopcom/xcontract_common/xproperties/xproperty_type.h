...
struct xtcash_property_type_of;

template <state_accessor::properties::xproperty_type_t PropertyTypeV, typename ... Ts>
using xproperty_type_of_t = xtcash_property_type_of<PropertyTypeV, Ts...>;

template <>
struct xtcash_property_type_of<state_accessor::properties::xproperty_type_t::bytes> {
    using type = xbytes_property_t;
};

template <>
struct xtcash_property_type_of<state_accessor::properties::xproperty_type_t::int64> {
    using type = xint64_property_t;
};

template <>
struct xtcash_property_type_of<state_accessor::properties::xproperty_type_t::uint64> {
    using type = xuint64_property_t;
};

template <typename KeyT, typename ValueT>
struct xtcash_property_type_of<state_accessor::properties::xproperty_type_t::map, KeyT, ValueT> {
    using type = xmap_property_t<KeyT, ValueT>;
};

template <>
struct xtcash_property_type_of<state_accessor::properties::xproperty_type_t::string> {
    using type = xstring_property_t;
};

template <>
struct xtcash_property_type_of<state_accessor::properties::xproperty_type_t::token> {
