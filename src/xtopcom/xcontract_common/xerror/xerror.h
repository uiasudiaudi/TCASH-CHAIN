...
NS_BEG3(tcash, contract_common, error)
...
template <>
struct is_error_code_enum<tcash::contract_common::error::xerrc_t> : std::true_type {};

template <>
struct is_error_condition_enum<tcash::contract_common::error::xerrc_t> : std::true_type {};
