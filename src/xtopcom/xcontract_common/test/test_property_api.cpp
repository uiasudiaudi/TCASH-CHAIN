...
protected:
    void SetUp() override {
        ...
        tcash::base::xvblock_t::register_object(tcash::base::xcontext_t::instance());
        xproperty_access_control_data_t access_data;
        tcash::observer_ptr<xvbstate_t> vbstate{new xvbstate_t{address, (uint64_t)1, (uint64_t)1, std::string(), std::string(), (uint64_t)0, (uint32_t)0, (uint16_t)0}};
