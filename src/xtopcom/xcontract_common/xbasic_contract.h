...
struct xtcash_contract_metadata {
    xtcash_contract_metadata() = default;
    xtcash_contract_metadata(xtcash_contract_metadata const& meta) = default;
    xtcash_contract_metadata(common::xaccount_address_t const& account, xcontract_type_t type = xcontract_type_t::system);

    xcontract_type_t m_type{ xcontract_type_t::invalid };
    common::xaccount_address_t m_account{};
};

class xtcash_basic_contract : public xcontract_face_t {
protected:
...
protected:
    xtcash_basic_contract() = default;

public:
    xtcash_basic_contract(xtcash_basic_contract const &) = delete;
    xtcash_basic_contract & operator=(xtcash_basic_contract const &) = delete;
    xtcash_basic_contract(xtcash_basic_contract &&) = default;
    xtcash_basic_contract & operator=(xtcash_basic_contract &&) = default;
    ~xtcash_basic_contract() override = default;
