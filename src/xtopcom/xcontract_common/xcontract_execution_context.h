...
class xtcash_contract_execution_context {
private:
    observer_ptr<xcontract_state_t> m_contract_state{};
    std::unique_ptr<data::xbasic_tcash_action_t const> m_action;
...
public:
    xtcash_contract_execution_context() = default;
    xtcash_contract_execution_context(xtcash_contract_execution_context const &) = delete;
    xtcash_contract_execution_context & operator=(xtcash_contract_execution_context const &) = delete;
    xtcash_contract_execution_context(xtcash_contract_execution_context &&) = default;
    xtcash_contract_execution_context & operator=(xtcash_contract_execution_context &&) = default;
    ~xtcash_contract_execution_context() = default;

    explicit xtcash_contract_execution_context(std::unique_ptr<data::xbasic_tcash_action_t const> action, observer_ptr<xcontract_state_t> s) noexcept;
...
using xcontract_execution_context_t = xtcash_contract_execution_context;
