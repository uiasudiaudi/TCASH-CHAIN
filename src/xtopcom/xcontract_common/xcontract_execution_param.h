...
struct xtcash_contract_execution_param {
    ...
    xtcash_contract_execution_param() = default;
    xtcash_contract_execution_param(data::xblock_consensus_para_t const & cs_para) {
...
using xcontract_execution_param_t = xtcash_contract_execution_param;
