...
struct xtcash_followup_transaction_delay_param {
    ...
    xtcash_followup_transaction_delay_param() = default;
    xtcash_followup_transaction_delay_param(xdelay_followup_type_t type_,
                                          uint64_t time_,
...
using xfollowup_transaction_delay_param_t = xtcash_followup_transaction_delay_param;

struct xtcash_followup_transaction_datum {
    xtcash_followup_transaction_datum() = default;
    xtcash_followup_transaction_datum(xtcash_followup_transaction_datum const &) = default;
    xtcash_followup_transaction_datum & operator=(xtcash_followup_transaction_datum const &) = default;
    xtcash_followup_transaction_datum(xtcash_followup_transaction_datum &&) = default;
    xtcash_followup_transaction_datum & operator=(xtcash_followup_transaction_datum &&) = default;
    ~xtcash_followup_transaction_datum() = default;

    xtcash_followup_transaction_datum(data::xcons_transaction_ptr_t && tx, xfollowup_transaction_schedule_type_t type);
...
using xfollowup_transaction_datum_t = xtcash_followup_transaction_datum;
