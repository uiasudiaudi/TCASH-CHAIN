...
class xtcash_blockmaker_category : public std::error_category {
public:
...
using xblockmaker_category_t = xtcash_blockmaker_category;
...
size_t hash<tcash::blockmaker::error::xerrc_t>::operator()(tcash::blockmaker::error::xerrc_t errc) const noexcept {
    return static_cast<size_t>(static_cast<std::underlying_type<tcash::blockmaker::error::xerrc_t>::type>(errc));
}
