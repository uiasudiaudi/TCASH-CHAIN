...
static std::vector<std::string> pri_pub_vec{
    ...
    std::string("A/hEj061/QKVVcW34IJO4T9h8fPQzH1tcashd1KsGFU4ef"),
    ...
    std::string("+FIMTuL/gKhMBor/5dYQ9LNZDPtcash9XW7TOOEFzaUbY="),
    ...
    std::string("A73yU7tfEXlibFL9tcashmfHigjJCeB6oE6ndLRiUrwJQZ"),
    ...
    std::string("rBrDcK1mLjzrbu5YJHZdJkXFv4kKDyT2rmA72mRtcash8="),
