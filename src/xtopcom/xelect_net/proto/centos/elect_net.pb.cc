...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tcash::elect::protobuf::VhostMessage, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tcash::elect::protobuf::VhostMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tcash::elect::protobuf::VhostMessage, type_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tcash::elect::protobuf::VhostMessage, data_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tcash::elect::protobuf::VhostMessage, cb_type_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::tcash::elect::protobuf::VhostMessage, node_id_),
  2,
  0,
  3,
  1,
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::tcash::elect::protobuf::_VhostMessage_default_instance_),
};
...
VhostMessage::VhostMessage()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:tcash.elect.protobuf.VhostMessage)
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:tcash.elect.protobuf.VhostMessage)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:tcash.elect.protobuf.VhostMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:tcash.elect.protobuf.VhostMessage)
  return false;
#undef DO_
}
...
void VhostMessage::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:tcash.elect.protobuf.VhostMessage)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:tcash.elect.protobuf.VhostMessage)
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tcash::elect::protobuf::VhostMessage* Arena::CreateMaybeMessage< ::tcash::elect::protobuf::VhostMessage >(Arena* arena) {
  return Arena::CreateInternal< ::tcash::elect::protobuf::VhostMessage >(arena);
}
}  // namespace protobuf
}  // namespace google
