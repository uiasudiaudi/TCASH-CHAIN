...
class xtcash_genesis_category : public std::error_category {
public:
...
using xgenesis_category_t = xtcash_genesis_category;
...
size_t hash<tcash::genesis::error::xerrc_t>::operator()(tcash::genesis::error::xerrc_t errc) const noexcept {
    return static_cast<size_t>(static_cast<std::underlying_type<tcash::genesis::error::xerrc_t>::type>(errc));
}
