    ...
    do {                                                                                                                                                                           \
        ...
        if (action_name != api_name) {                                                                                                                                             \
            break;                                                                                                                                                                 \
                                                                                                                                                                                   ...
                                                                                                                                                                                   \
        try {                                                                                                                                                                      \
            tcash::txexecutor::contract::call_contract_api(this, stream, std::mem_fn(&CONTRACT_API), &CONTRACT_API);                                                                 \
...
#define BEGIN_CONTRACT_API()                                                                                                                                                       \
    tcash::contract_common::xcontract_execution_result_t execute(observer_ptr<tcash::contract_common::xstateless_contract_execution_context_t> exe_ctx) override {                     \
