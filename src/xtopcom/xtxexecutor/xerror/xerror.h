...
enum class xenum_errc {
    ...
    xtransaction_non_tcash_token_illegal,
...
template <>
struct hash<tcash::txexecutor::error::xerrc_t> final {
    size_t operator()(tcash::txexecutor::error::xerrc_t errc) const noexcept;
};

#endif

template <>
struct is_error_code_enum<tcash::txexecutor::error::xerrc_t> : std::true_type {
};

template <>
struct is_error_condition_enum<tcash::txexecutor::error::xerrc_t> : std::true_type {
};
