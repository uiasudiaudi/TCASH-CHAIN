...
NS_BEG3(tcash, state_accessor, error)
...
class xtcash_state_category final : public std::error_category {
public:
...
using xstate_category_t = xtcash_state_category;
...
size_t hash<tcash::state_accessor::error::xerrc_t>::operator()(tcash::state_accessor::error::xerrc_t errc) const noexcept {
    return static_cast<size_t>(static_cast<std::underlying_type<tcash::state_accessor::error::xerrc_t>::type>(errc));
}
