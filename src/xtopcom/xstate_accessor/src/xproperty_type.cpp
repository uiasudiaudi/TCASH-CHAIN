...
size_t hash<tcash::state_accessor::properties::xproperty_type_t>::operator()(tcash::state_accessor::properties::xproperty_type_t const property_type) const noexcept {
    return static_cast<size_t>(static_cast<std::underlying_type<tcash::state_accessor::properties::xproperty_type_t>::type>(property_type));
}
