...
NS_BEG3(tcash, contract_vm, error)
...
template <>
struct is_error_code_enum<tcash::contract_vm::error::xerrc_t> : std::true_type {};

template <>
struct is_error_condition_enum<tcash::contract_vm::error::xerrc_t> : std::true_type {};
