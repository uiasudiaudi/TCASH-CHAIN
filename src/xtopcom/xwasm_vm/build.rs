...
fn main() {
    ...
    // Command::new("cp")
    //     .args(&["/home/charles/Eluvk-project/tcash-chain/cbuild/lib/Linux/libxcontract_api.a"])
    //     .arg(&format!("{}/libxcontract_api.a", out_dir))
    //     .status()
    //     .unwrap();

    // .args(&["/home/charles/Eluvk-project/tcash-chain/cbuild/lib/Linux/libxcontract_api.so"])
