...
class xtransaction_t : virtual public base::xrefcount_t {
 ...
 public: // header
    ...
    virtual tcash::evm_common::u256 get_amount_256() const noexcept = 0;
    virtual bool is_tcash_transfer() const noexcept = 0;
    ...
    virtual const tcash::evm_common::u256 get_gaslimit() const { return 0; }
    virtual const tcash::evm_common::u256 get_max_fee_per_gas() const { return 0; }
    virtual const tcash::evm_common::u256 get_max_priority_fee_per_gas() const { return 0; }
