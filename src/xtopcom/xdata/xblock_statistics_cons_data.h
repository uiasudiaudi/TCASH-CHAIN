...
struct xtcash_account_statistics_cons_data : public xserializable_based_on<void> {
...
using xaccount_statistics_cons_data_t = xtcash_account_statistics_cons_data;
...
struct xtcash_group_statistics_cons_data : public xserializable_based_on<void> {
...
using xgroup_statistics_cons_data_t = xtcash_group_statistics_cons_data;
...
struct xtcash_election_statistics_cons_data : public xserializable_based_on<void> {
    ...
    JsonObjectT to_json_object() const {
        ...
        for (auto const & group_data : group_statistics_data) {
            ...
            auto const & group_statistics_datum = tcash::get<xgroup_statistics_cons_data_t>(group_data);
...
using xelection_statistics_cons_data_t = xtcash_election_statistics_cons_data;
...
struct xtcash_statistics_cons_data : public xserializable_based_on<void> {
    ...
    JsonObjectT to_json_object() const {
        ...
        for (auto const & table_data : detail) {
            ...
            auto const & election_statistics_datum = tcash::get<xelection_statistics_cons_data_t>(table_data);
...
using xstatistics_cons_data_t = xtcash_statistics_cons_data;
