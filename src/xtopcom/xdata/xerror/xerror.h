...
template <>
struct is_error_code_enum<tcash::data::error::xerrc_t> : std::true_type {};

template <>
struct is_error_condition_enum<tcash::data::error::xerrc_t> : std::true_type {};
