...
class xtransaction_v3_t : public xbase_dataunit_t<xtransaction_v3_t, xdata_type_transaction_v3>, public xtransaction_t, public xstatistic::xstatistic_obj_face_t {
 ...
 public:
    ...
    virtual tcash::evm_common::u256 get_amount_256() const noexcept override { return m_ethtx.get_value(); }
    virtual bool is_tcash_transfer() const noexcept override { return false; }
...
public:
    ...
    virtual const tcash::evm_common::u256 get_gaslimit() const override {return m_ethtx.get_gas(); }
    virtual const tcash::evm_common::u256 get_max_fee_per_gas() const override { return m_ethtx.get_max_fee_per_gas(); }
    virtual const tcash::evm_common::u256 get_max_priority_fee_per_gas() const override { return m_ethtx.get_max_priority_fee_per_gas(); }
