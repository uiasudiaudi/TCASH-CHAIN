...
bool xtcash_blacklist_utl::is_black_address(std::string const& addr) {
...
bool xtcash_blacklist_utl::is_black_address(std::string const& tx_source_addr, std::string const& tx_target_addr) {
    auto black_addrs = black_config();
    if (!black_addrs.empty()) {
...
std::set<std::string>  xtcash_blacklist_utl::black_config() {
...
std::vector<std::string> xtcash_blacklist_utl::refresh_and_get_new_addrs() {
