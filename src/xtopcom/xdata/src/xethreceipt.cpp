...
void xeth_store_receipt_t::decodeRLP(evm_common::RLP const& _r, std::error_code & ec) {
    ...
    {
        xwarn("xeth_store_receipt_t::decodeRLP invalid,field=%d,%s", field, tcash::to_hex(_r[field].toString()).c_str());
        ec = common::error::xerrc_t::invalid_rlp_stream;
    }
    return;
}
...
void xeth_receipt_t::decodeRLP(evm_common::RLP const& _r, std::error_code & ec) {
    ...
    {
        xwarn("xeth_receipt_t::decodeRLP invalid,field=%d,%s", field, tcash::to_hex(_r[field].toString()).c_str());
        ec = common::error::xerrc_t::invalid_rlp_stream;
    }
    return;
}
