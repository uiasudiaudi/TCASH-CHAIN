...
void xmemcheck_dbgplugin_t::xmemcheck_dbg_init() {
    ...
    tcash::base::xcontext_t::instance().set_debug_modes(tcash::base::xcontext_t::enum_debug_mode_memory_check);
    tcash::base::xcontext_t::instance().set_debug_plugin(dbg_plugin);
}
