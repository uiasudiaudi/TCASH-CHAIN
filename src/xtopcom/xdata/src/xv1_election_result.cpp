...
xtcash_election_result::iterator xtcash_election_result::insert(const_iterator hint, value_type const & v) {
    return m_cluster_results.insert(hint, v);
}

xtcash_election_result::iterator xtcash_election_result::insert(const_iterator hint, value_type && v) {
...
v0::xelection_result_t xtcash_election_result::v0() const {
