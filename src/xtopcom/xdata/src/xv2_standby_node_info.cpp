...
uint64_t xtcash_standby_node_info::raw_credit_score(common::xnode_type_t const node_type) const noexcept {
...
void xtcash_standby_node_info::raw_credit_score(common::xnode_type_t const node_type, uint64_t const value) noexcept {
    raw_credit_scores[node_type] = value;
}

v1::xstandby_node_info_t xtcash_standby_node_info::v1() const {
