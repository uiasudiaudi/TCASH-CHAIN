...
xtcash_standby_result_store::iterator xtcash_standby_result_store::insert(const_iterator hint, value_type const & value) {
    return m_results.insert(hint, value);
}

xtcash_standby_result_store::iterator xtcash_standby_result_store::insert(const_iterator hint, value_type && value) {
...
v0::xstandby_result_store_t xtcash_standby_result_store::v0() const {
