...
struct xtcash_fulltableblock_account_data : public xserializable_based_on<void> {
...
using xfulltableblock_account_data_t = xtcash_fulltableblock_account_data;
...
struct xtcash_fulltableblock_group_data : public xserializable_based_on<void> {
...
using xfulltableblock_group_data_t = xtcash_fulltableblock_group_data;
...
struct xtcash_fulltableblock_statistic_accounts : public xserializable_based_on<void> {
...
using xfulltableblock_statistic_accounts = xtcash_fulltableblock_statistic_accounts;
