...
public:
    ...
    static xtransaction_ptr_t create_genesis_tx_with_balance(const std::string & account, int64_t tcash_balance);
    ...
    static xtransaction_ptr_t create_ethcall_v3_tx(const std::string & from, 
                                                   ...
                                                   const tcash::evm_common::u256 & value,
                                                   const tcash::evm_common::u256 & gas,
