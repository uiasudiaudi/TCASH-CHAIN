...
struct xtcash_block_data : public xserializable_based_on<void> {
...
using xblock_data_t = xtcash_block_data;
...
struct xtcash_consensus_vote_data : public xserializable_based_on<void> {
    uint32_t block_count{0};
...
using xconsensus_vote_data_t = xtcash_consensus_vote_data;
...
struct xtcash_account_related_statistics_data : public xserializable_based_on<void> {
...
using xaccount_related_statistics_data_t = xtcash_account_related_statistics_data;
...
struct xtcash_group_releated_statistics_data : public xserializable_based_on<void> {
...
using xgroup_related_statistics_data_t = xtcash_group_releated_statistics_data;
...
struct xtcash_election_related_statistics_data : public xserializable_based_on<void> {
    ...
    JsonObjectT to_json_object() const {
        ...
        for (auto const & group_data : group_statistics_data) {
            auto const & group_address = tcash::get<common::xgroup_address_t const>(group_data);
            auto const & group_statistics_datum = tcash::get<xgroup_related_statistics_data_t>(group_data);
...
using xelection_related_statistics_data_t = xtcash_election_related_statistics_data;
...
struct xtcash_statistics_data : public xserializable_based_on<void> {
    ...
    JsonObjectT to_json_object() const {
        ...
        for (auto const & table_data : detail) {
            auto const & election_blk_height = tcash::get<uint64_t const>(table_data);
            auto const & election_statistics_datum = tcash::get<xelection_related_statistics_data_t>(table_data);
...
using xstatistics_data_t = xtcash_statistics_data;
