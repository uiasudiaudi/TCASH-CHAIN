...
class xtcash_election_info final {
...
public:
    bool operator==(xtcash_election_info const & other) const noexcept;
    bool operator!=(xtcash_election_info const & other) const noexcept;

    void swap(xtcash_election_info & other) noexcept;
...
using xelection_info_t = xtcash_election_info;
