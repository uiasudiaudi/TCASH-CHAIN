...
class xtcash_election_group_result final {
private:
...
public:
    ...
    bool
    operator==(xtcash_election_group_result const & other) const noexcept;
...
using xelection_group_result_t = xtcash_election_group_result;
