...
template <>
struct convert<tcash::data::election::v2::xstandby_network_storage_result_t> final {
    msgpack::object const & operator()(msgpack::object const & o, tcash::data::election::v2::xstandby_network_storage_result_t & result) const {
        ...
        switch (o.via.array.size - 1) {
            ...
            case xstandby_network_storage_result_result_index: {
                result.results(o.via.array.ptr[xstandby_network_storage_result_result_index].as<std::map<tcash::common::xnode_id_t, tcash::data::election::v2::xstandby_node_info_t>>());
                break;
            }
        }
...
template <>
struct pack<::tcash::data::election::v2::xstandby_network_storage_result_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, tcash::data::election::v2::xstandby_network_storage_result_t const & result) const {
...
template <>
struct object_with_zone<tcash::data::election::v2::xstandby_network_storage_result_t> {
    void operator()(msgpack::object::with_zone & o, tcash::data::election::v2::xstandby_network_storage_result_t const & result) const {
