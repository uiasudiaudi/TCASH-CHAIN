...
template <>
struct convert<tcash::data::election::v2::xelection_info_bundle_t> final {
    msgpack::object const & operator()(msgpack::object const & o, tcash::data::election::v2::xelection_info_bundle_t & info_bundle) const {
        ...
        switch (o.via.array.size - 1) {
            ...
            case xelection_info_bundle_election_info_index: {
                info_bundle.election_info(o.via.array.ptr[xelection_info_bundle_election_info_index].as<tcash::data::election::v2::xelection_info_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xelection_info_bundle_node_id_index: {
                info_bundle.account_address(o.via.array.ptr[xelection_info_bundle_node_id_index].as<tcash::common::xnode_id_t>());
                break;
            }
        }
...
template <>
struct pack<::tcash::data::election::v2::xelection_info_bundle_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, tcash::data::election::v2::xelection_info_bundle_t const & info_bundle) const {
...
template <>
struct object_with_zone<::tcash::data::election::v2::xelection_info_bundle_t> {
    void operator()(msgpack::object::with_zone & o, tcash::data::election::v2::xelection_info_bundle_t const & info_bundle) const {
