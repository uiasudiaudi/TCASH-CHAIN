...
template <>
struct convert<tcash::data::election::v2::xelection_info_t> final {
    msgpack::object const & operator()(msgpack::object const & o, tcash::data::election::v2::xelection_info_t & election_info) const {
        ...
        case xelection_info_miner_type_index: {
            election_info.miner_type(o.via.array.ptr[xelection_info_miner_type_index].as<tcash::common::xminer_type_t>());
            XATTRIBUTE_FALLTHROUGH;
        }

        case xelection_info_consensus_public_key_index: {
            election_info.public_key(o.via.array.ptr[xelection_info_consensus_public_key_index].as<tcash::xpublic_key_t>());
            XATTRIBUTE_FALLTHROUGH;
        }
        ...
        case xelection_info_joined_version_index: {
            election_info.joined_epoch(o.via.array.ptr[xelection_info_joined_version_index].as<tcash::common::xelection_round_t>());
            break;
        }
        }
        return o;
...
template <>
struct pack<::tcash::data::election::v2::xelection_info_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, tcash::data::election::v2::xelection_info_t const & election_info) const {
...
template <>
struct object_with_zone<::tcash::data::election::v2::xelection_info_t> {
    void operator()(msgpack::object::with_zone & o, tcash::data::election::v2::xelection_info_t const & election_info) const {
