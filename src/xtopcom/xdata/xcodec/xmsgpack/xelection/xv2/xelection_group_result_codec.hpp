...
template <>
struct convert<tcash::data::election::v2::xelection_group_result_t> final {
    msgpack::object const & operator()(msgpack::object const & o, tcash::data::election::v2::xelection_group_result_t & result) const {
        ...
        switch (o.via.array.size - 1) {
            ...
            case xelection_group_result_start_time_index: {
                result.start_time(array[xelection_group_result_start_time_index].as<tcash::common::xlogic_time_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xelection_group_result_timestamp_index: {
                result.timestamp(array[xelection_group_result_timestamp_index].as<tcash::common::xlogic_time_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xelection_group_result_election_committee_version_index: {
                result.election_committee_version(array[xelection_group_result_election_committee_version_index].as<tcash::common::xelection_round_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xelection_group_result_cluster_version_index: {
                result.cluster_version(array[xelection_group_result_cluster_version_index].as<tcash::common::xelection_round_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xelection_group_result_associated_group_version_index: {
                result.associated_group_version(array[xelection_group_result_associated_group_version_index].as<tcash::common::xelection_round_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xelection_group_result_group_version_index: {
                result.group_version(array[xelection_group_result_group_version_index].as<tcash::common::xelection_round_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xelection_group_result_associated_group_id_index: {
                result.associated_group_id(array[xelection_group_result_associated_group_id_index].as<tcash::common::xgroup_id_t>());
                XATTRIBUTE_FALLTHROUGH;
            }

            case xelection_group_result_results_index: {
                result.results(array[xelection_group_result_results_index].as<std::map<tcash::common::xslot_id_t, tcash::data::election::v2::xelection_info_bundle_t>>());
                break;
            }
        }
...
template <>
struct pack<::tcash::data::election::v2::xelection_group_result_t> {
    template <typename StreamT>
    msgpack::packer<StreamT> & operator()(msgpack::packer<StreamT> & o, tcash::data::election::v2::xelection_group_result_t const & result) const {
...
template <>
struct object_with_zone<tcash::data::election::v2::xelection_group_result_t> {
    void operator()(msgpack::object::with_zone & o, tcash::data::election::v2::xelection_group_result_t const & result) const {
