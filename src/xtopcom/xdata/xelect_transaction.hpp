...
#define XADD_ONCHAIN_GOVERNANCE_PARAMETER(NAME)                                                                                                                                    \
    m_initial_values.insert(                                                                                                                                                       \
        {tcash::config::x##NAME##_onchain_goverance_parameter_t::name,                                                                                                               \
         tcash::config::xto_string_helper_t<tcash::config::x##NAME##_onchain_goverance_parameter_t::type>::to_string(tcash::config::x##NAME##_onchain_goverance_parameter_t::value)})

#define XADD_ONCHAIN_GOVERNANCE_PARAMETER2(NAME, VALUE) m_initial_values.insert({tcash::config::x##NAME##_onchain_goverance_parameter_t::name, (VALUE)})
        ...
        XADD_ONCHAIN_GOVERNANCE_PARAMETER(eth_to_tcash_exchange_ratio);
        ...
        XADD_ONCHAIN_GOVERNANCE_PARAMETER(tcash_eth_base_price);
#endif
