...
public:
    xtcash_trie_hasher(bool parallel) : m_parallel{parallel} {
    }

public:
    static xtcash_trie_hasher newHasher(bool parallel) {
        return xtcash_trie_hasher{parallel};
    }
...
using xtrie_hasher_t = xtcash_trie_hasher;
