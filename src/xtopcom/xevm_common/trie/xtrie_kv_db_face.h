...
class xtcash_kv_writer_face {
public:
    xtcash_kv_writer_face() = default;
    xtcash_kv_writer_face(xtcash_kv_writer_face const &) = delete;
    xtcash_kv_writer_face & operator=(xtcash_kv_writer_face const &) = delete;
    xtcash_kv_writer_face(xtcash_kv_writer_face &&) = default;
    xtcash_kv_writer_face & operator=(xtcash_kv_writer_face &&) = default;
    virtual ~xtcash_kv_writer_face() = default;
...
using xkv_writer_face_t = xtcash_kv_writer_face;

class xtcash_kv_reader_face {
public:
    xtcash_kv_reader_face() = default;
    xtcash_kv_reader_face(xtcash_kv_reader_face const &) = delete;
    xtcash_kv_reader_face & operator=(xtcash_kv_reader_face const &) = delete;
    xtcash_kv_reader_face(xtcash_kv_reader_face &&) = default;
    xtcash_kv_reader_face & operator=(xtcash_kv_reader_face &&) = default;
    virtual ~xtcash_kv_reader_face() = default;
...
using xkv_reader_face_t = xtcash_kv_reader_face;

class xtcash_kv_db_face
  : public xkv_reader_face_t
  , public xkv_writer_face_t {};
using xkv_db_face_t = xtcash_kv_db_face;
