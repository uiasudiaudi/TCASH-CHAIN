...
struct xtcash_function_selector {
    uint32_t method_id{0};
};
using xfunction_selector_t = xtcash_function_selector;

class xtcash_abi_decoder {
public:
...
public:
    xtcash_abi_decoder() = default;
    xtcash_abi_decoder(xtcash_abi_decoder const &) = delete;
    xtcash_abi_decoder & operator=(xtcash_abi_decoder const &) = delete;
    xtcash_abi_decoder(xtcash_abi_decoder &&) = default;
    xtcash_abi_decoder & operator=(xtcash_abi_decoder &&) = default;
    ~xtcash_abi_decoder() = default;

private:
    explicit xtcash_abi_decoder(xbytes_t input_data);

public:
    static xtcash_abi_decoder build_from_hex_string(std::string const & input_hex_string, std::error_code & ec);
    static xtcash_abi_decoder build_from_hex_string(std::string const & input_hex_string);
    static xtcash_abi_decoder build_from(xbytes_t const & raw_data, std::error_code & ec);
    static xtcash_abi_decoder build_from(xbytes_t && raw_data, std::error_code & ec);
...
private:
    ...
    VarientType variant_decode(std::size_t start_pos, std::size_t offset, std::error_code & ec) {
        return tcash::to_string(do_decode_bytes(start_pos, offset, ec));
    }
...
using xabi_decoder_t = xtcash_abi_decoder;
