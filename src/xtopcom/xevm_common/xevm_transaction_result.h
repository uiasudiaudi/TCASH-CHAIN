...
public:
    ...
    xevm_log_t(common::xeth_address_t const& _address, xh256s_t const& tcashics, xbytes_t const& data);
    xevm_log_t(common::xeth_address_t const & address, xh256s_t tcashics);
