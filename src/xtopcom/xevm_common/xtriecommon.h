...
{
    h256 ret;
	const uint256_t tcash_hash = utl::xkeccak256_t::digest((const unsigned char *)_input.data(), 32);
	bytesConstRef((const unsigned char*)tcash_hash.data(), 32).copyTo(ret.ref());
