...
std::vector<xbytes_t> xtcash_trie_simple_iterator::trie_leafs(xh256_t const & trie_root_hash, observer_ptr<xtrie_db_t> const & trie_db) {
...
void xtcash_trie_simple_iterator::get_trie_leafs(std::shared_ptr<xtrie_node_face_t> const & node, observer_ptr<xtrie_db_t> const & trie_db, std::vector<xbytes_t> & leafs) {
    if (node == nullptr) {
        return;
    }
    ...
    case xtcash_trie_node_type::valuenode: {
...
void xtcash_trie_simple_iterator::get_hash_node_leafs(std::shared_ptr<xtrie_hash_node_t> const & hash_node, observer_ptr<xtrie_db_t> const & trie_db, std::vector<xbytes_t> & leafs) {
...
void xtcash_trie_simple_iterator::get_short_node_leafs(std::shared_ptr<xtrie_short_node_t> const & short_node,
...
void xtcash_trie_simple_iterator::get_value_node_leaf(std::shared_ptr<xtrie_value_node_t> const & value_node,
                                                    observer_ptr<xtrie_db_t> const & trie_db,
                                                    std::vector<xbytes_t> & leafs) {
    assert(value_node);
...
void xtcash_trie_simple_iterator::get_full_node_leafs(std::shared_ptr<xtrie_full_node_t> const & full_node, observer_ptr<xtrie_db_t> const & trie_db, std::vector<xbytes_t> & leafs) {
...
//
//xtcash_trie_iterator::xtcash_trie_iterator(std::unique_ptr<xtrie_node_iterator_face_t> iter) : node_iterator_{std::move(iter)} {
//}
//
//bool xtcash_trie_iterator::next() {
...
//}
//
//xbytes_t xtcash_trie_iterator::key() const {
//    return key_;
//}
//
//xbytes_t xtcash_trie_iterator::value() const {
//    return value_;
//}
//
//std::error_code xtcash_trie_iterator::error_code() const {
//    return ec_;
//}
//
//xtcash_trie_node_iterator::xtcash_trie_node_iterator(std::shared_ptr<xtrie_t> trie) : trie_{std::move(trie)} {
//    
//}
//
//xhash256_t xtcash_trie_node_iterator::hash() const {
//    if (stack_.empty()) {
//        return xhash256_t{};
//    }
//
...
//}
//
//xhash256_t xtcash_trie_node_iterator::parent_hash() const {
//    if (stack_.empty()) {
//        return xhash256_t{};
//    }
//
...
//}
//
//bool xtcash_trie_node_iterator::leaf() const noexcept {
//    return hasTerm(path_);
//}
//
//xbytes_t xtcash_trie_node_iterator::leaf_key() const {
//    assert(!stack_.empty());
//
...
//}
//
//xbytes_t xtcash_trie_node_iterator::leaf_blob() const {
//    assert(!stack_.empty());
...
//}
//
//std::vector<xbytes_t> xtcash_trie_node_iterator::leaf_proof() const {
//    unreachable();
//}
//
//xbytes_t xtcash_trie_node_iterator::path() const {
//    return path_;
//}
//
//xbytes_t xtcash_trie_node_iterator::node_blob() const {
//    if (hash().empty()) {
//        return {};
//    }
//
...
//}
//
//bool xtcash_trie_node_iterator::error() const {
//    unreachable();
//}
//
//bool xtcash_trie_node_iterator::next(bool const descend) const {
//    return false;
//}
//
//void xtcash_trie_node_iterator::seek(xbytes_t const & prefix, std::error_code & ec) {
...
//}
//
//std::tuple<std::unique_ptr<xtrie_node_iterator_state_t>, std::unique_ptr<int>, xbytes_t> xtcash_trie_node_iterator::peek_seek(xbytes_t const & seek_key, std::error_code & ec) {
//    if (stack_.empty()) {
//        auto state = init(ec);
//        if (ec) {
...
//}
//
//std::shared_ptr<xtrie_node_face_t> xtcash_trie_node_iterator::resolve_hash(xhash256_t const & hash, std::error_code & ec) const {
//    return trie_->resolve_hash(hash, ec);
//}
//
//
//std::unique_ptr<xtrie_node_iterator_state_t> xtcash_trie_node_iterator::init(std::error_code & ec) {
//    assert(!ec);
//
//    auto const & trie_root_hash = trie_->hash();
//
//    auto state = tcash::make_unique<xtrie_node_iterator_state_t>();
...
//}
//
//void xtcash_trie_node_iterator::pop() {
...
//
//
//void xtcash_trie_node_iterator_state::resolve(observer_ptr<xtrie_node_iterator_t> const trie_node_iterator, std::error_code & ec) {
