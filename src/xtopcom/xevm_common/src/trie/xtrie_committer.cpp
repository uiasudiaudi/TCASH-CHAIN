...
std::pair<xtrie_hash_node_ptr_t, int32_t> xtcash_trie_committer::Commit(xtrie_node_face_ptr_t const & n, observer_ptr<xtrie_db_t> const db, std::error_code & ec) {
    if (db == nullptr) {
...
std::pair<xtrie_node_face_ptr_t, int32_t> xtcash_trie_committer::commit(xtrie_node_face_ptr_t const & n, observer_ptr<xtrie_db_t> const db, std::error_code & ec) {
...
std::pair<std::array<xtrie_node_face_ptr_t, 17>, int32_t> xtcash_trie_committer::commitChildren(xtrie_full_node_ptr_t n, observer_ptr<xtrie_db_t> const db, std::error_code & ec) {
...
xtrie_node_face_ptr_t xtcash_trie_committer::store(xtrie_node_face_ptr_t n, observer_ptr<xtrie_db_t> const db) {
...
int32_t xtcash_trie_committer::estimateSize(xtrie_node_face_ptr_t n) {
    switch (n->type()) {
    case xtrie_node_type_t::shortnode: {
