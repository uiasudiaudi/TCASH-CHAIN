...
std::int32_t xtcash_serializable_based_on<void>::serialize_to(base::xstream_t & stream) const {
    base::xstream_t internal_stream{ base::xcontext_t::instance() };
    do_write(internal_stream);
    return stream << internal_stream;
}

std::int32_t xtcash_serializable_based_on<void>::serialize_to(base::xstream_t & stream, std::error_code & ec) const {
    assert(!ec);
    try {
        return serialize_to(stream);
    } catch (...) {
        ec = tcash::error::xbasic_errc_t::serialization_error;
    }

    return -1;
}

std::int32_t xtcash_serializable_based_on<void>::serialize_from(base::xstream_t & stream) {
    base::xstream_t internal_stream{ base::xcontext_t::instance() };
...
std::int32_t xtcash_serializable_based_on<void>::serialize_from_short(base::xstream_t & stream) {
...
std::int32_t xtcash_serializable_based_on<void>::serialize_from(base::xstream_t & stream, std::error_code & ec) {
    assert(!ec);
    try {
        return serialize_from(stream);
    } catch (...) {
        ec = tcash::error::xbasic_errc_t::deserialization_error;
    }

    return -1;
}

std::int32_t xtcash_serializable_based_on<void>::serialize_to(base::xbuffer_t & stream) const {
    base::xstream_t internal_stream{base::xcontext_t::instance()};
    do_write(internal_stream);
    return stream << internal_stream;
}

std::int32_t xtcash_serializable_based_on<void>::serialize_to(base::xbuffer_t & stream, std::error_code & ec) const {
    assert(!ec);
    try {
        return serialize_to(stream);
    } catch (...) {
...
std::int32_t xtcash_serializable_based_on<void>::serialize_from(base::xbuffer_t & stream) {
    base::xstream_t internal_stream{base::xcontext_t::instance()};
    auto ret = stream >> internal_stream;
    do_read(internal_stream);
    return ret;
...
std::int32_t xtcash_serializable_based_on<void>::serialize_from(base::xbuffer_t & stream, std::error_code & ec) {
    assert(!ec);
    try {
        return serialize_from(stream);
    } catch (...) {
...
xbyte_buffer_t xtcash_serializable_based_on<void>::serialize_based_on<base::xstream_t>() const {
    ...
    if (do_write(stream) <= 0) {
        std::error_code ec = tcash::error::xbasic_errc_t::serialization_error;
...
void xtcash_serializable_based_on<void>::deserialize_based_on<base::xstream_t>(xbyte_buffer_t bytes) {
    ...
    if (do_read(stream) <= 0) {
        std::error_code ec{ tcash::error::xbasic_errc_t::deserialization_error };
        tcash::error::throw_error(ec);
    }
}
...
std::int32_t xtcash_serializable_based_on<void>::do_write(base::xstream_t & stream, std::error_code & ec) const {
    assert(!ec);
    try {
...
std::int32_t xtcash_serializable_based_on<void>::do_read(base::xstream_t & stream, std::error_code & ec) {
    assert(!ec);
    try {
