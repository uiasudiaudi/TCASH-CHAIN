...
xbytes_t to_bytes<char>(char const & input) {
    return tcash::to_bytes(static_cast<unsigned char>(input));
}
...
xbytes_t to_bytes<int>(int const & input) {
    return to_bytes(tcash::to_string(input));
}
...
char from_bytes<char>(xbytes_t const & input, std::error_code & ec) {
    ...
    return static_cast<char>(tcash::from_bytes<unsigned char>(input, ec));
}
...
signed char from_bytes<signed char>(xbytes_t const & input, std::error_code & ec) {
    assert(!ec);
    return static_cast<signed char>(tcash::from_bytes<unsigned char>(input, ec));
}
...
int from_bytes<int>(xbytes_t const & input, std::error_code & ec) {
    ...
    return tcash::from_string<int>(string, ec);
}
...
long from_bytes<long>(xbytes_t const & input, std::error_code & ec) {
    ...
    return tcash::from_string<long>(string, ec);
}
...
long long from_bytes<long long>(xbytes_t const & input, std::error_code & ec) {
    ...
    return tcash::from_string<long long>(string, ec);
}
...
unsigned int from_bytes<unsigned int>(xbytes_t const & input, std::error_code & ec) {
    ...
    return tcash::from_string<unsigned int>(string, ec);
}
...
unsigned long from_bytes<unsigned long>(xbytes_t const & input, std::error_code & ec) {
    ...
    return tcash::from_string<unsigned long>(string, ec);
}
...
unsigned long long from_bytes<unsigned long long>(xbytes_t const & input, std::error_code & ec) {
    ...
    return tcash::from_string<unsigned long long>(string, ec);
}

xtcash_bytes_helper::xtcash_bytes_helper(xbytes_t const & bytes) noexcept : bytes_{bytes} {
}

bool xtcash_bytes_helper::start_with(xbytes_t const & prefix) const noexcept {
