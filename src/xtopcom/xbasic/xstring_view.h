...
class xtcash_basic_string_view;

template <typename CharT, typename TraitsT = std::char_traits<CharT>>
using xbasic_string_view_t = xtcash_basic_string_view<CharT, TraitsT>;

NS_BEG1(details)

template <class TraitsT>
class xtcash_string_view_iterator {
public:
    ...
    constexpr xtcash_string_view_iterator() noexcept = default;
...
private:
    ...
    constexpr xtcash_string_view_iterator(pointer const offset) noexcept : offset_(offset) {
    }
...
public:
    ...
    xtcash_string_view_iterator & operator++() noexcept {
        ++offset_;
        return *this;
    }

    xtcash_string_view_iterator operator++(int) noexcept {
        xtcash_string_view_iterator tmp{*this};
        ++*this;
        return tmp;
    }
    ...
    xtcash_string_view_iterator & operator+=(difference_type const offset) noexcept {
        offset_ += static_cast<size_t>(offset);
        return *this;
    }

    XATTRIBUTE_NODISCARD xtcash_string_view_iterator operator+(difference_type const offset) const noexcept {
        xtcash_string_view_iterator tmp{*this};
        tmp += offset;
        return tmp;
    }

    XATTRIBUTE_NODISCARD friend xtcash_string_view_iterator operator+(difference_type const offset, xtcash_string_view_iterator right) noexcept {
        right += offset;
        return right;
    }
    ...
    XATTRIBUTE_NODISCARD difference_type operator-(xtcash_string_view_iterator const & right) const noexcept {
    ...
    XATTRIBUTE_NODISCARD constexpr bool operator==(xtcash_string_view_iterator const & right) const noexcept {
...
using xstring_view_iterator_t = xtcash_string_view_iterator<TraitsT>;
...
public:
    ...
    constexpr xtcash_basic_string_view() = default;
    xtcash_basic_string_view(xtcash_basic_string_view const &) = default;
    xtcash_basic_string_view & operator=(xtcash_basic_string_view const &) = default;
    xtcash_basic_string_view(xtcash_basic_string_view &&) = default;
    xtcash_basic_string_view & operator=(xtcash_basic_string_view &&) = default;
    ~xtcash_basic_string_view() = default;

    xtcash_basic_string_view(std::basic_string<CharT, TraitsT> const & str) noexcept : data_{str.data()}, size_{str.size()} {
    }

    xtcash_basic_string_view(const_pointer const cstr) noexcept : data_{cstr}, size_{TraitsT::length(cstr)} {
    }

    xtcash_basic_string_view(const_pointer const cstr, size_type const size) noexcept : data_{cstr}, size_{size} {
        assert(cstr);
    }
    ...
    void swap(xtcash_basic_string_view & other) noexcept {
        xtcash_basic_string_view const tmp{other};
        other = *this;
        *this = tmp;
    }
    ...
    XATTRIBUTE_NODISCARD xtcash_basic_string_view substr(size_type const offset = 0, size_type size = npos) const {
        check_offset(offset);
        size = clamp_suffix_size(offset, size);
        return xtcash_basic_string_view{data_ + offset, size};
    }

    XATTRIBUTE_NODISCARD int compare(xtcash_basic_string_view const right) const noexcept {
    ...
    XATTRIBUTE_NODISCARD constexpr int compare(size_type const pos1, size_type const count1, xtcash_basic_string_view const other) const {
    ...
    XATTRIBUTE_NODISCARD constexpr int compare(size_type const pos1,
                                               ...
                                               xtcash_basic_string_view const other,
    ...
    XATTRIBUTE_NODISCARD constexpr int compare(value_type const * const cstr) const {
        return compare(xtcash_basic_string_view{cstr});
    }
    ...
    XATTRIBUTE_NODISCARD constexpr int compare(size_type const pos1, size_type const count1, value_type const * const cstr) const {
        ...
        return substr(pos1, count1).compare(xtcash_basic_string_view(cstr));
    }
    ...
    XATTRIBUTE_NODISCARD constexpr int compare(size_type const pos1, size_type const count1, value_type const * const cstr, size_type const count2) const {
        ...
        return substr(pos1, count1).compare(xtcash_basic_string_view(cstr, count2));
    }

    XATTRIBUTE_NODISCARD bool starts_with(xtcash_basic_string_view const other) const noexcept {
    ...
    XATTRIBUTE_NODISCARD constexpr bool starts_with(value_type const * const cstr) const noexcept {
        return starts_with(xtcash_basic_string_view{cstr});
    }

    XATTRIBUTE_NODISCARD bool ends_with(xtcash_basic_string_view const other) const noexcept {
        if (size_ < other.size_) {
            return false;
        }
    ...
    XATTRIBUTE_NODISCARD constexpr bool ends_with(value_type const * const other) const noexcept {
        return ends_with(xtcash_basic_string_view(other));
    }

    XATTRIBUTE_NODISCARD constexpr bool contains(xtcash_basic_string_view const other) const noexcept {
    ...
    //XATTRIBUTE_NODISCARD constexpr size_type find(xtcash_basic_string_view const other, size_type const offset = 0) const noexcept {
    //}
    ...
    //XATTRIBUTE_NODISCARD constexpr size_type rfind(xtcash_basic_string_view const other, size_type const offset = npos) const noexcept {
    //}
    ...
    //XATTRIBUTE_NODISCARD constexpr size_type find_first_of(xtcash_basic_string_view const other, size_type const offset = 0) const noexcept {
    //}
    ...
    //XATTRIBUTE_NODISCARD constexpr size_type find_last_of(xtcash_basic_string_view const other, size_type const offset = npos) const noexcept {
    //}
    ...
    //XATTRIBUTE_NODISCARD constexpr size_type find_first_not_of(xtcash_basic_string_view const other, size_type const offset = 0) const noexcept {
    //}
    ...
    //XATTRIBUTE_NODISCARD constexpr size_type find_last_not_of(xtcash_basic_string_view const other, size_type const offset = npos) const noexcept {
    //}
...
constexpr typename xtcash_basic_string_view<CharT, TraistsT>::size_type xtcash_basic_string_view<CharT, TraistsT>::npos;
