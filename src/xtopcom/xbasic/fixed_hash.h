...
public:
    ...
    explicit FixedHash(std::string const & _s, ConstructFromStringType _t = FromHex, ConstructFromHashType _ht = FailIfDifferent)
      : FixedHash(_t == FromHex ? fromHex(_s, WhenError::Throw) : tcash::evm_common::asBytes(_s), _ht) {
    }
...
namespace std {
/// Forward std::hash<tcash::evm_common::FixedHash> to tcash::evm_common::FixedHash::hash.
template <>
struct hash<tcash::evm_common::h64> : tcash::evm_common::h64::hash {};
template <>
struct hash<tcash::evm_common::h128> : tcash::evm_common::h128::hash {};
template <>
struct hash<tcash::evm_common::h160> : tcash::evm_common::h160::hash {};
template <>
struct hash<tcash::evm_common::h256> : tcash::evm_common::h256::hash {};
template <>
struct hash<tcash::evm_common::h512> : tcash::evm_common::h512::hash {};
}  // namespace std
