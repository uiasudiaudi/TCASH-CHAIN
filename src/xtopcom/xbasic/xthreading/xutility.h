...
struct xtcash_lock_guard_helper
{
...
#define XLOCK_GUARD(MUTEX)                                                                                                                                                                                                                                                                  \
    for (::tcash::threading::xtcash_lock_guard_helper<typename ::std::remove_cv<typename ::std::remove_reference<decltype(MUTEX)>::type>::type> MUTEX ## _lock{ ::std::unique_lock<typename ::std::remove_cv<typename ::std::remove_reference<decltype(MUTEX)>::type>::type>{MUTEX}, true };    \
         MUTEX ## _lock.b;                                                                                                                                                                                                                                                                  \
         MUTEX ## _lock.b = false)
