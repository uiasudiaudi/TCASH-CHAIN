...
class xtcash_relay_make_block_contract : public xcontract::xcontract_base {
    using xbase_t = xcontract::xcontract_base;

public:
    XDECLARE_DELETED_COPY_DEFAULTED_MOVE_SEMANTICS(xtcash_relay_make_block_contract);
    XDECLARE_DEFAULTED_OVERRIDE_DESTRUCTOR(xtcash_relay_make_block_contract);

    explicit xtcash_relay_make_block_contract(common::xnetwork_id_t const & network_id);

    xcontract_base * clone() override {
        return new xtcash_relay_make_block_contract(network_id());
    }
    ...
    BEGIN_CONTRACT_WITH_PARAM(xtcash_relay_make_block_contract)
    CONTRACT_FUNCTION_PARAM(xtcash_relay_make_block_contract, on_receive_cross_txs);
    CONTRACT_FUNCTION_PARAM(xtcash_relay_make_block_contract, on_make_block);
...
using xrelay_make_block_contract_t = xtcash_relay_make_block_contract;
