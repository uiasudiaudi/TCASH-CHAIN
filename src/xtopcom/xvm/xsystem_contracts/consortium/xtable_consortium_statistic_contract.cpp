    ...
    uint64_t block_height)
{
    ...
    XCONTRACT_ENSURE(base_addr == tcash::sys_contract_sharding_statistic_info_addr || source_addr == tcash::sys_contract_eth_table_statistic_info_addr, "invalid source base's call!");
