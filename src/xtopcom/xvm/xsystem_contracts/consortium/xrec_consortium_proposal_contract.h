...
private:
     ...
     * @return false
     */
    bool get_proposal_info(const std::string& proposal_id, tcash::tcc::proposal_info& proposal);
     ...
     * @return false
     */
    bool is_valid_proposal_type(tcash::tcc::proposal_type type);
