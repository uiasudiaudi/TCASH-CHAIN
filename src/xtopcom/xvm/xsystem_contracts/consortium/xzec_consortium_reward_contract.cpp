...
void xzec_consortium_reward_contract::on_receive_reward(std::string const& table_info_str)
{
    ...
    XCONTRACT_ENSURE(base_addr == tcash::sys_contract_sharding_statistic_info_addr || source_address == tcash::sys_contract_eth_table_statistic_info_addr, "invalid source base's call!");
