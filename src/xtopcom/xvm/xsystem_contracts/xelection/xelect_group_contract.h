...
class xtcash_elect_group_contract : public xcontract::xcontract_base {
    using xbase_t = xcontract::xcontract_base;

public:
    XDECLARE_DELETED_COPY_DEFAULTED_MOVE_SEMANTICS(xtcash_elect_group_contract);
    XDECLARE_DEFAULTED_OVERRIDE_DESTRUCTOR(xtcash_elect_group_contract);

protected:
    explicit xtcash_elect_group_contract(common::xnetwork_id_t const & network_id);
...
using xelect_group_contract_t = xtcash_elect_group_contract;
