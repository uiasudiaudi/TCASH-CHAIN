...
class xtcash_zec_elect_consensus_group_contract final : public xelect_consensus_group_contract_t {
...
public:
    XDECLARE_DELETED_COPY_DEFAULTED_MOVE_SEMANTICS(xtcash_zec_elect_consensus_group_contract);
    XDECLARE_DEFAULTED_OVERRIDE_DESTRUCTOR(xtcash_zec_elect_consensus_group_contract);

    explicit xtcash_zec_elect_consensus_group_contract(common::xnetwork_id_t const & network_id);

    xcontract_base * clone() override { return new xtcash_zec_elect_consensus_group_contract(this->m_network_id); }

    void setup() override;

    void on_timer(common::xlogic_time_t const current_time);

    BEGIN_CONTRACT_WITH_PARAM(xtcash_zec_elect_consensus_group_contract)
    CONTRACT_FUNCTION_PARAM(xtcash_zec_elect_consensus_group_contract, on_timer);
...
using xzec_elect_consensus_group_contract_t = xtcash_zec_elect_consensus_group_contract;
