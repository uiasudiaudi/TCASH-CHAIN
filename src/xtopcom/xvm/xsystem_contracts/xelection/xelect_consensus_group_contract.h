 ...
 */
class xtcash_election_awared_data final {
private:
...
public:
    xtcash_election_awared_data(xtcash_election_awared_data const &) = default;
    xtcash_election_awared_data & operator=(xtcash_election_awared_data const &) = default;
    xtcash_election_awared_data(xtcash_election_awared_data &&) = default;
    xtcash_election_awared_data & operator=(xtcash_election_awared_data &&) = default;
    ~xtcash_election_awared_data() = default;

    xtcash_election_awared_data(common::xnode_id_t const & account,
    ...
    bool operator<(xtcash_election_awared_data const & other) const noexcept;
    bool operator==(xtcash_election_awared_data const & other) const noexcept;
    bool operator>(xtcash_election_awared_data const & other) const noexcept;
...
using xelection_awared_data_t = xtcash_election_awared_data;

class xtcash_elect_consensus_group_contract : public xelect_group_contract_t {
    using xbase_t = xelect_group_contract_t;

public:
    XDECLARE_DELETED_COPY_DEFAULTED_MOVE_SEMANTICS(xtcash_elect_consensus_group_contract);
    XDECLARE_DEFAULTED_OVERRIDE_DESTRUCTOR(xtcash_elect_consensus_group_contract);

protected:
    explicit xtcash_elect_consensus_group_contract(common::xnetwork_id_t const & network_id);
...
using xelect_consensus_group_contract_t = xtcash_elect_consensus_group_contract;
