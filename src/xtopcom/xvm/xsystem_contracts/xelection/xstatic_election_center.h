...
public:
    ...
    void calc_static_tcash_consensus_election_nodes();
    void calc_static_evm_consensus_election_nodes();
    
    std::vector<node_info> get_static_tcash_consensus_election_nodes(uint8_t group_id_value);
    std::vector<node_info> get_static_evm_consensus_election_nodes(uint8_t group_id_value);

private:
    std::map<uint8_t,std::vector<node_info>> tcash_consensus_group_map;
    ...
    xstatic_election_center() {
        ...
        calc_static_tcash_consensus_election_nodes();
