...
xtcash_rec_elect_edge_contract::xtcash_rec_elect_edge_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {}
...
void xtcash_rec_elect_edge_contract::elect_config_nodes(common::xlogic_time_t const current_time) {
...
void xtcash_rec_elect_edge_contract::setup() {
...
void xtcash_rec_elect_edge_contract::on_timer(const uint64_t current_time) {
#ifdef STATIC_CONSENSUS
...
common::xnode_type_t xtcash_rec_elect_edge_contract::standby_type(common::xzone_id_t const & zid,
