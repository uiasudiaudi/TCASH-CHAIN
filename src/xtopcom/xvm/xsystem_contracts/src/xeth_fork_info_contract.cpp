...
xtcash_eth_fork_info_contract::xtcash_eth_fork_info_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {
}

void xtcash_eth_fork_info_contract::setup() {
    xinfo("xtcash_eth_fork_info_contract::setup");
...
void xtcash_eth_fork_info_contract::on_timer(common::xlogic_time_t const trigger_time) {
    auto current_time = TIME();
    xinfo("xtcash_eth_fork_info_contract::on_timer % " PRIu64 " triggered at %" PRIu64 "", current_time, trigger_time);
    ...
    ///     xinfo("xtcash_eth_fork_info_contract::do_fork: TEST_FORK");
    ///     STRING_SET(data::XPROPERTY_CONTRACT_TABLE_FORK_INFO_KEY, "fork_info");
    /// }
