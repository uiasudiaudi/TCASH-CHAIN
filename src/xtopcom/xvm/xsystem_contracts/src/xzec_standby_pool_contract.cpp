...
xtcash_zec_standby_pool_contract::xtcash_zec_standby_pool_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {}

xcontract::xcontract_base * xtcash_zec_standby_pool_contract::clone() {
    return new xtcash_zec_standby_pool_contract{this->m_network_id};
}

void xtcash_zec_standby_pool_contract::setup() {
...
void xtcash_zec_standby_pool_contract::on_timer(common::xlogic_time_t const current_time) {
