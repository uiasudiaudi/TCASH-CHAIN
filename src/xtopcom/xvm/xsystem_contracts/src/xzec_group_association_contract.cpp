...
xtcash_group_association_contract::xtcash_group_association_contract(common::xnetwork_id_t const & network_id)
    : xbase_t{ network_id } {
}

xcontract::xcontract_base *
xtcash_group_association_contract::clone() {
    return new xtcash_group_association_contract{ network_id() };
}

void
xtcash_group_association_contract::setup() {
