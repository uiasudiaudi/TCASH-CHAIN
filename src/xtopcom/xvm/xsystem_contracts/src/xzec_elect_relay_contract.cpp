...
xtcash_zec_elect_relay_contract::xtcash_zec_elect_relay_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {}

void xtcash_zec_elect_relay_contract::setup() {
...
void xtcash_zec_elect_relay_contract::on_timer(common::xlogic_time_t const current_time) {
    XCONTRACT_ENSURE(SOURCE_ADDRESS() == SELF_ADDRESS().to_string(), "xtcash_zec_elect_relay_contract instance is triggled by " + SOURCE_ADDRESS());
    XCONTRACT_ENSURE(SELF_ADDRESS() == zec_elect_relay_contract_address, "xtcash_zec_elect_relay_contract instance is not triggled by zec_elect_relay_contract_address");
    // XCONTRACT_ENSURE(current_time <= TIME(), u8"xtcash_zec_elect_relay_contract::on_timer current_time > consensus leader's time");
