...
xtcash_elect_group_contract::xtcash_elect_group_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {}

bool xtcash_elect_group_contract::elect_group(common::xzone_id_t const &,
