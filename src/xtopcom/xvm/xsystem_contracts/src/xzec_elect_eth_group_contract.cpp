...
xtcash_zec_elect_eth_contract::xtcash_zec_elect_eth_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {
}
...
void xtcash_zec_elect_eth_contract::elect_config_nodes(common::xlogic_time_t const current_time) {
...
void xtcash_zec_elect_eth_contract::setup() {
...
void xtcash_zec_elect_eth_contract::on_timer(common::xlogic_time_t const current_time) {
#ifdef STATIC_CONSENSUS
...
void xtcash_zec_elect_eth_contract::elect(common::xzone_id_t const zone_id,
...
bool xtcash_zec_elect_eth_contract::elect_eth_consensus(common::xzone_id_t const zone_id,
                                                      common::xcluster_id_t const cluster_id,
