...
xtcash_rec_elect_archive_contract::xtcash_rec_elect_archive_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {}
...
void xtcash_rec_elect_archive_contract::elect_config_nodes(common::xlogic_time_t const current_time) {
...
void xtcash_rec_elect_archive_contract::setup() {
...
void xtcash_rec_elect_archive_contract::on_timer(const uint64_t current_time) {
#ifdef STATIC_CONSENSUS
...
void xtcash_rec_elect_archive_contract::elect_archive(const uint64_t current_time) {
    ...
    tcash::common::xgroup_id_t const & archive_gid = common::xarchive_group_id;
...
common::xnode_type_t xtcash_rec_elect_archive_contract::standby_type(common::xzone_id_t const & zid,
