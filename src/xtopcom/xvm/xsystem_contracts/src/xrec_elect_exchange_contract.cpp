...
xtcash_rec_elect_exchange_contract::xtcash_rec_elect_exchange_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {}
...
void xtcash_rec_elect_exchange_contract::elect_config_nodes(common::xlogic_time_t const current_time) {
...
void xtcash_rec_elect_exchange_contract::setup() {
...
void xtcash_rec_elect_exchange_contract::on_timer(const uint64_t current_time) {
#ifdef STATIC_CONSENSUS
    ...
    tcash::common::xgroup_id_t exchange_gid = common::xexchange_group_id;
...
common::xnode_type_t xtcash_rec_elect_exchange_contract::standby_type(common::xzone_id_t const & zid,
