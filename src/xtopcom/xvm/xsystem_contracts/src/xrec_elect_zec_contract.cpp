...
xtcash_rec_elect_zec_contract::xtcash_rec_elect_zec_contract(common::xnetwork_id_t const & network_id) : xbase_t{network_id} {}
...
void xtcash_rec_elect_zec_contract::elect_config_nodes(common::xlogic_time_t const current_time) {
...
void xtcash_rec_elect_zec_contract::setup() {
...
void xtcash_rec_elect_zec_contract::on_timer(common::xlogic_time_t const current_time) {
#ifdef STATIC_CONSENSUS
