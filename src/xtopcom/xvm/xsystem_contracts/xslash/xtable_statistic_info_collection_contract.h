...
public:
     ...
     */
    void
    on_collect_statistic_info(tcash::data::xstatistics_data_t const& statistic_data, tcash::data::xfulltableblock_statistic_accounts const& statistic_accounts, uint64_t block_height, int64_t tgas);
...
protected:
     ...
     */
    void collect_slash_statistic_info(tcash::data::xstatistics_data_t const & statistic_data,
                                      tcash::data::xfulltableblock_statistic_accounts const & statistic_accounts,
     ...
     */
    data::system_contract::xunqualified_node_info_v1_t process_statistic_data(tcash::data::xstatistics_data_t const & block_statistic_data,
                                                                              tcash::data::xfulltableblock_statistic_accounts const & statistic_accounts);
     ...
     *
     */
    void process_workload_statistic_data(tcash::data::xstatistics_data_t const & statistic_data,  tcash::data::xfulltableblock_statistic_accounts const& statistic_accounts, const int64_t tgas);
     ...
     *
     */
    std::map<common::xgroup_address_t, data::system_contract::xgroup_workload_t> get_workload_from_data(tcash::data::xstatistics_data_t const & statistic_data,
                                                                                                        tcash::data::xfulltableblock_statistic_accounts const & statistic_accounts);
