...
#include "xcommon/xtcash_event.h"
...
public:
    ...
    void tcash_token_increase(const uint64_t amount);
    void tcash_token_decrease(const uint64_t amount);
    ...
    void event(common::xtcash_event_t & event);
