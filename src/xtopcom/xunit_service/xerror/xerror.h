...
NS_BEG3(tcash, xunit_service, error)
...
template <>
struct is_error_code_enum<tcash::xunit_service::error::xerrc_t> : std::true_type {};

template <>
struct is_error_condition_enum<tcash::xunit_service::error::xerrc_t> : std::true_type {};
