...
class xtcash_db_export_category final : public std::error_category {
public:
    ...
    ~xtcash_db_export_category() noexcept override = default;
};
using xdb_export_category_t = xtcash_db_export_category;
